...
public class ModelFlounder extends ModelBase
{
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		if ((double)f1 > 0.1) {
			newangle = MathHelper.cos(f2 * 1.3F) * (float)Math.PI * 0.25F * f1;
			newangle2 = MathHelper.cos(f2 * 1.7F) * (float)Math.PI * 0.25F * f1;
		} else {
			newangle = 0.0F;
			newangle2 = 0.0F;
		}
		...
		if ((double)f1 > 0.1) {
			newangle = MathHelper.cos(f2 * 1.2F) * (float)Math.PI * 0.25F * f1;
		} else {
			newangle = MathHelper.cos(f2 * 0.7F) * (float)Math.PI * 0.05F;
		}
