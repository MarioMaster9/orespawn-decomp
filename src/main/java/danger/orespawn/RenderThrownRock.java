...
public class RenderThrownRock extends Render
{
	...
	protected ResourceLocation getEntityTexture(Entity entity)
	{
		...
		if (r.getRockType() == 1) return texture1;
		if (r.getRockType() == 2) return texture2;
		if (r.getRockType() == 3) return texture3;
		if (r.getRockType() == 4) return texture4;
		if (r.getRockType() == 5) return texture5;
		if (r.getRockType() == 6) return texture6;
		if (r.getRockType() == 7) return texture7;
		if (r.getRockType() == 8) return texture8;
		if (r.getRockType() == 9) return texture9;
		if (r.getRockType() == 10) return texture10;
		if (r.getRockType() == 11) return texture11;
		if (r.getRockType() == 12) return texture12;
		return texture1;
	}
}
