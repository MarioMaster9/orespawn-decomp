...
public class ModelRat extends ModelBase
{
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		this.tail2.rotationPointZ = this.tail1.rotationPointZ + (float)Math.cos((double)this.tail1.rotateAngleY) * 9.0F;
		this.tail2.rotationPointX = this.tail1.rotationPointX + (float)Math.sin((double)this.tail1.rotateAngleY) * 9.0F;
