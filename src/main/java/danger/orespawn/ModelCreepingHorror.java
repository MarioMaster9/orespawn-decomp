...
public class ModelCreepingHorror extends ModelBase
{
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		float newangle = MathHelper.cos(f2 * 1.25F) * (float)Math.PI * 0.35F * f1;
		...
		newangle = MathHelper.cos(f2 * 0.48F) * (float)Math.PI * 0.15F;
		...
		newangle = MathHelper.cos(f2 * 0.11F) * (float)Math.PI * 0.25F;
		...
		newangle = MathHelper.cos(f2 * 0.81F) * (float)Math.PI * 0.08F;
		this.spike1.rotateAngleX = 0.7F + newangle;
		newangle = MathHelper.cos(f2 * 0.87F) * (float)Math.PI * 0.08F;
		this.spike2.rotateAngleX = 0.7F + newangle;
		newangle = MathHelper.cos(f2 * 0.99F) * (float)Math.PI * 0.08F;
		this.spike3.rotateAngleX = 0.7F + newangle;
		newangle = MathHelper.cos(f2 * 0.103F) * (float)Math.PI * 0.08F;
		this.spike4.rotateAngleX = 0.7F + newangle;
		newangle = MathHelper.cos(f2 * 0.107F) * (float)Math.PI * 0.08F;
		this.spike5.rotateAngleX = 0.7F + newangle;
		
		newangle = MathHelper.cos(f2 * 1.11F) * (float)Math.PI * 0.08F;
		this.spike1.rotateAngleY = newangle;
		newangle = MathHelper.cos(f2 * 1.17F) * (float)Math.PI * 0.08F;
		this.spike2.rotateAngleY = newangle;
		newangle = MathHelper.cos(f2 * 1.25F) * (float)Math.PI * 0.08F;
		this.spike3.rotateAngleY = newangle;
		newangle = MathHelper.cos(f2 * 1.28F) * (float)Math.PI * 0.08F;
		this.spike4.rotateAngleY = newangle;
		newangle = MathHelper.cos(f2 * 1.31F) * (float)Math.PI * 0.08F;
		this.spike5.rotateAngleY = newangle;
		
		newangle = MathHelper.cos(f2 * 1.41F) * (float)Math.PI * 0.08F;
		this.spike1.rotateAngleZ = newangle;
		newangle = MathHelper.cos(f2 * 1.47F) * (float)Math.PI * 0.08F;
		this.spike2.rotateAngleZ = newangle;
		newangle = MathHelper.cos(f2 * 1.55F) * (float)Math.PI * 0.08F;
		this.spike3.rotateAngleZ = newangle;
		newangle = MathHelper.cos(f2 * 1.58F) * (float)Math.PI * 0.08F;
		this.spike4.rotateAngleZ = newangle;
		newangle = MathHelper.cos(f2 * 1.61F) * (float)Math.PI * 0.08F;
