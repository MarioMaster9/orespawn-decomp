...
public class ModelLizard extends ModelBase
{
	...
	public ModelLizard(float f1)
	{
		...
		this.setRotation(this.Tail2, (-(float)Math.PI / 6F), 0.0F, 0.0F);
		...
		this.setRotation(this.RightEye, 0.0F, ((float)Math.PI / 4F), 0.3490659F);
		...
		this.setRotation(this.LeftEye, 0.0F, (-(float)Math.PI / 4F), -0.3490659F);
		...
		this.setRotation(this.Tooth16, ((float)Math.PI / 6F), 0.0F, 0.0F);
		...
		this.setRotation(this.Tooth15, ((float)Math.PI / 6F), 0.0F, 0.0F);
		...
		this.setRotation(this.Tooth14, ((float)Math.PI / 6F), 0.0F, 0.0F);
		...
		this.setRotation(this.Tooth13, ((float)Math.PI / 6F), 0.0F, 0.0F);
		...
		this.setRotation(this.Tooth12, ((float)Math.PI / 6F), 0.0F, 0.0F);
		...
		this.setRotation(this.Tooth9, ((float)Math.PI / 6F), 0.0F, 0.0F);
		...
		this.setRotation(this.BottomJaw, ((float)Math.PI / 6F), 0.0F, 0.0F);
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		if ((double)f1 > 0.1) {
			newangle = MathHelper.cos(f2 * 1.0F * this.wingspeed) * (float)Math.PI * 0.25F * f1;
		} else {
			newangle = 0.0F;
		}
		...
		newangle = MathHelper.cos(f2 * 0.25F * this.wingspeed) * (float)Math.PI * 0.05F;
		if (e.getAttacking() != 0) {
			newangle = MathHelper.cos(f2 * 1.25F * this.wingspeed) * (float)Math.PI * 0.35F;
		}

		this.TailBase1.rotateAngleY = newangle * 0.25F;
		this.Tail2.rotationPointZ = this.TailBase1.rotationPointZ + (float)Math.cos((double)this.TailBase1.rotateAngleY) * 12.0F;
		this.Tail2.rotationPointX = this.TailBase1.rotationPointX + (float)Math.sin((double)this.TailBase1.rotateAngleY) * 12.0F;
		...
		this.Tail4.rotationPointZ = this.Tail3.rotationPointZ + (float)Math.cos((double)this.Tail3.rotateAngleY) * 7.0F;
		this.Tail4.rotationPointX = this.Tail3.rotationPointX + (float)Math.sin((double)this.Tail3.rotateAngleY) * 7.0F;
		this.Tail4.rotateAngleY = newangle * 1.0F;
		this.TailTip.rotationPointZ = this.Tail4.rotationPointZ + (float)Math.cos((double)this.Tail4.rotateAngleY) * 7.0F;
		this.TailTip.rotationPointX = this.Tail4.rotationPointX + (float)Math.sin((double)this.Tail4.rotateAngleY) * 7.0F;
		...
		this.Neck.rotateAngleY = (float)Math.toRadians((double)f3) * 0.25F;
		this.JawTop.rotationPointZ = this.Neck.rotationPointZ - (float)Math.cos((double)this.Neck.rotateAngleY) * 2.0F;
		this.JawTop.rotationPointX = this.Neck.rotationPointX - (float)Math.sin((double)this.Neck.rotateAngleY) * 2.0F;
		this.JawTop.rotateAngleY = (float)Math.toRadians((double)f3) * 0.5F;
		...
		this.BottomJaw.rotationPointZ = this.Neck.rotationPointZ - (float)Math.cos((double)this.Neck.rotateAngleY) * 3.0F;
		this.BottomJaw.rotationPointX = this.Neck.rotationPointX - (float)Math.sin((double)this.Neck.rotateAngleY) * 3.0F;
		this.BottomJaw.rotateAngleY = (float)Math.toRadians((double)f3) * 0.5F;
