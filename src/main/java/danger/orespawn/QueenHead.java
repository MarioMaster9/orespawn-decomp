...
public class QueenHead extends EntityLiving
{
	...
	public boolean attackEntityFrom(DamageSource par1DamageSource, float par2)
	{
		...
		if (e != null && (e instanceof TheQueen || e instanceof QueenHead)) return false;
		e = par1DamageSource.getSourceOfDamage();
		if (e != null && (e instanceof TheQueen || e instanceof QueenHead)) return false;
		
		List var5 = this.worldObj.getEntitiesWithinAABB(TheQueen.class, this.boundingBox.expand((double)48.0F, 32.0D, (double)48.0F));
	...
	public void onUpdate()
	{
		...
		else
		{
			...
			List var5 = this.worldObj.getEntitiesWithinAABB(TheQueen.class, this.boundingBox.expand(32.0D, 32.0D, 32.0D));
			Iterator var2 = var5.iterator();
			Entity var3 = null;
			TheQueen var4 = null;
