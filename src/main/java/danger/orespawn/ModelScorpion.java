...
public class ModelScorpion extends ModelBase
{
	...
	public ModelScorpion(float f1)
	{
		...
		this.setRotation(this.larm2, 0.0F, ((float)Math.PI / 6F), 0.1745329F);
	...
	private void doLeftClaw(float angle)
	{
		...
		this.larm1.rotationPointZ = (float)((double)this.larm2.rotationPointZ - Math.sin((double)this.larm2.rotateAngleY) * 4.5D);
	...
	private void doRightClaw(float angle)
	{
		...
		this.rarm1.rotationPointZ = (float)((double)this.rarm2.rotationPointZ - Math.sin((double)this.rarm2.rotateAngleY) * 4.5D);
	...
	private void doTail(float angle)
	{
		...
		this.tail2.rotationPointY = (float)((double)this.tail1.rotationPointY - Math.sin((double)this.tail1.rotateAngleX) * 4.0D);
		this.tail2.rotationPointZ = (float)((double)this.tail1.rotationPointZ + Math.cos((double)this.tail1.rotateAngleX) * 4.0D);
		
		this.tail3.rotateAngleX = this.tail2.rotateAngleX + 0.701F + angle;
		this.tail3.rotationPointY = (float)((double)this.tail2.rotationPointY - Math.sin((double)this.tail2.rotateAngleX) * 4.0D);
		this.tail3.rotationPointZ = (float)((double)this.tail2.rotationPointZ + Math.cos((double)this.tail2.rotateAngleX) * 4.0D);
		
		this.tail4.rotateAngleX = this.tail3.rotateAngleX + -5.501F - angle * 3.0F / 2.0F - 0.4F;
		this.tail4.rotationPointY = (float)((double)this.tail3.rotationPointY - Math.sin((double)this.tail3.rotateAngleX) * 3.0D);
		this.tail4.rotationPointZ = (float)((double)this.tail3.rotationPointZ + Math.cos((double)this.tail3.rotateAngleX) * 3.0D);
		
		this.tail5.rotationPointY = (float)((double)this.tail4.rotationPointY - Math.sin((double)this.tail4.rotateAngleX) * 4.0D);
		this.tail5.rotationPointZ = (float)((double)this.tail4.rotationPointZ + Math.cos((double)this.tail4.rotateAngleX) * 4.0D);
		
		this.tail6.rotationPointY = (float)((double)this.tail5.rotationPointY - Math.sin((double)this.tail5.rotateAngleX) * 4.0D);
		this.tail6.rotationPointZ = (float)((double)this.tail5.rotationPointZ + Math.cos((double)this.tail5.rotateAngleX) * 4.0D);
	}
}
