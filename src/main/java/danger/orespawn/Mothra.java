...
public class Mothra extends EntityButterfly implements IMob {
	...
	protected void updateAITasks() {
		...
		if (!this.isDead) {
			...
			if (this.stuck_count <= 50 && this.worldObj.rand.nextInt(300) != 0 && !(this.currentFlightTarget.getDistanceSquared((int)this.posX, (int)this.posY, (int)this.posZ) < 9.0F)) {
				if (this.worldObj.rand.nextInt(10) == 0 && this.worldObj.difficultySetting != EnumDifficulty.PEACEFUL && OreSpawnMain.MothraPeaceful == 0) {
					EntityPlayer target = null;
					target = (EntityPlayer)this.worldObj.findNearestEntityWithinAABB(EntityPlayer.class, this.boundingBox.expand(25.0D, 20.0D, 25.0D), this);
					if (target != null) {
	...
	public boolean getCanSpawnHere() {
		...
		if (this.posY < (double)70.0F) {
			...
			Mothra target = null;
			target = (Mothra)this.worldObj.findNearestEntityWithinAABB(Mothra.class, this.boundingBox.expand((double)64.0F, 32.0D, (double)64.0F), this);
			if (target != null) {
				return false;
			} else {
				return true;
