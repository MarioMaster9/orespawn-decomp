...
public class Hammerhead extends EntityMob {
	...
	protected String getLivingSound() {
		return this.rand.nextInt(3) == 0 ? "orespawn:hammerhead_living" : null;
	}
	...
	private void dropItemRand(Item index, int par1) {
		EntityItem var3 = new EntityItem(this.worldObj, this.posX + (double)OreSpawnMain.OreSpawnRand.nextInt(5) - (double)OreSpawnMain.OreSpawnRand.nextInt(5), this.posY + 2.0D, this.posZ + (double)OreSpawnMain.OreSpawnRand.nextInt(5) - (double)OreSpawnMain.OreSpawnRand.nextInt(5), new ItemStack(index, par1, 0));
	...
	private boolean isSuitableTarget(EntityLivingBase par1EntityLiving, boolean par2) {
		if (par1EntityLiving == null) {
			...
			return false;
		} else if (par1EntityLiving instanceof Hammerhead) {
			return false;
	...
	private EntityLivingBase findSomethingToAttack() {
		if (OreSpawnMain.PlayNicely != 0) {
			...
			List var5 = this.worldObj.getEntitiesWithinAABB(EntityLivingBase.class, this.boundingBox.expand(18.0D, 9.0D, 18.0D));
	...
	public boolean getCanSpawnHere() {
		...
		if (!this.isValidLightLevel()) {
			...
			target = (Hammerhead)this.worldObj.findNearestEntityWithinAABB(Hammerhead.class, this.boundingBox.expand(16.0D, 8.0D, 16.0D), this);
			if (target != null) {
				return false;
			} else {
				return true;
