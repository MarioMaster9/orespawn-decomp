...
public class ThePrinceAdult extends EntityTameable {
	...
	protected void applyEntityAttributes() {
		...
		this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue((double)100.0F);
	}
	...
	public String getLivingSound() {
		if (this.isSitting()) {
			...
			return this.getActivity() == 1 && this.riddenByEntity == null ? "orespawn:king_living" : null;
		}
	}
	...
	public boolean attackEntityFrom(DamageSource par1DamageSource, float par2) {
		...
		if (this.hurt_timer > 0) {
			...
			if (e != null && e instanceof BetterFireball) {
				e.setDead();
				return ret;
			} else if (e != null && e instanceof EntitySmallFireball) {
				e.setDead();
				return ret;
			} else if (e != null && e instanceof ThePrinceAdult) {
				return false;
			...
			if (!this.isSitting()) {
				if (!this.worldObj.isRemote) {
					if (this.worldObj.rand.nextInt(5) == 1 && this.worldObj.difficultySetting != EnumDifficulty.PEACEFUL) {
						...
						if (e != null) {
							this.setAttacking(1);
							if (this.getDistanceSqToEntity(e) < (double)((10.0F + e.width / 2.0F) * (10.0F + e.width / 2.0F))) {
								this.attackEntityAsMob(e);
							} else if (this.getDistanceSqToEntity(e) < (double)625.0F && !this.isInWater() && this.getThePrinceAdultFire() != 0) {
	...
	private EntityLivingBase findSomethingToAttack() {
		if (OreSpawnMain.PlayNicely != 0) {
			...
			List var5 = this.worldObj.getEntitiesWithinAABB(EntityLivingBase.class, this.boundingBox.expand(32.0D, 20.0D, 32.0D));
	...
	private void fly_without_rider() {
		...
		if (this.riddenByEntity == null) {
			if (this.isTamed() && this.getOwner() != null) {
				...
				oy = e.posY;
				oz = e.posZ;
				if (this.getDistanceSqToEntity(e) > (double)400.0F) {
					toofar = 1;
					this.target_in_sight = false;
					this.setAttacking(0);
					this.setSitting(false);
			...
			if (!this.isSitting()) {
					...
					if (e != null) {
						if (this.isTamed() && this.getHealth() / (float)this.mygetMaxHealth() < 0.25F) {
							...
							if (this.getDistanceSqToEntity(e) < (double)((10.0F + e.width / 2.0F) * (10.0F + e.width / 2.0F))) {
								...
								do_new = 1;
							} else if (this.getDistanceSqToEntity(e) < (double)600.0F && !this.isInWater() && this.getThePrinceAdultFire() != 0 && this.worldObj.rand.nextInt(2) == 1) {
								this.shoot_something(e.posX, e.posY, e.posZ);
							}
						}
					} else {
				...
				if (this.owner_flying != 0) {
					...
					if (this.isTamed() && this.getOwner() != null) {
						e = this.getOwner();
						if (this.getDistanceSqToEntity(e) > (double)64.0F) {
				...
				if (this.getActivity() != 0) {
					...
					if (this.riddenByEntity == null) {
						...
						if (this.fireballticker == 0 && (pp.moveStrafing < -0.001F || pp.moveStrafing > 0.001F)) {
							double yoff = (double)9.5F;
							double xzoff = (double)14.5F;
							++this.which_attack;
							...
							if (this.which_attack == 0) {
								...
								double cx = this.posX - xzoff * Math.sin(Math.toRadians((double)(this.rotationYaw - 10.0F)));
								double cz = this.posZ + xzoff * Math.cos(Math.toRadians((double)(this.rotationYaw - 10.0F)));
						...
						this.motionZ *= 0.985;
						if (!this.worldObj.isRemote) {
							list = this.worldObj.getEntitiesWithinAABBExcludingEntity(this, this.boundingBox.expand((double)6.25F, 10.0D, (double)6.25F));
	...
	public boolean interact(EntityPlayer par1EntityPlayer) {
		...
		if (var2 != null && var2.getItem() == Item.getItemFromBlock(Blocks.diamond_block) && par1EntityPlayer.getDistanceSqToEntity(this) < 36.0D) {
			if (!this.worldObj.isRemote) {
			...
			if (this.isTamed()) {
				...
				if (var2 == null && par1EntityPlayer.getDistanceSqToEntity(this) < 36.0D) {
					if (!this.worldObj.isRemote) {
				...
				if (var2 != null && var2.getItem() == Items.beef && par1EntityPlayer.getDistanceSqToEntity(this) < 36.0D) {
					if (this.worldObj.isRemote) {
				...
				if (var2 != null && par1EntityPlayer.getDistanceSqToEntity(this) < 36.0D && var2.getItem() instanceof ItemFood) {
					if (!this.worldObj.isRemote) {
				...
				if (var2 != null && var2.getItem() == Item.getItemFromBlock(Blocks.ice) && par1EntityPlayer.getDistanceSqToEntity(this) < 36.0D) {
					if (!this.worldObj.isRemote) {
						this.playTameEffect(true);
						this.worldObj.setEntityState(this, (byte)6);
						this.setThePrinceAdultFire(0);
						String healthMessage = new String();
						healthMessage = String.format("Fireballs extinguished.");
				...
				if (var2 != null && var2.getItem() == Items.flint_and_steel && par1EntityPlayer.getDistanceSqToEntity(this) < 36.0D) {
					if (!this.worldObj.isRemote) {
						this.playTameEffect(true);
						this.worldObj.setEntityState(this, (byte)6);
						this.setThePrinceAdultFire(1);
						String healthMessage = new String();
						healthMessage = String.format("Fireballs lit!");
						par1EntityPlayer.addChatComponentMessage(new ChatComponentText(healthMessage));
					}
				...
				if (var2 != null && var2.getItem() == Items.diamond && par1EntityPlayer.getDistanceSqToEntity(this) < 36.0D && !this.worldObj.isRemote) {
					Entity ent = null;
				...
				if (this.isTamed() && var2 != null && var2.getItem() == Items.name_tag && par1EntityPlayer.getDistanceSqToEntity(this) < 36.0D && this.func_152114_e(par1EntityPlayer)) {
	...
	private void firecanonl(double x, double y, double z) {
		...
		double cz = this.posZ + xzoff * Math.cos(Math.toRadians((double)this.rotationYaw));
		this.worldObj.playSoundAtEntity(this, "random.bow", 1.0F, 1.0F / (this.getRNG().nextFloat() * 0.4F + 0.8F));
		float var10000 = 5.0F * (this.worldObj.rand.nextFloat() - this.worldObj.rand.nextFloat());
		var10000 = 3.0F * (this.worldObj.rand.nextFloat() - this.worldObj.rand.nextFloat());
		var10000 = 5.0F * (this.worldObj.rand.nextFloat() - this.worldObj.rand.nextFloat());
