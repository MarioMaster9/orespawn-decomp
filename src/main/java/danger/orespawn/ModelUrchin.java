...
public class ModelUrchin extends ModelBase
{
	...
	public ModelUrchin(float f1)
	{
		...
		this.setRotation(this.of1, 0.0F, 0.0F, (-(float)Math.PI / 6F));
		...
		this.setRotation(this.of2, 0.0F, 0.0F, ((float)Math.PI / 6F));
		...
		this.setRotation(this.of3, (-(float)Math.PI / 6F), 0.0F, 0.0F);
		...
		this.setRotation(this.of4, ((float)Math.PI / 6F), 0.0F, 0.0F);
		...
		this.setRotation(this.tos1, (-(float)Math.PI / 6F), 0.0F, 0.0F);
		...
		this.setRotation(this.tos2, 0.0F, 0.0F, (-(float)Math.PI / 6F));
		...
		this.setRotation(this.tos3, 0.0F, 0.0F, ((float)Math.PI / 6F));
		...
		this.setRotation(this.tos4, ((float)Math.PI / 6F), 0.0F, 0.0F);
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		if ((double)f1 > 0.1) {
			newangle = MathHelper.cos(f2 * 0.7F * this.wingspeed) * (float)Math.PI * 0.15F * f1;
			newangle1 = MathHelper.cos(f2 * 1.7F * this.wingspeed) * (float)Math.PI * 0.15F * f1;
			newangle2 = MathHelper.cos(f2 * 1.65F * this.wingspeed) * (float)Math.PI * 0.15F * f1;
			newangle3 = MathHelper.cos(f2 * 1.75F * this.wingspeed) * (float)Math.PI * 0.15F * f1;
			newangle4 = MathHelper.cos(f2 * 1.8F * this.wingspeed) * (float)Math.PI * 0.15F * f1;
		} else {
			newangle = 0.0F;
			newangle1 = 0.0F;
			newangle2 = 0.0F;
		...
		if (u.getAttacking() != 0) {
			newangle = (float)((double)(f2 * 0.2F) % (Math.PI * 2D));
			newangle1 = MathHelper.cos(f2 * 0.7F * this.wingspeed) * (float)Math.PI * 0.06F;
			newangle2 = MathHelper.cos(f2 * 0.65F * this.wingspeed) * (float)Math.PI * 0.06F;
			newangle3 = MathHelper.cos(f2 * 0.75F * this.wingspeed) * (float)Math.PI * 0.06F;
			newangle4 = MathHelper.cos(f2 * 0.8F * this.wingspeed) * (float)Math.PI * 0.06F;
			newangle5 = MathHelper.cos(f2 * 0.55F * this.wingspeed) * (float)Math.PI * 0.06F;
			newangle6 = MathHelper.cos(f2 * 0.45F * this.wingspeed) * (float)Math.PI * 0.06F;
			newangle7 = MathHelper.cos(f2 * 0.35F * this.wingspeed) * (float)Math.PI * 0.06F;
			newangle8 = MathHelper.cos(f2 * 0.4F * this.wingspeed) * (float)Math.PI * 0.06F;
		} else {
			newangle = (float)((double)(f2 * 0.02F) % (Math.PI * 2D));
			newangle1 = MathHelper.cos(f2 * 0.07F * this.wingspeed) * (float)Math.PI * 0.02F;
			newangle2 = MathHelper.cos(f2 * 0.065F * this.wingspeed) * (float)Math.PI * 0.02F;
			newangle3 = MathHelper.cos(f2 * 0.075F * this.wingspeed) * (float)Math.PI * 0.02F;
			newangle4 = MathHelper.cos(f2 * 0.08F * this.wingspeed) * (float)Math.PI * 0.02F;
			newangle5 = MathHelper.cos(f2 * 0.055F * this.wingspeed) * (float)Math.PI * 0.02F;
			newangle6 = MathHelper.cos(f2 * 0.045F * this.wingspeed) * (float)Math.PI * 0.02F;
			newangle7 = MathHelper.cos(f2 * 0.035F * this.wingspeed) * (float)Math.PI * 0.02F;
			newangle8 = MathHelper.cos(f2 * 0.04F * this.wingspeed) * (float)Math.PI * 0.02F;
		}
