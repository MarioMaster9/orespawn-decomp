...
public class Cephadrome extends EntityCreature {
	...
	public String getLivingSound() {
		return this.getActivity() != 1 && this.rand.nextInt(6) == 1 ? "orespawn:MothraWings" : null;
	}
		...
		for (int var8 = 0; var8 < i; ++var8) {
			...
			switch (var3) {
				...
				case 1:
					...
					break;
				case 2:
					ItemStack var20 = this.dropItemRand(OreSpawnMain.MyThunderStaff, 1);
					break;
				case 3:
					ItemStack var19 = this.dropItemRand(OreSpawnMain.MyRubySword, 1);
					...
					break;
				case 4:
					ItemStack var18 = this.dropItemRand(OreSpawnMain.MyRubyShovel, 1);
					if (this.worldObj.rand.nextInt(2) == 1) {
					...
					break;
				case 5:
					ItemStack var17 = this.dropItemRand(OreSpawnMain.MyRubyPickaxe, 1);
					if (this.worldObj.rand.nextInt(2) == 1) {
					...
					break;
				case 6:
					ItemStack var16 = this.dropItemRand(OreSpawnMain.MyRubyAxe, 1);
					if (this.worldObj.rand.nextInt(2) == 1) {
					...
					break;
				case 7:
					ItemStack var15 = this.dropItemRand(OreSpawnMain.MyRubyHoe, 1);
					if (this.worldObj.rand.nextInt(2) == 1) {
					...
					break;
				case 8:
					ItemStack var14 = this.dropItemRand(OreSpawnMain.RubyHelmet, 1);
					if (this.worldObj.rand.nextInt(6) == 1) {
					...
					break;
				case 9:
					ItemStack var13 = this.dropItemRand(OreSpawnMain.RubyBody, 1);
					if (this.worldObj.rand.nextInt(6) == 1) {
					...
					break;
				case 10:
					ItemStack var12 = this.dropItemRand(OreSpawnMain.RubyLegs, 1);
					if (this.worldObj.rand.nextInt(6) == 1) {
					...
					break;
				case 11:
					ItemStack var11 = this.dropItemRand(OreSpawnMain.RubyBoots, 1);
					if (this.worldObj.rand.nextInt(6) == 1) {
	...
	private boolean isSuitableTarget(EntityLivingBase par1EntityLiving, boolean par2) {
		if (this.worldObj.difficultySetting == EnumDifficulty.PEACEFUL) {
			...
			if (p.capabilities.isCreativeMode) {
				return false;
			} else if (this.hit_by_player != 0) {
				return true;
			} else if (this.badmood != 0) {
				return true;
			} else if (this.shouldattack > 0) {
				this.shouldattack = 0;
				return true;
			} else {
				return false;
		...
		if (!this.isDead) {
			if (this.worldObj.isRemote) {
				...
				if (this.riddenByEntity != null) {
					...
					pi = 3.1415926545;
					deltav = 0.0D;
					double im = (double)pp.moveForward;
	...
	public boolean interact(EntityPlayer par1EntityPlayer) {
		...
		if (var2 != null && (var2.getItem() == Items.beef || var2.getItem() == Items.chicken || var2.getItem() == Items.porkchop) && par1EntityPlayer.getDistanceSqToEntity(this) < 25.0D) {
			...
			if (var2 == null && par1EntityPlayer.getDistanceSqToEntity(this) < 25.0D && !this.worldObj.isRemote) {
				if (this.wasfed == 0) {
