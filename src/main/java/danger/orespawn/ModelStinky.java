...
public class ModelStinky extends ModelBase
{
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		newangle = MathHelper.cos(f2 * 1.0F * this.wingspeed) * (float)Math.PI * 0.2F;
		if (c.isSitting() == true) {
			newangle = 0.0F;
		}
		this.tail2.rotateAngleY = newangle;
		
		this.tail3.rotationPointZ = this.tail2.rotationPointZ + (float)Math.cos((double)this.tail2.rotateAngleY) * 4.0F;
		this.tail3.rotationPointX = this.tail2.rotationPointX + (float)Math.sin((double)this.tail2.rotateAngleY) * 4.0F - 0.5F;
		this.tail3.rotateAngleY = newangle * 1.6F;
		
		this.tail4.rotationPointZ = this.tail3.rotationPointZ + (float)Math.cos((double)this.tail3.rotateAngleY) * 3.0F;
		this.tail4.rotationPointX = this.tail3.rotationPointX + (float)Math.sin((double)this.tail3.rotateAngleY) * 3.0F - 0.5F;
		...
		this.snout.rotateAngleY = (float)Math.toRadians((double)f3);
		this.neck.rotateAngleY = (float)Math.toRadians((double)f3) / 2.0F;
		this.Rhorn1.rotateAngleY = (float)Math.toRadians((double)f3);
		this.Rhorn2.rotateAngleY = (float)Math.toRadians((double)f3);
		this.Lhorn1.rotateAngleY = (float)Math.toRadians((double)f3);
		this.Lhorn2.rotateAngleY = (float)Math.toRadians((double)f3);
		
		
		
		
		this.head.rotateAngleX = (float)Math.toRadians((double)f4) / 3.0F;
		this.snout.rotateAngleX = (float)Math.toRadians((double)f4) / 3.0F;
		this.neck.rotateAngleX = (float)Math.toRadians((double)f4) / 3.0F;
		this.Rhorn1.rotateAngleX = (float)Math.toRadians((double)f4) / 3.0F;
		this.Rhorn2.rotateAngleX = (float)Math.toRadians((double)f4) / 3.0F;
		this.Lhorn1.rotateAngleX = (float)Math.toRadians((double)f4) / 3.0F;
		this.Lhorn2.rotateAngleX = (float)Math.toRadians((double)f4) / 3.0F;
