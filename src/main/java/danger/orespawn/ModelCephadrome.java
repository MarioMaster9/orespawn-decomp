...
public class ModelCephadrome extends ModelBase
{
	...
	public ModelCephadrome(float f1)
	{
		...
		this.setRotation(this.topmem2, (-(float)Math.PI / 6F), 0.0F, 0.0F);
		...
		this.setRotation(this.leftwingfin3, -0.2617994F, (-(float)Math.PI / 4F), 0.0F);
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		if ((double)f1 > 0.001) {
			...
			newangle = MathHelper.cos(f2 * 0.75F * this.wingspeed) * (float)Math.PI * lspeed * 0.4F;
			if ((double)newangle > 0.5D) newangle = 0.75F;
			if ((double)newangle < -0.5D) newangle = -0.75F;
		} else {
			newangle = 0.0F;
		}
		...
		if (e.getActivity() != 0) {
			...
			newangle = -0.65F + MathHelper.cos(f2 * 0.9F * this.wingspeed) * (float)Math.PI * 0.068F;
		}
		...
		this.tail2.rotationPointZ = this.tail1.rotationPointZ + (float)Math.cos((double)this.tail1.rotateAngleY) * 13.0F;
		this.tail2.rotationPointX = this.tail1.rotationPointX + 1.5F + (float)Math.sin((double)this.tail1.rotateAngleY) * 13.0F;
		this.tail2.rotateAngleY = MathHelper.cos(f2 * tailspeed * this.wingspeed - pi4) * (float)Math.PI * tailamp;
		
		this.tail3.rotationPointZ = this.tail2.rotationPointZ + (float)Math.cos((double)this.tail2.rotateAngleY) * 13.0F;
		this.tail3.rotationPointX = this.tail2.rotationPointX - 0.5F + (float)Math.sin((double)this.tail2.rotateAngleY) * 13.0F;
		this.tail3.rotateAngleY = MathHelper.cos(f2 * tailspeed * this.wingspeed - 2.0F * pi4) * (float)Math.PI * tailamp;
		
		this.tailfin1.rotationPointZ = this.tail3.rotationPointZ + (float)Math.cos((double)this.tail3.rotateAngleY) * 10.0F;
		this.tailfin1.rotationPointX = this.tail3.rotationPointX - 1.0F + (float)Math.sin((double)this.tail3.rotateAngleY) * 10.0F;
		...
		this.neck2.rotationPointZ = this.neck3.rotationPointZ - (float)Math.cos((double)this.neck3.rotateAngleY) * 14.0F;
		this.neck2.rotationPointX = this.neck3.rotationPointX + 0.5F - (float)Math.sin((double)this.neck3.rotateAngleY) * 14.0F;
		this.neck2.rotateAngleY = (float)Math.toRadians((double)f3) * 0.25F;
		this.neck1.rotationPointZ = this.neck2.rotationPointZ - (float)Math.cos((double)this.neck2.rotateAngleY) * 14.0F;
		this.neck1.rotationPointX = this.neck2.rotationPointX + 0.5F - (float)Math.sin((double)this.neck2.rotateAngleY) * 14.0F;
		this.neck1.rotateAngleY = (float)Math.toRadians((double)f3) * 0.5F;
		this.head.rotationPointZ = this.neck1.rotationPointZ - (float)Math.cos((double)this.neck1.rotateAngleY) * 8.0F;
		this.head.rotationPointX = this.neck1.rotationPointX - (float)Math.sin((double)this.neck1.rotateAngleY) * 8.0F;
		...
		newangle = MathHelper.cos(f2 * 0.5F * this.wingspeed) * (float)Math.PI * 0.14F;
