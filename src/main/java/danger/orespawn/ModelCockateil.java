...
public class ModelCockateil extends ModelBase
{
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		newangle = MathHelper.cos(f2 * 1.5F * this.wingspeed) * (float)Math.PI * 0.35F;
		...
		newangle = MathHelper.cos(f2 * 1.1F * this.wingspeed) * (float)Math.PI * 0.08F;
		this.feather1.rotateAngleZ = newangle;
		newangle = MathHelper.cos(f2 * 1.2F * this.wingspeed) * (float)Math.PI * 0.08F;
		this.feather2.rotateAngleZ = newangle;
		newangle = MathHelper.cos(f2 * 1.3F * this.wingspeed) * (float)Math.PI * 0.08F;
