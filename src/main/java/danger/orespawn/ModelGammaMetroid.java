...
public class ModelGammaMetroid extends ModelBase
{
	...
	public ModelGammaMetroid(float f1)
	{
		...
		this.setRotation(this.Shell3, -0.9599311F, 0.6283185F, ((float)Math.PI / 6F));
		...
		this.setRotation(this.BeakUpper, 0.1047198F, ((float)Math.PI / 4F), 0.1047198F);
		...
		this.setRotation(this.BeakLower, 0.1396263F, ((float)Math.PI / 4F), 0.1396263F);
		...
		this.setRotation(this.Shell1, 0.0F, 0.0F, ((float)Math.PI / 4F));
		...
		this.setRotation(this.Shell2, (-(float)Math.PI / 6F), 0.3665191F, 0.715585F);
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		newangle = MathHelper.cos(f2 * 0.81F * this.wingspeed) * (float)Math.PI * 0.08F;
		this.LeftTusk.rotateAngleX = newangle;
		newangle = MathHelper.cos(f2 * 0.87F * this.wingspeed) * (float)Math.PI * 0.08F;
		this.RightTusk.rotateAngleX = newangle;
		newangle = MathHelper.cos(f2 * 0.99F * this.wingspeed) * (float)Math.PI * 0.08F;
		this.MiddleTusk.rotateAngleX = newangle;
		newangle = MathHelper.cos(f2 * 1.11F * this.wingspeed) * (float)Math.PI * 0.08F;
		this.LeftTusk.rotateAngleY = newangle;
		newangle = MathHelper.cos(f2 * 1.17F * this.wingspeed) * (float)Math.PI * 0.08F;
		this.RightTusk.rotateAngleY = newangle;
		newangle = MathHelper.cos(f2 * 1.25F * this.wingspeed) * (float)Math.PI * 0.08F;
		...
		newangle = MathHelper.cos(f2 * 0.75F * this.wingspeed) * (float)Math.PI * 0.1F;
	...
	private void doLeftFLeg(ModelRenderer seg2, ModelRenderer seg3, float angle, float upangle)
	{
		...
		seg3.rotationPointZ = (float)((double)seg2.rotationPointZ + Math.sin((double)seg2.rotateAngleX) * 7.0D) - 0.5F;
		
		
		seg2.rotateAngleZ = -upangle - 0.66F;
		seg3.rotateAngleZ = -upangle;
		seg3.rotationPointY = seg2.rotationPointY + (float)(5.0D * Math.cos((double)seg2.rotateAngleX));
		seg3.rotationPointX = (float)((double)seg2.rotationPointX + Math.abs(Math.sin((double)seg2.rotateAngleZ) * 7.0D) + 1.0D);
	...
	private void doLeftRLeg(ModelRenderer seg2, ModelRenderer seg3, float angle, float upangle)
	{
		...
		seg3.rotateAngleZ = -upangle;
		seg3.rotationPointY = seg2.rotationPointY + (float)(5.0D * Math.cos((double)seg2.rotateAngleX));
		seg3.rotationPointX = (float)((double)seg2.rotationPointX + Math.abs(Math.sin((double)seg2.rotateAngleZ) * 7.0D) + 1.5D);
	}
