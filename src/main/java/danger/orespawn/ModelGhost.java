...
public class ModelGhost extends ModelBase
{
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		this.LArm.rotateAngleZ = -0.33F + MathHelper.cos(f2 * 0.3F) * (float)Math.PI * 0.05F;
		this.RArm.rotateAngleZ = 0.33F + MathHelper.cos(f2 * 0.32F) * (float)Math.PI * 0.05F;
		this.LArm.rotateAngleX = -0.33F + MathHelper.cos(f2 * 0.34F) * (float)Math.PI * 0.05F;
		this.RArm.rotateAngleX = 0.33F + MathHelper.cos(f2 * 0.36F) * (float)Math.PI * 0.05F;
