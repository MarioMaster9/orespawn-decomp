...
public class ItemThunderStaff extends Item
{
	...
	public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
	{
		...
		else
		{
			xzoff = 1.0D;
			yoff = 1.55;
			lb = new ThunderBolt(par2World, par3EntityPlayer);
			...
			par3EntityPlayer.addVelocity(Math.cos(Math.toRadians((double)(par3EntityPlayer.rotationYawHead - 90.0F))) * 0.5D, 0.15, Math.sin(Math.toRadians((double)(par3EntityPlayer.rotationYawHead - 90.0F))) * 0.5D);
