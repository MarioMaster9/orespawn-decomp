...
public class BlockTomato extends BlockReed
{
	...
	public void updateTick(World par1World, int par2, int par3, int par4, Random par5Random)
	{
		...
		if (this != OreSpawnMain.MyTomatoPlant1 && this != OreSpawnMain.MyTomatoPlant2) return;
		
		int var7 = par1World.getBlockMetadata(par2, par3, par4);
		this.myMaxHeight = var7 >> 8;
		var7 &= 255;
		
		if (this.myMaxHeight == 0) this.myMaxHeight = 3 + OreSpawnMain.OreSpawnRand.nextInt(3);
