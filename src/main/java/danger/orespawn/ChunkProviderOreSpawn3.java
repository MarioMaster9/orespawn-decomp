...
public class ChunkProviderOreSpawn3 implements IChunkProvider
{
	...
	public void populate(IChunkProvider par1IChunkProvider, int par2, int par3)
	{
		...
		if (biomegenbase != BiomeGenBase.desert && biomegenbase != BiomeGenBase.desertHills && !flag && this.rand.nextInt(4) == 0 && TerrainGen.populate(par1IChunkProvider, this.worldObj, this.rand, par2, par3, flag, EventType.LAKE))
		{
