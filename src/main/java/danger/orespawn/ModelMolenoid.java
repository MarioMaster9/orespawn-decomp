...
public class ModelMolenoid extends ModelBase
{
	...
	public ModelMolenoid(float f1)
	{
		...
		this.setRotation(this.nosestar4, 0.0F, 0.0F, ((float)Math.PI / 6F));
		...
		this.setRotation(this.nosestar6, 0.0F, 0.0F, (-(float)Math.PI / 6F));
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		if (e.getAttacking() != 0) {
			newangle = MathHelper.cos(f2 * 1.7F * this.wingspeed) * (float)Math.PI * 0.25F;
		}
		else if (f1 > 0.1F) {
		...
		this.lhand.rotationPointZ = this.larm.rotationPointZ - (float)Math.sin((double)this.larm.rotateAngleY) * 15.0F;
		this.lhand.rotationPointX = this.larm.rotationPointX + (float)Math.cos((double)this.larm.rotateAngleY) * 15.0F;
		this.lhand.rotateAngleY = newangle * 1.25F;
		this.lclaw1.rotationPointZ = this.lhand.rotationPointZ - (float)Math.sin((double)this.lhand.rotateAngleY) * 10.0F;
		this.lclaw1.rotationPointX = this.lhand.rotationPointX + (float)Math.cos((double)this.lhand.rotateAngleY) * 10.0F;
		...
		this.rhand.rotationPointZ = this.rarm.rotationPointZ + (float)Math.sin((double)this.rarm.rotateAngleY) * 15.0F;
		this.rhand.rotationPointX = this.rarm.rotationPointX - (float)Math.cos((double)this.rarm.rotateAngleY) * 15.0F;
		this.rhand.rotateAngleY = newangle * 1.25F;
		this.rclaw1.rotationPointZ = this.rhand.rotationPointZ + (float)Math.sin((double)this.rhand.rotateAngleY) * 10.0F;
		this.rclaw1.rotationPointX = this.rhand.rotationPointX - (float)Math.cos((double)this.rhand.rotateAngleY) * 10.0F;
		...
		this.lfoot.rotationPointZ = this.lleg.rotationPointZ - (float)Math.sin((double)this.lleg.rotateAngleY) * 15.0F;
		this.lfoot.rotationPointX = this.lleg.rotationPointX + (float)Math.cos((double)this.lleg.rotateAngleY) * 15.0F;
		this.lfoot.rotateAngleY = -newangle * 1.25F;
		this.ltoe1.rotationPointZ = this.lfoot.rotationPointZ - (float)Math.sin((double)this.lfoot.rotateAngleY) * 10.0F;
		this.ltoe1.rotationPointX = this.lfoot.rotationPointX + (float)Math.cos((double)this.lfoot.rotateAngleY) * 10.0F;
		...
		this.rfoot.rotationPointZ = this.rleg.rotationPointZ + (float)Math.sin((double)this.rleg.rotateAngleY) * 15.0F;
		this.rfoot.rotationPointX = this.rleg.rotationPointX - (float)Math.cos((double)this.rleg.rotateAngleY) * 15.0F;
		this.rfoot.rotateAngleY = -newangle * 1.25F;
		this.rtoe1.rotationPointZ = this.rfoot.rotationPointZ + (float)Math.sin((double)this.rfoot.rotateAngleY) * 10.0F;
		this.rtoe1.rotationPointX = this.rfoot.rotationPointX - (float)Math.cos((double)this.rfoot.rotateAngleY) * 10.0F;
		...
		newangle = MathHelper.cos(f2 * 0.1F * this.wingspeed) * (float)Math.PI;
