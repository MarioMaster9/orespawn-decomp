...
public class KrakenRepellent extends BlockTorch {
	...
	public void randomDisplayTick(World par1World, int par2, int par3, int par4, Random par5Random) {
		...
		if (var6 == 1) {
			...
			par1World.spawnParticle("smoke", var7, var9 + 0.21, var11, 0.0D, 0.0D, 0.0D);
			par1World.spawnParticle("flame", var7, var9 + 0.21, var11, 0.0D, 0.0D, 0.0D);
			par1World.spawnParticle("reddust", var7, var9 + 0.21, var11, 0.0D, 0.0D, 0.0D);
		}
	...
	private void findSomethingToRepell(World par1World, int par2, int par3, int par4) {
		AxisAlignedBB bb = AxisAlignedBB.getBoundingBox((double)par2 - 20.0D, (double)par3 - 10.0D, (double)par4 - 20.0D, (double)par2 + 20.0D, (double)par3 + (double)40.0F, (double)par4 + 20.0D);
		...
		while (var2.hasNext()) {
			...
			if (var3 != null && var3 instanceof Kraken) {
				...
				double d2 = var3.posY - 15.0D - (double)par3;
				...
				f *= 0.4;
				double d = (double)((float)Math.atan2(var3.posX - (double)par2, var3.posZ - (double)par4));
