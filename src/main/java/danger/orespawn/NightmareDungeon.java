...
public class NightmareDungeon
{
	...
	public void makeDungeon(World world, int cposx, int cposy, int cposz)
	{
		...
		world.setBlock(cposx + width / 2 + 1, cposy + 1, cposz + width / 2 + 1, Blocks.chest, 0, 2);
