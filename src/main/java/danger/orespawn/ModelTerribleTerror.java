...
public class ModelTerribleTerror extends ModelBase
{
	...
	public ModelTerribleTerror()
	{
		...
		this.setRotation(this.Tail1, (-(float)Math.PI / 6F), 0.0F, 0.0F);
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		newangle = MathHelper.cos(f2 * 1.3F * this.wingspeed) * (float)Math.PI * 0.25F;
		...
		newangle = MathHelper.cos(f2 * 1.25F) * (float)Math.PI * 0.35F;
		...
		newangle = MathHelper.cos(f2 * 0.71F * this.wingspeed) * (float)Math.PI * 0.1F;
		this.Tail1.rotateAngleX = newangle;
		newangle = MathHelper.cos(f2 * 0.77F * this.wingspeed) * (float)Math.PI * 0.1F;
		this.Tail1.rotateAngleY = newangle;
		
		float dist = 6.0F;
		dist = (float)((double)dist * Math.cos((double)this.Tail1.rotateAngleX));
		this.Tail2.rotationPointY = (float)((double)this.Tail1.rotationPointY - Math.sin((double)this.Tail1.rotateAngleX) * (double)dist);
		this.Tail2.rotationPointX = (float)((double)this.Tail1.rotationPointX + Math.sin((double)this.Tail1.rotateAngleY) * (double)dist);
		
		newangle = MathHelper.cos(f2 * 0.81F * this.wingspeed) * (float)Math.PI * 0.15F;
		this.Tail2.rotateAngleX = newangle;
		newangle = MathHelper.cos(f2 * 0.87F * this.wingspeed) * (float)Math.PI * 0.15F;
		this.Tail2.rotateAngleY = newangle;
		
		dist = 6.0F;
		dist = (float)((double)dist * Math.cos((double)this.Tail2.rotateAngleX));
		this.Tail3.rotationPointY = this.Tail4.rotationPointY = (float)((double)this.Tail2.rotationPointY - Math.sin((double)this.Tail2.rotateAngleX) * (double)dist);
		this.Tail3.rotationPointX = this.Tail4.rotationPointX = (float)((double)this.Tail2.rotationPointX + Math.sin((double)this.Tail2.rotateAngleY) * (double)dist);
		
		newangle = MathHelper.cos(f2 * 0.91F * this.wingspeed) * (float)Math.PI * 0.2F;
		this.Tail3.rotateAngleX = this.Tail4.rotateAngleX = newangle;
		newangle = MathHelper.cos(f2 * 0.97F * this.wingspeed) * (float)Math.PI * 0.2F;
		this.Tail3.rotateAngleY = this.Tail4.rotateAngleY = newangle;
