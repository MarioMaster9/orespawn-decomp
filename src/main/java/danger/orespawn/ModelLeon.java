...
public class ModelLeon extends ModelBase
{
	...
	public ModelLeon(float f1)
	{
		...
		this.setRotation(this.wing_2_L, (-(float)Math.PI / 6F), -0.0349066F, -0.4712389F);
		...
		this.setRotation(this.wing_2_R, (-(float)Math.PI / 6F), 0.0349066F, 0.4712389F);
		...
		this.setRotation(this.wing_3_L, -0.4886922F, (-(float)Math.PI / 6F), 0.4014257F);
		...
		this.setRotation(this.wing_3_R, -0.4886922F, ((float)Math.PI / 6F), -0.4014257F);
		...
		this.setRotation(this.fwing_2_L, (-(float)Math.PI / 6F), -0.0349066F, -0.4712389F);
		...
		this.setRotation(this.fwing_2_R, (-(float)Math.PI / 6F), 0.0349066F, 0.4712389F);
		...
		this.setRotation(this.fwing_3_L, -0.4886922F, (-(float)Math.PI / 6F), 0.4014257F);
		...
		this.setRotation(this.fwing_3_R, -0.4886922F, ((float)Math.PI / 6F), -0.4014257F);
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		if ((double)f1 > 0.1) {
			newangle = MathHelper.cos(f2 * 1.8F * this.wingspeed) * (float)Math.PI * 0.25F * f1;
			newangle2 = MathHelper.cos(f2 * 0.9F * this.wingspeed) * (float)Math.PI * 0.25F * f1;
		} else {
			newangle = 0.0F;
			newangle2 = MathHelper.cos(f2 * 0.9F * this.wingspeed) * (float)Math.PI * 0.02F;
			if (e.isSitting()) newangle2 = 0.0F;
		...
		if (e.getActivity() == 0)
		{
			...
			this.leg_2_L.rotationPointZ = (float)((double)this.leg_1_L.rotationPointZ + Math.sin((double)this.leg_1_L.rotateAngleX) * 9.0D);
			this.leg_2_L.rotationPointY = (float)((double)this.leg_1_L.rotationPointY + Math.cos((double)this.leg_1_L.rotateAngleX) * 9.0D);
			this.leg_2_R.rotateAngleX = 0.611F - newangle;
			this.leg_2_R.rotationPointZ = (float)((double)this.leg_1_R.rotationPointZ + Math.sin((double)this.leg_1_R.rotateAngleX) * 9.0D);
			this.leg_2_R.rotationPointY = (float)((double)this.leg_1_R.rotationPointY + Math.cos((double)this.leg_1_R.rotateAngleX) * 9.0D);
			this.footL.rotationPointZ = (float)((double)this.leg_2_L.rotationPointZ + Math.sin((double)this.leg_2_L.rotateAngleX) * 13.0D);
			this.footL.rotationPointY = (float)((double)this.leg_2_L.rotationPointY + Math.cos((double)this.leg_2_L.rotateAngleX) * 13.0D);
			this.footR.rotationPointZ = (float)((double)this.leg_2_R.rotationPointZ + Math.sin((double)this.leg_2_R.rotateAngleX) * 11.0D);
			this.footR.rotationPointY = (float)((double)this.leg_2_R.rotationPointY + Math.cos((double)this.leg_2_R.rotateAngleX) * 11.0D);
			...
			this.arm_2_L.rotationPointZ = this.wing_2_L.rotationPointZ = (float)((double)this.arm_1_L.rotationPointZ + Math.sin((double)this.arm_1_L.rotateAngleX) * 11.0D);
			this.arm_2_L.rotationPointY = this.wing_2_L.rotationPointY = (float)((double)this.arm_1_L.rotationPointY + Math.cos((double)this.arm_1_L.rotateAngleX) * 11.0D);
			...
			this.wing_5_L.rotationPointZ = (float)((double)this.arm_2_L.rotationPointZ + Math.sin((double)this.arm_2_L.rotateAngleX) * 20.0D);
			this.wing_5_L.rotationPointY = (float)((double)this.arm_2_L.rotationPointY + Math.cos((double)this.arm_2_L.rotateAngleX) * 20.0D);
			...
			this.arm_2_R.rotationPointZ = this.wing_2_R.rotationPointZ = (float)((double)this.arm_1_R.rotationPointZ + Math.sin((double)this.arm_1_R.rotateAngleX) * 11.0D);
			this.arm_2_R.rotationPointY = this.wing_2_R.rotationPointY = (float)((double)this.arm_1_R.rotationPointY + Math.cos((double)this.arm_1_R.rotateAngleX) * 11.0D);
			...
			this.wing_5_R.rotationPointZ = (float)((double)this.arm_2_R.rotationPointZ + Math.sin((double)this.arm_2_R.rotateAngleX) * 20.0D);
			this.wing_5_R.rotationPointY = (float)((double)this.arm_2_R.rotationPointY + Math.cos((double)this.arm_2_R.rotateAngleX) * 20.0D);
			...
			newangle2 = MathHelper.cos(f2 * 0.6F * this.wingspeed) * (float)Math.PI * 0.02F;
			...
			this.head.rotateAngleY = this.upper_jaw.rotateAngleY = this.upper_sail_1.rotateAngleY = this.upper_sail2_.rotateAngleY = this.upper_sail3.rotateAngleY = newangle;
			...
			this.bottom_jaw.rotateAngleY = this.lower_sail1.rotateAngleY = this.lower_sail2.rotateAngleY = this.lower_sail_3.rotateAngleY = newangle;
			this.bottom_jaw.rotationPointZ = (float)((double)this.head.rotationPointZ - Math.cos((double)newangle) * 5.0D);
			this.bottom_jaw.rotationPointX = (float)((double)this.head.rotationPointX - Math.sin((double)newangle) * 5.0D);
		...
		else
		{
			...
			newangle2 = MathHelper.cos(f2 * 1.6F * this.wingspeed * spd) * (float)Math.PI * 0.06F;
			...
			if (e.getBeingRidden() == 0) {
				this.fchest.rotationPointY = (float)((double)-2.0F + Math.sin((double)newangle2) * 10.0D * (double)amp);
			} else {
			...
			this.fabdomen.rotationPointZ = (float)((double)this.fchest.rotationPointZ + Math.cos((double)this.fchest.rotateAngleX) * 8.0D);
			this.fabdomen.rotationPointY = (float)((double)this.fchest.rotationPointY - Math.sin((double)this.fchest.rotateAngleX) * 8.0D - 6.0D);
			...
			if (e.getAttacking() == 0) {
				...
				this.fleg_2_L.rotationPointZ = (float)((double)this.fleg_1_L.rotationPointZ + Math.sin((double)this.fleg_1_L.rotateAngleX) * 9.0D);
				this.fleg_2_L.rotationPointY = (float)((double)this.fleg_1_L.rotationPointY + Math.cos((double)this.fleg_1_L.rotateAngleX) * 9.0D);
				this.fleg_2_R.rotateAngleX = 0.1F + newangle;
				this.fleg_2_R.rotationPointZ = (float)((double)this.fleg_1_R.rotationPointZ + Math.sin((double)this.fleg_1_R.rotateAngleX) * 9.0D);
				this.fleg_2_R.rotationPointY = (float)((double)this.fleg_1_R.rotationPointY + Math.cos((double)this.fleg_1_R.rotateAngleX) * 9.0D);
				this.ffootL.rotationPointZ = (float)((double)this.fleg_2_L.rotationPointZ + Math.sin((double)this.fleg_2_L.rotateAngleX) * 13.0D);
				this.ffootL.rotationPointY = (float)((double)this.fleg_2_L.rotationPointY + Math.cos((double)this.fleg_2_L.rotateAngleX) * 13.0D);
				this.ffootR.rotationPointZ = (float)((double)this.fleg_2_R.rotationPointZ + Math.sin((double)this.fleg_2_R.rotateAngleX) * 11.0D);
				this.ffootR.rotationPointY = (float)((double)this.fleg_2_R.rotationPointY + Math.cos((double)this.fleg_2_R.rotateAngleX) * 11.0D);
			...
			{
				newangle = (-(float)Math.PI / 4F);
				newangle3 = MathHelper.cos(f2 * 3.6F * this.wingspeed) * (float)Math.PI * 0.1F;
				this.fleg_1_L.rotationPointY = this.fabdomen.rotationPointY + 5.0F;
				this.fleg_1_R.rotationPointY = this.fabdomen.rotationPointY + 5.0F;
				...
				this.ffootR.rotationPointZ = (float)((double)this.fleg_2_R.rotationPointZ + Math.sin((double)this.fleg_2_R.rotateAngleX) * 11.0D);
				this.ffootR.rotationPointY = (float)((double)this.fleg_2_R.rotationPointY + Math.cos((double)this.fleg_2_R.rotateAngleX) * 11.0D);
				this.ffootL.rotateAngleX = (-(float)Math.PI / 4F) + newangle3 * 2.0F;
				this.ffootR.rotateAngleX = (-(float)Math.PI / 4F) - newangle3 * 2.0F;
			...
			newangle = MathHelper.cos(f2 * 1.6F * this.wingspeed * spd) * (float)Math.PI * 0.26F * amp;
			
			this.farm_1_L.rotateAngleZ = (float)((-Math.PI / 2D) - (double)newangle);
			this.farm_1_R.rotateAngleZ = (float)((Math.PI / 2D) + (double)newangle);
			this.fwing_1_L.rotateAngleZ = (float)((-Math.PI / 2D) - (double)newangle);
			this.fwing_1_R.rotateAngleZ = (float)((Math.PI / 2D) + (double)newangle);
			
			this.farm_2_L.rotateAngleZ = (float)((-Math.PI / 2D) - (double)(newangle * 1.3F));
			this.fwing_2_L.rotateAngleZ = (float)((-Math.PI / 2D) - (double)(newangle * 1.3F));
			this.farm_2_L.rotationPointX = this.fwing_2_L.rotationPointX = (float)((double)this.farm_1_L.rotationPointX + Math.cos((double)newangle) * 14.0D);
			this.farm_2_L.rotationPointY = this.fwing_2_L.rotationPointY = (float)((double)this.farm_1_L.rotationPointY - Math.sin((double)newangle) * 14.0D);
			
			this.fwing_5_L.rotationPointX = (float)((double)this.farm_2_L.rotationPointX + Math.cos((double)(newangle * 1.3F)) * 20.0D);
			this.fwing_5_L.rotationPointY = (float)((double)this.farm_2_L.rotationPointY - Math.sin((double)(newangle * 1.3F)) * 20.0D);
			...
			this.fwing_5_L.rotateAngleZ = (float)((-Math.PI / 2D) - (double)(newangle * 1.65F));
			this.fwing_6_L.rotateAngleZ = (float)((-Math.PI / 2D) - (double)(newangle * 1.65F));
			this.fwing_7_R.rotateAngleZ = (float)((-Math.PI / 2D) - (double)(newangle * 1.65F));
			
			this.fwing_7_R.rotateAngleX = (-(float)Math.PI / 2F);
			this.fwing_6_L.rotateAngleX = -1.1780972F;
			this.fwing_5_L.rotateAngleX = (-(float)Math.PI / 4F);
			
			
			this.farm_2_R.rotateAngleZ = (float)((Math.PI / 2D) + (double)(newangle * 1.3F));
			this.fwing_2_R.rotateAngleZ = (float)((Math.PI / 2D) + (double)(newangle * 1.3F));
			this.farm_2_R.rotationPointX = this.fwing_2_R.rotationPointX = (float)((double)this.farm_1_R.rotationPointX - Math.cos((double)newangle) * 14.0D);
			this.farm_2_R.rotationPointY = this.fwing_2_R.rotationPointY = (float)((double)this.farm_1_R.rotationPointY - Math.sin((double)newangle) * 14.0D);
			
			this.fwing_5_R.rotationPointX = (float)((double)this.farm_2_R.rotationPointX - Math.cos((double)(newangle * 1.3F)) * 20.0D);
			this.fwing_5_R.rotationPointY = (float)((double)this.farm_2_R.rotationPointY - Math.sin((double)(newangle * 1.3F)) * 20.0D);
			...
			this.fwing_5_R.rotateAngleZ = (float)((Math.PI / 2D) + (double)(newangle * 1.65F));
			this.fwing_6_R.rotateAngleZ = (float)((Math.PI / 2D) + (double)(newangle * 1.65F));
			this.fwing_7_L.rotateAngleZ = (float)((Math.PI / 2D) + (double)(newangle * 1.65F));
			
			this.fwing_7_L.rotateAngleX = (-(float)Math.PI / 2F);
			this.fwing_6_R.rotateAngleX = -1.1780972F;
			this.fwing_5_R.rotateAngleX = (-(float)Math.PI / 4F);
			
			
			
			this.fneck_1.rotateAngleX = -newangle / 12.0F;
			this.fneck_1.rotationPointZ = (float)((double)this.fchest.rotationPointZ - Math.cos((double)this.fchest.rotateAngleX) * 10.0D);
			this.fneck_1.rotationPointY = (float)((double)this.fchest.rotationPointY + Math.sin((double)this.fchest.rotateAngleX) * 8.0D - 1.0D);
			
			this.fneck_2.rotateAngleX = -newangle / 10.0F;
			this.fneck_2.rotationPointZ = (float)((double)this.fneck_1.rotationPointZ - Math.cos((double)this.fneck_1.rotateAngleX) * 7.0D);
			this.fneck_2.rotationPointY = (float)((double)this.fneck_1.rotationPointY + Math.sin((double)this.fneck_1.rotateAngleX) * 6.0D - 1.0D);
			
			this.fneck_3.rotateAngleX = -newangle / 8.0F;
			this.fneck_3.rotationPointZ = (float)((double)this.fneck_2.rotationPointZ - Math.cos((double)this.fneck_2.rotateAngleX) * 7.0D);
			this.fneck_3.rotationPointY = (float)((double)this.fneck_2.rotationPointY + Math.sin((double)this.fneck_2.rotateAngleX) * 5.0D);
			
			
			this.fhead.rotationPointZ = (float)((double)this.fneck_3.rotationPointZ - Math.cos((double)this.fneck_3.rotateAngleX) * 16.0D);
			this.fhead.rotationPointY = (float)((double)this.fneck_3.rotationPointY + Math.sin((double)this.fneck_3.rotateAngleX) * 15.0D);
			...
			this.fhead.rotateAngleY = this.fupper_jaw.rotateAngleY = this.fupper_sail_1.rotateAngleY = this.fupper_sail2_.rotateAngleY = this.fupper_sail3.rotateAngleY = newangle;
			...
			this.fbottom_jaw.rotateAngleY = this.flower_sail1.rotateAngleY = this.flower_sail2.rotateAngleY = this.flower_sail_3.rotateAngleY = newangle;
			this.fbottom_jaw.rotationPointZ = (float)((double)this.fhead.rotationPointZ - Math.cos((double)newangle) * 5.0D);
			this.fbottom_jaw.rotationPointX = (float)((double)this.fhead.rotationPointX - Math.sin((double)newangle) * 5.0D);
			...
			if (e.getAttacking() == 0) {
				...
				newangle2 = MathHelper.cos(f2 * 2.6F * this.wingspeed) * (float)Math.PI * 0.16F;
