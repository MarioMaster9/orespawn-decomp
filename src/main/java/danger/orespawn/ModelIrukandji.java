...
public class ModelIrukandji extends ModelBase
{
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		newangle = MathHelper.cos(f2 * 0.55F) * (float)Math.PI * 0.15F;
		this.t11.rotateAngleX = newangle;
		float d1 = (float)(Math.sin((double)newangle) * 7.0D);
		float d2 = (float)(Math.cos((double)newangle) * 7.0D);
		...
		newangle = MathHelper.cos(f2 * 0.45F) * (float)Math.PI * 0.15F;
		this.t12.rotateAngleX = newangle;
		newangle = MathHelper.cos(f2 * 0.25F) * (float)Math.PI * 0.1F;
		this.t12.rotateAngleZ = newangle;
		
		
		newangle = MathHelper.cos(f2 * 0.65F) * (float)Math.PI * 0.15F;
		this.t21.rotateAngleX = newangle;
		d1 = (float)(Math.sin((double)newangle) * 7.0D);
		d2 = (float)(Math.cos((double)newangle) * 7.0D);
		this.t22.rotationPointZ = this.t21.rotationPointZ + d1;
		newangle = MathHelper.cos(f2 * 0.45F) * (float)Math.PI * 0.1F;
		...
		newangle = MathHelper.cos(f2 * 0.5F) * (float)Math.PI * 0.15F;
		this.t31.rotateAngleX = newangle;
		d1 = (float)(Math.sin((double)newangle) * 7.0D);
		d2 = (float)(Math.cos((double)newangle) * 7.0D);
		this.t32.rotationPointZ = this.t31.rotationPointZ + d1;
		newangle = MathHelper.cos(f2 * 0.3F) * (float)Math.PI * 0.1F;
		...
		newangle = MathHelper.cos(f2 * 0.4F) * (float)Math.PI * 0.15F;
		this.t32.rotateAngleX = newangle;
		newangle = MathHelper.cos(f2 * 0.2F) * (float)Math.PI * 0.1F;
		this.t32.rotateAngleZ = newangle;
		
		
		newangle = MathHelper.cos(f2 * 0.57F) * (float)Math.PI * 0.15F;
		this.t41.rotateAngleX = newangle;
		d1 = (float)(Math.sin((double)newangle) * 7.0D);
		d2 = (float)(Math.cos((double)newangle) * 7.0D);
		this.t42.rotationPointZ = this.t41.rotationPointZ + d1;
		newangle = MathHelper.cos(f2 * 0.37F) * (float)Math.PI * 0.1F;
		...
		newangle = MathHelper.cos(f2 * 0.29F) * (float)Math.PI * 0.1F;
