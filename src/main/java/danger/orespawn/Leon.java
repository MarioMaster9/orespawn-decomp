...
public class Leon extends EntityTameable {
	...
	protected void applyEntityAttributes() {
		...
		this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue((double)55.0F);
	}
	...
	public String getLivingSound() {
		if (this.isSitting()) {
			...
			return this.getActivity() == 1 && this.riddenByEntity == null ? "orespawn:leon_living" : null;
		}
	}
	...
	private ItemStack dropItemRand(Item index, int par1) {
		...
		var3 = new EntityItem(this.worldObj, this.posX + (double)OreSpawnMain.OreSpawnRand.nextInt(4) - (double)OreSpawnMain.OreSpawnRand.nextInt(4), this.posY + 2.0D, this.posZ + (double)OreSpawnMain.OreSpawnRand.nextInt(4) - (double)OreSpawnMain.OreSpawnRand.nextInt(4), is);
		if (var3 != null) {
			...
			if (!this.isSitting()) {
				if (!this.worldObj.isRemote) {
					if (this.worldObj.rand.nextInt(freq) == 1 && this.worldObj.difficultySetting != EnumDifficulty.PEACEFUL) {
						...
						if (e != null) {
							this.setAttacking(1);
							if (this.getDistanceSqToEntity(e) < (double)((9.0F + e.width / 2.0F) * (9.0F + e.width / 2.0F))) {
	...
	public boolean getCanSpawnHere() {
		...
		if (this.worldObj.rand.nextInt(16) != 0) {
			...
			if (!this.worldObj.isDaytime()) {
				...
				target = (Leon)this.worldObj.findNearestEntityWithinAABB(Leon.class, this.boundingBox.expand((double)48.0F, 16.0D, (double)48.0F), this);
				if (target != null) {
					return false;
	...
	public void onUpdate() {
		...
		if (!this.worldObj.isRemote) {
			if (this.getActivity() == 0 && this.isTamed() && this.getOwner() != null && !this.isSitting()) {
				e = this.getOwner();
				if (e != null && this.getDistanceSqToEntity(e) > (double)144.0F) {
					this.setActivity(1);
				}
			}
		...
		if (!this.worldObj.isRemote) {
			...
			if (!this.isSitting()) {
				...
				if (this.isTamed() && this.getOwner() != null && !this.isSitting()) {
					pl = (EntityPlayer)this.getOwner();
					if (this.getDistanceSqToEntity(pl) > (double)400.0F) {
						this.setActivity(1);
					}
				}
	...
	public boolean interact(EntityPlayer par1EntityPlayer) {
		...
		if (var2 != null && var2.getItem() == Item.getItemFromBlock(Blocks.diamond_block) && par1EntityPlayer.getDistanceSqToEntity(this) < (double)49.0F) {
			if (!this.worldObj.isRemote) {
				this.setTamed(true);
			...
			if (!this.isTamed()) {
				if (var2 != null && var2.getItem() == Items.beef && par1EntityPlayer.getDistanceSqToEntity(this) < (double)49.0F) {
					if (!this.worldObj.isRemote) {
				...
				if (var2 == null && par1EntityPlayer.getDistanceSqToEntity(this) < (double)49.0F) {
					if (!this.worldObj.isRemote) {
				...
				if (var2 != null && var2.getItem() == Item.getItemFromBlock(Blocks.deadbush) && par1EntityPlayer.getDistanceSqToEntity(this) < (double)49.0F) {
					if (!this.worldObj.isRemote) {
						this.setTamed(false);
						this.func_152115_b("");
						this.playTameEffect(false);
				...
				if (this.isTamed() && var2 != null && var2.getItem() == Items.name_tag && par1EntityPlayer.getDistanceSqToEntity(this) < (double)49.0F && this.func_152114_e(par1EntityPlayer)) {
				...
				if (var2 != null && par1EntityPlayer.getDistanceSqToEntity(this) < (double)49.0F && this.riddenByEntity == null) {
					if (!this.isSitting()) {
