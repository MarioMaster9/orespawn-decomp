...
public class Gazelle extends EntityTameable {
	...
	public Gazelle(World par1World) {
		...
		this.tasks.addTask(3, new EntityAIAvoidEntity(this, EntityMob.class, 8.0F, 1.0D, (double)1.7F));
		...
		this.tasks.addTask(6, new EntityAIAvoidEntity(this, EntityPlayer.class, 12.0F, 1.0D, 2.0D));
