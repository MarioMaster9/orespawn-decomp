...
public class ModelFirefly extends ModelBase
{
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		this.wing_left.rotateAngleZ = 1.11F + MathHelper.cos(f2 * this.wingspeed) * (float)Math.PI * 0.35F;
		this.wing_right.rotateAngleZ = -1.11F - MathHelper.cos(f2 * this.wingspeed) * (float)Math.PI * 0.35F;
