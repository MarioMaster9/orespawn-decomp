...
public class ModelWormLarge extends ModelBase
{
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		newangle2 = MathHelper.cos(f2 * 0.15F) * (float)Math.PI * 0.07F;
		this.neck1.rotateAngleY = newangle2;
		this.neck2.rotateAngleX = this.neck3.rotateAngleX = this.neck4.rotateAngleX = this.neck5.rotateAngleX = this.neck1.rotateAngleX;
		this.neck2.rotateAngleY = this.neck3.rotateAngleY = this.neck4.rotateAngleY = this.neck5.rotateAngleY = this.neck1.rotateAngleY;
		
		d1 = (double)((float)(Math.cos((double)newangle) * dist));
		d2 = (double)((float)(Math.sin((double)newangle) * dist));
		this.head1.rotationPointZ = (float)((double)this.neck1.rotationPointZ - d1);
		d3 = (double)((float)(Math.sin((double)newangle2) * d1));
		d4 = (double)((float)(Math.cos((double)newangle2) * d1));
		...
		this.head1.rotateAngleX = newangle = MathHelper.cos(f2 * 0.35F) * (float)Math.PI * 0.15F;
		this.head1.rotateAngleY = newangle2 = MathHelper.cos(f2 * 0.45F) * (float)Math.PI * 0.05F;
		
		this.head2.rotationPointX = this.head3.rotationPointX = this.head4.rotationPointX = this.head5.rotationPointX = this.head1.rotationPointX;
		this.head2.rotationPointY = this.head3.rotationPointY = this.head4.rotationPointY = this.head5.rotationPointY = this.head1.rotationPointY;
		this.head2.rotationPointZ = this.head3.rotationPointZ = this.head4.rotationPointZ = this.head5.rotationPointZ = this.head1.rotationPointZ;
		this.head2.rotateAngleX = this.head3.rotateAngleX = this.head4.rotateAngleX = this.head5.rotateAngleX = this.head1.rotateAngleX;
		this.head2.rotateAngleY = this.head3.rotateAngleY = this.head4.rotateAngleY = this.head5.rotateAngleY = this.head1.rotateAngleY;
		...
		this.tooth1.rotationPointY = (float)((double)this.head1.rotationPointY + d2 - 9.0D);
		...
		this.tooth1.rotationPointZ -= Math.sin(this.head1.rotateAngleX) * 9.0D;
		this.tooth2.rotationPointZ += Math.sin(this.head1.rotateAngleX) * 9.0D;
		
		this.tooth3.rotationPointZ -= Math.sin(this.head1.rotateAngleY) * 9.0D;
		this.tooth4.rotationPointZ += Math.sin(this.head1.rotateAngleY) * 9.0D;
		
		this.tooth7.rotationPointZ -= Math.sin(this.head1.rotateAngleX) * 6.0D;
		this.tooth7.rotationPointZ -= Math.sin(this.head1.rotateAngleY) * 6.0D;
		
		this.tooth6.rotationPointZ += Math.sin(this.head1.rotateAngleX) * 6.0D;
		this.tooth6.rotationPointZ -= Math.sin(this.head1.rotateAngleY) * 6.0D;
		
		this.tooth5.rotationPointZ -= Math.sin(this.head1.rotateAngleX) * 6.0D;
		this.tooth5.rotationPointZ += Math.sin(this.head1.rotateAngleY) * 6.0D;
		
		this.tooth8.rotationPointZ += Math.sin(this.head1.rotateAngleX) * 6.0D;
		this.tooth8.rotationPointZ += Math.sin(this.head1.rotateAngleY) * 6.0D;
		
		newangle = MathHelper.cos(f2 * 0.57F) * (float)Math.PI * 0.35F;
		...
		newangle = MathHelper.cos(f2 * 0.63F) * (float)Math.PI * 0.15F;
		this.tailtip.rotateAngleX = newangle + 0.35F;
		newangle = MathHelper.cos((float)((double)(f2 * 0.63F) + 1.57075)) * (float)Math.PI * 0.15F;
