...
public class ModelGoldFish extends ModelBase
{
	...
	public ModelGoldFish(float f1)
	{
		...
		this.setRotation(this.Mouth, (-(float)Math.PI / 4F), 0.0F, 0.0F);
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		newangle = MathHelper.cos(f2 * 1.3F * this.wingspeed) * (float)Math.PI * 0.15F;
		this.Pectoralfin1.rotateAngleY = 0.4F + newangle;
		newangle = MathHelper.cos(f2 * 1.2F * this.wingspeed) * (float)Math.PI * 0.15F;
		this.Pectoralfin2.rotateAngleY = -0.4F + newangle;
		newangle = MathHelper.cos(f2 * 1.1F * this.wingspeed) * (float)Math.PI * 0.15F;
		...
		newangle = MathHelper.cos(f2 * 0.7F * this.wingspeed) * (float)Math.PI * 0.1F;
