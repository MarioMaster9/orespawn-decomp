...
public class ModelAntRobot extends ModelBase
{
	...
	public ModelAntRobot(float f1)
	{
		...
		this.setRotation(this.Leg1, ((float)Math.PI / 4F), 0.0F, 0.0F);
		...
		this.setRotation(this.Leg3, (-(float)Math.PI / 4F), 0.0F, 0.0F);
		...
		this.setRotation(this.Foot1, (-(float)Math.PI / 4F), 0.0F, 0.0F);
		...
		this.setRotation(this.Foot2, (-(float)Math.PI / 4F), 0.0F, 0.0F);
		...
		this.setRotation(this.Foot3, (-(float)Math.PI / 4F), 0.0F, 0.0F);
		...
		this.setRotation(this.Foot4, (-(float)Math.PI / 4F), 0.0F, 0.0F);
		...
		this.setRotation(this.Foot5, (-(float)Math.PI / 4F), 0.0F, 0.0F);
		...
		this.setRotation(this.Foot6, (-(float)Math.PI / 4F), 0.0F, 0.0F);
		...
		this.setRotation(this.Foot7, (-(float)Math.PI / 4F), 0.0F, 0.0F);
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		for (i = 0; i < 6; i++)
		{
			this.Leg1.rotateAngleY = this.Leg2.rotateAngleY = this.Leg3.rotateAngleY = r.ydisplayangle[i];
			...
			this.Leg1.rotationPointX = -((float)Math.cos((double)r.ymid[i])) * r.legoff[i] * 16.0F;
			this.Leg1.rotationPointZ = (float)Math.sin((double)r.ymid[i]) * r.legoff[i] * 16.0F;
			this.Leg1.rotationPointY = r.yoff[i] * -16.0F;
			
			
			this.Leg2.rotationPointY = this.Leg1.rotationPointY - (float)Math.sin((double)this.Leg1.rotateAngleX) * 49.0F;
			this.Leg2.rotationPointZ = this.Leg1.rotationPointZ + (float)Math.cos((double)this.Leg1.rotateAngleX) * (float)Math.cos((double)this.Leg1.rotateAngleY) * 49.0F;
			this.Leg2.rotationPointX = this.Leg1.rotationPointX + (float)Math.cos((double)this.Leg1.rotateAngleX) * (float)Math.sin((double)this.Leg1.rotateAngleY) * 49.0F;
			
			
			this.Leg3.rotationPointY = this.Leg2.rotationPointY - (float)Math.sin((double)this.Leg2.rotateAngleX) * 49.0F;
			this.Leg3.rotationPointZ = this.Leg2.rotationPointZ + (float)Math.cos((double)this.Leg2.rotateAngleX) * (float)Math.cos((double)this.Leg2.rotateAngleY) * 49.0F;
			this.Leg3.rotationPointX = this.Leg2.rotationPointX + (float)Math.cos((double)this.Leg2.rotateAngleX) * (float)Math.sin((double)this.Leg2.rotateAngleY) * 49.0F;
		...
		if (e.getAttacking() == 0) {
			...
			this.LAntenna.rotateAngleX = MathHelper.cos((float)r.gpcounter * 0.35F) * (float)Math.PI * 0.05F;
			this.LAntenna.rotateAngleZ = 0.54F + MathHelper.cos((float)r.gpcounter * 0.25F) * (float)Math.PI * 0.05F;
			this.RAntenna.rotateAngleX = MathHelper.cos((float)r.gpcounter * 0.3F) * (float)Math.PI * 0.05F;
			this.RAntenna.rotateAngleZ = -0.54F + MathHelper.cos((float)r.gpcounter * 0.45F) * (float)Math.PI * 0.05F;
		} else
		{
			newangle = MathHelper.cos((float)r.gpcounter * 0.25F) * (float)Math.PI * 0.22F;
			...
			this.LAntenna.rotateAngleX = MathHelper.cos((float)r.gpcounter * 0.45F) * (float)Math.PI * 0.1F;
			this.LAntenna.rotateAngleZ = 0.54F + MathHelper.cos((float)r.gpcounter * 0.35F) * (float)Math.PI * 0.1F;
			this.RAntenna.rotateAngleX = MathHelper.cos((float)r.gpcounter * 0.4F) * (float)Math.PI * 0.1F;
			this.RAntenna.rotateAngleZ = -0.54F + MathHelper.cos((float)r.gpcounter * 0.55F) * (float)Math.PI * 0.1F;
		}
