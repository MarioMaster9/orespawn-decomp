...
public class ModelGodzilla extends ModelBase
{
	...
	public ModelGodzilla(float f1)
	{
		...
		this.setRotation(this.LToe1, 0.0F, ((float)Math.PI / 4F), 0.0F);
		...
		this.setRotation(this.LToe3, 0.0F, ((float)Math.PI / 4F), 0.0F);
		...
		this.setRotation(this.LToe2, 0.0F, ((float)Math.PI / 4F), 0.0F);
		...
		this.setRotation(this.LToe9, 0.0F, (-(float)Math.PI / 4F), 0.0F);
		...
		this.setRotation(this.LToe8, 0.0F, (-(float)Math.PI / 4F), 0.0F);
		...
		this.setRotation(this.LToe7, 0.0F, (-(float)Math.PI / 4F), 0.0F);
		...
		this.setRotation(this.RToe9, 0.0F, ((float)Math.PI / 4F), 0.0F);
		...
		this.setRotation(this.RToe2, 0.0F, (-(float)Math.PI / 4F), 0.0F);
		...
		this.setRotation(this.RToe1, 0.0F, (-(float)Math.PI / 4F), 0.0F);
		...
		this.setRotation(this.RToe7, 0.0F, ((float)Math.PI / 4F), 0.0F);
		...
		this.setRotation(this.RToe8, 0.0F, ((float)Math.PI / 4F), 0.0F);
		...
		this.setRotation(this.RToe3, 0.0F, (-(float)Math.PI / 4F), 0.0F);
		...
		this.setRotation(this.LUpperLeg, -0.1745329F, (-(float)Math.PI / 8F), -0.0872665F);
		...
		this.setRotation(this.RLegUpper, -0.1745329F, ((float)Math.PI / 8F), 0.0872665F);
		...
		this.setRotation(this.LowerJaw, ((float)Math.PI / 6F), 0.0F, 0.0F);
		...
		this.setRotation(this.TailBase, ((float)Math.PI / 4F), 0.0F, 0.0F);
		...
		this.setRotation(this.RLowerArm, 0.0F, (-(float)Math.PI / 4F), -0.2617994F);
		...
		this.setRotation(this.LLowerArm, 0.0F, ((float)Math.PI / 4F), 0.2617994F);
		...
		this.setRotation(this.Lspike5, (-(float)Math.PI / 4F), 0.0F, -0.0174533F);
		...
		this.setRotation(this.Rspike5, (-(float)Math.PI / 4F), 0.0F, -0.0174533F);
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		if (e.getAttacking() != 0) {
			newangle = MathHelper.cos(f2 * this.wingspeed * 1.75F) * (float)Math.PI * 0.2F;
		} else {
			newangle = MathHelper.cos(f2 * this.wingspeed * 0.75F) * (float)Math.PI * 0.05F;
		}
		...
		newangle = MathHelper.cos(f2 * this.wingspeed * 1.5F) * (float)Math.PI * 0.12F;
		newrf1 = f2 * 1.5F * this.wingspeed % ((float)Math.PI * 2F);
		...
		if (newrf1 < r.rf2)
		{
			...
			else if (e.worldObj.rand.nextInt(2) == 1) r.ri2 |= 1;
		...
		newangle = newangle2 = MathHelper.sin(f2 * this.wingspeed * 1.75F) * (float)Math.PI * 0.16F;
		newrf1 = f2 * 1.75F * this.wingspeed % ((float)Math.PI * 2F);
		newrf1 = Math.abs(newrf1);
		...
		if (newrf1 < r.rf1)
		{
			...
			if (e.getAttacking() == 0) {
				...
				if (e.worldObj.rand.nextInt(20) == 1) r.ri1 |= 2;
			} else {
				if (e.worldObj.rand.nextInt(2) == 1) r.ri1 |= 1;
				if (e.worldObj.rand.nextInt(2) == 1) r.ri1 |= 2;
			}
		}
