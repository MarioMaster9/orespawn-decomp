...
public class ModelTheQueen extends ModelBase
{
	...
	public ModelTheQueen(float f1)
	{
		...
		this.setRotation(this.Rib1, ((float)Math.PI / 6F), 0.6632251F, 0.0F);
		...
		this.setRotation(this.Rib2, ((float)Math.PI / 6F), 0.6632251F, 0.0F);
		...
		this.setRotation(this.Rib3, ((float)Math.PI / 6F), 0.6632251F, 0.0F);
		...
		this.setRotation(this.Rib4, ((float)Math.PI / 6F), -0.6632251F, 0.0F);
		...
		this.setRotation(this.Rib5, ((float)Math.PI / 6F), -0.6632251F, 0.0F);
		...
		this.setRotation(this.Rib6, ((float)Math.PI / 6F), -0.6632251F, 0.0F);
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		if (k.getAttacking() != 0) {
			newangle = MathHelper.cos(f2 * 0.85F * this.wingspeed) * (float)Math.PI * 0.26F;
		} else {
		...
		if (k.getAttacking() != 0) {
			newangle = MathHelper.cos(f2 * 0.7F * this.wingspeed) * (float)Math.PI * 0.45F;
		} else {
			newangle = 0.0F;
		}
		...
		if (k.getAttacking() != 0) {
			...
			Lheadud = MathHelper.sin(f2 * 0.2F * this.wingspeed) * (float)Math.PI * 0.25F;
			Ljawangle = MathHelper.sin(f2 * 0.85F * this.wingspeed) * (float)Math.PI * 0.12F;
			
			Rheadlr = MathHelper.sin(f2 * 0.33F * this.wingspeed) * (float)Math.PI * 0.25F;
			Rheadud = MathHelper.sin(f2 * 0.22F * this.wingspeed) * (float)Math.PI * 0.25F;
			Rjawangle = MathHelper.sin(f2 * 0.95F * this.wingspeed) * (float)Math.PI * 0.12F;
			
			Cheadlr = MathHelper.sin(f2 * 0.27F * this.wingspeed) * (float)Math.PI * 0.25F;
			Cheadud = MathHelper.sin(f2 * 0.18F * this.wingspeed) * (float)Math.PI * 0.25F;
			...
			Lheadud = MathHelper.sin(f2 * 0.13F * this.wingspeed) * (float)Math.PI * 0.1F;
			...
			Rheadud = MathHelper.sin(f2 * 0.12F * this.wingspeed) * (float)Math.PI * 0.1F;
			...
			Cheadud = MathHelper.sin(f2 * 0.08F * this.wingspeed) * (float)Math.PI * 0.1F;
		...
		if ((double)this.PowerCube1.rotateAngleX > Math.PI) this.PowerCube1.rotateAngleX -= (Math.PI * 2D);
		this.PowerCube2.rotateAngleX += 0.04F;
		if ((double)this.PowerCube2.rotateAngleX > Math.PI) this.PowerCube2.rotateAngleX -= (Math.PI * 2D);
		this.PowerCube3.rotateAngleX += 0.05F;
		if ((double)this.PowerCube3.rotateAngleX > Math.PI) this.PowerCube3.rotateAngleX -= (Math.PI * 2D);
		
		this.PowerCube1.rotateAngleY += 0.035F;
		if ((double)this.PowerCube1.rotateAngleY > Math.PI) this.PowerCube1.rotateAngleY -= (Math.PI * 2D);
		this.PowerCube2.rotateAngleY += 0.046F;
		if ((double)this.PowerCube2.rotateAngleY > Math.PI) this.PowerCube2.rotateAngleY -= (Math.PI * 2D);
		this.PowerCube3.rotateAngleY += 0.065F;
		if ((double)this.PowerCube3.rotateAngleY > Math.PI) this.PowerCube3.rotateAngleY -= (Math.PI * 2D);
		
		this.PowerCube1.rotateAngleZ += 0.05F;
		if ((double)this.PowerCube1.rotateAngleZ > Math.PI) this.PowerCube1.rotateAngleZ -= (Math.PI * 2D);
		this.PowerCube2.rotateAngleZ += 0.13F;
		if ((double)this.PowerCube2.rotateAngleZ > Math.PI) this.PowerCube2.rotateAngleZ -= (Math.PI * 2D);
		this.PowerCube3.rotateAngleZ += 0.03F;
		if ((double)this.PowerCube3.rotateAngleZ > Math.PI) this.PowerCube3.rotateAngleZ -= (Math.PI * 2D);
		...
		if (k.getPower() > 350) this.PowerCube2.render(f5);
		if (k.getPower() > 650) this.PowerCube3.render(f5);
	...
	private void moveLeftHead(float Lheadlr, float Lheadud, float Ljawangle)
	{
		...
		this.LJaw1.rotationPointZ = this.NeckL4.rotationPointZ - (float)Math.cos((double)this.NeckL4.rotateAngleY) * 37.0F;
		this.LJaw1.rotationPointX = this.NeckL4.rotationPointX - (float)Math.sin((double)this.NeckL4.rotateAngleY) * 37.0F;
		...
		this.LJaw1.rotationPointZ = this.NeckL4.rotationPointZ + (this.LJaw1.rotationPointZ - this.NeckL4.rotationPointZ) * (float)Math.cos((double)this.NeckL4.rotateAngleX);
		this.LJaw1.rotationPointZ += (float)Math.sin((double)this.LHead1.rotateAngleX) * 14.0F;
		this.LJaw1.rotationPointX = this.NeckL4.rotationPointX + (this.LJaw1.rotationPointX - this.NeckL4.rotationPointX) * (float)Math.cos((double)this.NeckL4.rotateAngleX);
	...
	private void moveCenterHead(float Cheadlr, float Cheadud, float Cjawangle)
	{
		...
		this.CJaw1.rotationPointZ = this.NeckC4.rotationPointZ - (float)Math.cos((double)this.NeckC4.rotateAngleY) * 37.0F;
		this.CJaw1.rotationPointX = this.NeckC4.rotationPointX - (float)Math.sin((double)this.NeckC4.rotateAngleY) * 37.0F;
		...
		this.CJaw1.rotationPointZ = this.NeckC4.rotationPointZ + (this.CJaw1.rotationPointZ - this.NeckC4.rotationPointZ) * (float)Math.cos((double)this.NeckC4.rotateAngleX);
		this.CJaw1.rotationPointZ += (float)Math.sin((double)this.CHead1.rotateAngleX) * 14.0F;
		this.CJaw1.rotationPointX = this.NeckC4.rotationPointX + (this.CJaw1.rotationPointX - this.NeckC4.rotationPointX) * (float)Math.cos((double)this.NeckC4.rotateAngleX);
	...
	private void moveRightHead(float Rheadlr, float Rheadud, float Rjawangle)
	{
		...
		this.RJaw1.rotationPointZ = this.NeckR4.rotationPointZ - (float)Math.cos((double)this.NeckR4.rotateAngleY) * 37.0F;
		this.RJaw1.rotationPointX = this.NeckR4.rotationPointX - (float)Math.sin((double)this.NeckR4.rotateAngleY) * 37.0F;
		...
		this.RJaw1.rotationPointZ = this.NeckR4.rotationPointZ + (this.RJaw1.rotationPointZ - this.NeckR4.rotationPointZ) * (float)Math.cos((double)this.NeckR4.rotateAngleX);
		this.RJaw1.rotationPointZ += (float)Math.sin((double)this.RHead1.rotateAngleX) * 14.0F;
		this.RJaw1.rotationPointX = this.NeckR4.rotationPointX + (this.RJaw1.rotationPointX - this.NeckR4.rotationPointX) * (float)Math.cos((double)this.NeckR4.rotateAngleX);
