...
public class ModelDragon extends ModelBase
{
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		if ((double)f1 > 0.001) {
			...
			lspeed = (float)Math.sqrt((double)lspeed);
			newangle = MathHelper.cos(f2 * 1.25F * this.wingspeed) * (float)Math.PI * lspeed * 0.6F;
		} else {
			newangle = 0.0F;
		}
		...
		if (e.getAttacking() != 0) {
			if (e.getActivity() != 0) {
				newangle = MathHelper.cos(f2 * 0.75F * this.wingspeed) * (float)Math.PI * 0.28F;
			} else {
				newangle = -0.45F + MathHelper.cos(f2 * 0.85F * this.wingspeed) * (float)Math.PI * 0.2F;
			}
		}
		else if (e.getActivity() != 0) {
			newangle = MathHelper.cos(f2 * 0.75F * this.wingspeed) * (float)Math.PI * 0.28F;
		} else {
			newangle = -0.85F + MathHelper.cos(f2 * 0.2F * this.wingspeed) * (float)Math.PI * 0.028F;
		}

		this.wing1.rotateAngleZ = newangle;
		this.wing15.rotateAngleZ = newangle;
		this.wing3.rotateAngleZ = newangle * 4.0F / 3.0F;
		this.wing3.rotationPointY = this.wing1.rotationPointY + (float)Math.sin((double)this.wing1.rotateAngleZ) * 7.0F;
		this.wing3.rotationPointX = this.wing1.rotationPointX + (float)Math.cos((double)this.wing1.rotateAngleZ) * 7.0F;
		...
		this.wing2.rotationPointY = this.wing3.rotationPointY + (float)Math.sin((double)this.wing3.rotateAngleZ) * 6.0F;
		this.wing2.rotationPointX = this.wing3.rotationPointX + (float)Math.cos((double)this.wing3.rotateAngleZ) * 6.0F;
		...
		this.wing5.rotationPointY = this.wing4.rotationPointY - (float)Math.sin((double)this.wing4.rotateAngleZ) * 7.0F;
		this.wing5.rotationPointX = this.wing4.rotationPointX - (float)Math.cos((double)this.wing4.rotateAngleZ) * 7.0F;
		...
		this.wing6.rotationPointY = this.wing5.rotationPointY - (float)Math.sin((double)this.wing5.rotateAngleZ) * 6.0F;
		this.wing6.rotationPointX = this.wing5.rotationPointX - (float)Math.cos((double)this.wing5.rotateAngleZ) * 6.0F;
		...
		this.tail2.rotationPointZ = this.tail1.rotationPointZ + (float)Math.cos((double)this.tail1.rotateAngleY) * 6.0F;
		this.tail2.rotationPointX = this.tail1.rotationPointX + (float)Math.sin((double)this.tail1.rotateAngleY) * 6.0F;
		this.tail2.rotateAngleY = MathHelper.cos(f2 * tailspeed * this.wingspeed) * (float)Math.PI * tailamp * 0.125F;
		...
		this.neck1.rotationPointZ = this.tail2.rotationPointZ + (float)Math.cos((double)this.tail2.rotateAngleY) * 6.0F;
		this.neck1.rotationPointX = this.tail2.rotationPointX + (float)Math.sin((double)this.tail2.rotateAngleY) * 6.0F;
		this.neck1.rotateAngleY = MathHelper.cos(f2 * tailspeed * this.wingspeed) * (float)Math.PI * tailamp * 0.25F;
		...
		this.tail3.rotationPointZ = this.neck1.rotationPointZ + (float)Math.cos((double)this.neck1.rotateAngleY) * 6.0F;
		this.tail3.rotationPointX = this.neck1.rotationPointX + 1.0F + (float)Math.sin((double)this.neck1.rotateAngleY) * 6.0F;
		this.tail3.rotateAngleY = MathHelper.cos(f2 * tailspeed * this.wingspeed) * (float)Math.PI * tailamp * 0.375F;
		...
		this.tail4.rotationPointZ = this.tail3.rotationPointZ + (float)Math.cos((double)this.tail3.rotateAngleY) * 6.0F;
		this.tail4.rotationPointX = this.tail3.rotationPointX + (float)Math.sin((double)this.tail3.rotateAngleY) * 6.0F;
		this.tail4.rotateAngleY = MathHelper.cos(f2 * tailspeed * this.wingspeed) * (float)Math.PI * tailamp * 0.5F;
		...
		this.tail6.rotationPointZ = this.tail4.rotationPointZ + (float)Math.cos((double)this.tail4.rotateAngleY) * 6.0F;
		this.tail6.rotationPointX = this.tail4.rotationPointX - 1.0F + (float)Math.sin((double)this.tail4.rotateAngleY) * 6.0F;
		this.tail6.rotateAngleY = MathHelper.cos(f2 * tailspeed * this.wingspeed) * (float)Math.PI * tailamp * 0.625F;
		
		
		this.tail5.rotationPointZ = this.tail6.rotationPointZ + (float)Math.cos((double)this.tail6.rotateAngleY) * 6.0F;
		this.tail5.rotationPointX = this.tail6.rotationPointX - 0.5F + (float)Math.sin((double)this.tail6.rotateAngleY) * 6.0F;
		this.tail5.rotateAngleY = MathHelper.cos(f2 * tailspeed * this.wingspeed) * (float)Math.PI * tailamp * 0.75F;
		...
		this.neck3.rotationPointZ = this.neck2.rotationPointZ - (float)Math.cos((double)this.neck2.rotateAngleY) * 6.0F;
		this.neck3.rotationPointX = this.neck2.rotationPointX - (float)Math.sin((double)this.neck2.rotateAngleY) * 6.0F;
		...
		this.head.rotationPointZ = this.neck3.rotationPointZ - (float)Math.cos((double)this.neck3.rotateAngleY) * 6.0F;
		this.head.rotationPointX = this.neck3.rotationPointX - (float)Math.sin((double)this.neck3.rotateAngleY) * 6.0F;
		...
		this.mouth2.rotationPointZ = this.head.rotationPointZ - (float)Math.cos((double)this.head.rotateAngleY) * 9.0F;
		this.mouth2.rotationPointX = this.head.rotationPointX - (float)Math.sin((double)this.head.rotateAngleY) * 9.0F;
		...
		newangle = MathHelper.cos(f2 * 1.5F * this.wingspeed) * (float)Math.PI * 0.14F;
