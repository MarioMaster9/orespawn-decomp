...
public class ModelHerculesBeetle extends ModelBase
{
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		newangle = MathHelper.cos(f2 * this.wingspeed * 0.45F) * (float)Math.PI * 0.12F * f1;
		this.lfleg1.rotateAngleY = 0.349F + newangle;
		this.lfleg3.rotateAngleY = this.lfleg2.rotateAngleY = this.lfleg1.rotateAngleY;
		this.lmleg1.rotateAngleY = -newangle;
		this.lmleg3.rotateAngleY = this.lmleg2.rotateAngleY = this.lmleg1.rotateAngleY;
		this.lrleg1.rotateAngleY = -0.349F + newangle;
		this.lrleg3.rotateAngleY = this.lrleg2.rotateAngleY = this.lrleg1.rotateAngleY;
		
		this.rfleg1.rotateAngleY = -0.349F + newangle;
		this.rfleg3.rotateAngleY = this.rfleg2.rotateAngleY = this.rfleg1.rotateAngleY;
		this.rmleg1.rotateAngleY = -newangle;
		this.rmleg3.rotateAngleY = this.rmleg2.rotateAngleY = this.rmleg1.rotateAngleY;
		this.rrleg1.rotateAngleY = 0.349F + newangle;
		this.rrleg3.rotateAngleY = this.rrleg2.rotateAngleY = this.rrleg1.rotateAngleY;
		
		
		if (b.getAttacking() == 0) {
			newangle = MathHelper.cos(f2 * 0.051F * this.wingspeed) * (float)Math.PI * 0.01F;
		} else {
			newangle = MathHelper.cos(f2 * 0.51F * this.wingspeed) * (float)Math.PI * 0.07F;
		}
