...
public class ModelSpyro extends ModelBase
{
	...
	public ModelSpyro(float f1)
	{
		...
		this.setRotation(this.HornRightBottom, (-(float)Math.PI / 4F), ((float)Math.PI / 4F), 0.0F);
		...
		this.setRotation(this.HornLeftBottom, (-(float)Math.PI / 4F), (-(float)Math.PI / 4F), 0.0F);
		...
		this.setRotation(this.HornRightTop, (-(float)Math.PI / 4F), ((float)Math.PI / 4F), 0.0F);
		...
		this.setRotation(this.HornLeftTop, (-(float)Math.PI / 4F), (-(float)Math.PI / 4F), 0.0F);
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		this.TailFront.rotationPointZ = this.TailBack.rotationPointZ + (float)Math.cos((double)this.TailBack.rotateAngleY) * 3.0F;
		this.TailFront.rotationPointX = this.TailBack.rotationPointX + (float)Math.sin((double)this.TailBack.rotateAngleY) * 3.0F - 0.5F;
		...
		this.HeadPieceTop.rotateAngleY = (float)Math.toRadians((double)f3);
		this.HeadPieceBottom.rotateAngleY = (float)Math.toRadians((double)f3);
		this.JawPiece.rotateAngleY = (float)Math.toRadians((double)f3);
		this.SnoutRight.rotateAngleY = (float)Math.toRadians((double)f3);
		this.SnoutLeft.rotateAngleY = (float)Math.toRadians((double)f3);
		this.ScaleTop1.rotateAngleY = (float)Math.toRadians((double)f3);
		this.ScaleHead.rotateAngleY = (float)Math.toRadians((double)f3);
		this.ScaleBackHead.rotateAngleY = (float)Math.toRadians((double)f3);
		this.HornRightBottom.rotateAngleY = (float)Math.toRadians((double)f3) + 0.785F;
		this.HornRightTop.rotateAngleY = (float)Math.toRadians((double)f3) + 0.785F;
		this.HornLeftBottom.rotateAngleY = (float)Math.toRadians((double)f3) - 0.785F;
		this.HornLeftTop.rotateAngleY = (float)Math.toRadians((double)f3) - 0.785F;
		
		
		this.HeadPieceTop.rotateAngleX = (float)Math.toRadians((double)f4);
		this.HeadPieceBottom.rotateAngleX = (float)Math.toRadians((double)f4);
		this.JawPiece.rotateAngleX = (float)Math.toRadians((double)f4);
		this.SnoutRight.rotateAngleX = (float)Math.toRadians((double)f4);
		this.SnoutLeft.rotateAngleX = (float)Math.toRadians((double)f4);
		this.ScaleTop1.rotateAngleX = (float)Math.toRadians((double)f4);
		this.ScaleHead.rotateAngleX = (float)Math.toRadians((double)f4);
		this.ScaleBackHead.rotateAngleX = (float)Math.toRadians((double)f4);
		this.HornRightBottom.rotateAngleX = (float)Math.toRadians((double)f4) - 0.785F;
		this.HornRightTop.rotateAngleX = (float)Math.toRadians((double)f4) - 0.785F;
		this.HornLeftBottom.rotateAngleX = (float)Math.toRadians((double)f4) - 0.785F;
		this.HornLeftTop.rotateAngleX = (float)Math.toRadians((double)f4) - 0.785F;
