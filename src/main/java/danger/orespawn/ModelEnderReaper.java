...
public class ModelEnderReaper extends ModelBase
{
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		this.scythe3.rotateAngleZ = this.scythe2.rotateAngleZ = this.scythe1.rotateAngleZ = 1.0F - Math.abs(newangle);
		
		
		if (e.isScreaming()) {
			newangle = MathHelper.cos(f2 * 1.9F * this.wingspeed) * (float)Math.PI * 0.25F;
			this.scythe3.rotateAngleZ = this.scythe2.rotateAngleZ = this.scythe1.rotateAngleZ = 1.0F + newangle;
			...
			newangle = MathHelper.cos(f2 * 0.7F * this.wingspeed) * (float)Math.PI * 0.06F;
		}
		this.lwing1.rotateAngleY = this.lwing2.rotateAngleY = this.lwing3.rotateAngleY = 0.785F + newangle;
		this.rwing1.rotateAngleY = this.rwing2.rotateAngleY = this.rwing3.rotateAngleY = -0.785F - newangle;
