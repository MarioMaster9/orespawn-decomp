...
public class ModelSpitBug extends ModelBase
{
	...
	public ModelSpitBug(float f1)
	{
		...
		this.setRotation(this.legintersectionpart2, 0.0F, ((float)Math.PI / 4F), 0.0F);
		...
		this.setRotation(this.leg1start, 0.0F, (-(float)Math.PI / 4F), 0.0F);
		...
		this.setRotation(this.leg1startpart2, 0.3717861F, (-(float)Math.PI / 4F), 0.0F);
		...
		this.setRotation(this.leg1startpart3, 0.669215F, (-(float)Math.PI / 4F), 0.0F);
		...
		this.setRotation(this.leg1, 1.041001F, (-(float)Math.PI / 4F), 0.0F);
		...
		this.setRotation(this.leg1part2, -1.152537F, (-(float)Math.PI / 4F), 0.0F);
		...
		this.setRotation(this.leg1part2b, -0.7435722F, (-(float)Math.PI / 4F), 0.0F);
		...
		this.setRotation(this.leg1part2c, -0.6320451F, (-(float)Math.PI / 4F), 0.0F);
		...
		this.setRotation(this.leg1part2d, -1.041001F, (-(float)Math.PI / 4F), 0.0F);
		...
		this.setRotation(this.leg1part3, 0.669215F, (-(float)Math.PI / 4F), 0.0F);
		...
		this.setRotation(this.leg1part3b, -0.4833219F, (-(float)Math.PI / 4F), -0.0349066F);
		...
		this.setRotation(this.leg1part3c, -0.4833219F, (-(float)Math.PI / 4F), -0.0349066F);
		...
		this.setRotation(this.leg2start, 0.0F, ((float)Math.PI / 4F), 0.0F);
		...
		this.setRotation(this.leg2startpart2, 0.3717861F, ((float)Math.PI / 4F), 0.0F);
		...
		this.setRotation(this.leg2startpart3, 0.669215F, ((float)Math.PI / 4F), 0.0F);
		...
		this.setRotation(this.leg2, 1.041001F, ((float)Math.PI / 4F), 0.0F);
		...
		this.setRotation(this.leg2part2, -1.152537F, ((float)Math.PI / 4F), 0.0F);
		...
		this.setRotation(this.leg2part2b, -0.7435722F, ((float)Math.PI / 4F), 0.0F);
		...
		this.setRotation(this.leg2part2c, -0.6320451F, ((float)Math.PI / 4F), 0.0F);
		...
		this.setRotation(this.leg2part2d, -1.041001F, ((float)Math.PI / 4F), 0.0F);
		...
		this.setRotation(this.leg2part3, 0.669215F, ((float)Math.PI / 4F), 0.0F);
		...
		this.setRotation(this.leg2part3b, -0.4833219F, ((float)Math.PI / 4F), -0.0349066F);
		...
		this.setRotation(this.leg2part3c, -0.4833219F, ((float)Math.PI / 4F), -0.0349066F);
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		newangle = MathHelper.sin(f2 * 2.0F * this.wingspeed) * (float)Math.PI * 0.12F * f1;
		nextangle = MathHelper.sin((f2 + 0.1F) * 2.0F * this.wingspeed) * (float)Math.PI * 0.12F * f1;
		upangle = 0.0F;
		if (nextangle > newangle)
			upangle = Math.abs(MathHelper.cos(f2 * 2.0F * this.wingspeed) * (float)Math.PI * 0.12F * f1);
		this.doLeftFrontLeg(newangle, upangle);
		this.doLeftRearLeg(-newangle, upangle);
		
		newangle = MathHelper.sin((float)((double)(f2 * 2.0F * this.wingspeed) + Math.PI)) * (float)Math.PI * 0.12F * f1;
		nextangle = MathHelper.sin((float)((double)((f2 + 0.1F) * 2.0F * this.wingspeed) + Math.PI)) * (float)Math.PI * 0.12F * f1;
		upangle = 0.0F;
		if (nextangle > newangle)
			upangle = Math.abs(MathHelper.cos((float)((double)(f2 * 2.0F * this.wingspeed) + Math.PI)) * (float)Math.PI * 0.12F * f1);
		...
		if (e.getAttacking() == 0) {
			newangle = MathHelper.cos(f2 * 0.3F * this.wingspeed) * (float)Math.PI * 0.015F;
		} else {
			newangle = MathHelper.cos(f2 * 2.6F * this.wingspeed) * (float)Math.PI * 0.1F;
		}
	...
	private void doRightFrontLeg(float angle, float upangle)
	{
		...
		float dist = 14.0F;
		dist = (float)((double)dist * Math.cos((double)this.leg1.rotateAngleX));
		this.leg1part2.rotationPointZ = this.leg1part2b.rotationPointZ = this.leg1part2c.rotationPointZ = this.leg1part2d.rotationPointZ = (float)((double)this.leg1.rotationPointZ - Math.cos((double)this.leg1.rotateAngleY) * (double)dist);
		this.leg1part2.rotationPointX = this.leg1part2b.rotationPointX = this.leg1part2c.rotationPointX = this.leg1part2d.rotationPointX = (float)((double)this.leg1.rotationPointX - Math.sin((double)this.leg1.rotateAngleY) * (double)dist);
		...
		dist = 14.0F;
		dist = (float)((double)dist * Math.cos((double)this.leg1part2.rotateAngleX));
		this.leg1part3.rotationPointZ = (float)((double)this.leg1part2.rotationPointZ - Math.cos((double)this.leg1part2.rotateAngleY) * (double)dist);
		this.leg1part3.rotationPointX = (float)((double)this.leg1part2.rotationPointX - Math.sin((double)this.leg1part2.rotateAngleY) * (double)dist);
		
		this.leg1part3.rotateAngleX = 0.669F - upangle;
		
		dist = 8.0F;
		dist = (float)Math.abs((double)dist * Math.cos((double)this.leg1part3.rotateAngleX));
		this.leg1part3b.rotationPointZ = this.leg1part3c.rotationPointZ = (float)((double)this.leg1part3.rotationPointZ - Math.cos((double)this.leg1part3.rotateAngleY) * (double)dist);
		this.leg1part3b.rotationPointX = this.leg1part3c.rotationPointX = (float)((double)this.leg1part3.rotationPointX - Math.sin((double)this.leg1part3.rotateAngleY) * (double)dist);
	...
	private void doLeftFrontLeg(float angle, float upangle)
	{
		...
		float dist = 14.0F;
		dist = (float)((double)dist * Math.cos((double)this.leg2.rotateAngleX));
		this.leg2part2.rotationPointZ = this.leg2part2b.rotationPointZ = this.leg2part2c.rotationPointZ = this.leg2part2d.rotationPointZ = (float)((double)this.leg2.rotationPointZ - Math.cos((double)this.leg2.rotateAngleY) * (double)dist);
		this.leg2part2.rotationPointX = this.leg2part2b.rotationPointX = this.leg2part2c.rotationPointX = this.leg2part2d.rotationPointX = (float)((double)this.leg2.rotationPointX - Math.sin((double)this.leg2.rotateAngleY) * (double)dist);
		...
		dist = 14.0F;
		dist = (float)((double)dist * Math.cos((double)this.leg2part2.rotateAngleX));
		this.leg2part3.rotationPointZ = (float)((double)this.leg2part2.rotationPointZ - Math.cos((double)this.leg2part2.rotateAngleY) * (double)dist);
		this.leg2part3.rotationPointX = (float)((double)this.leg2part2.rotationPointX - Math.sin((double)this.leg2part2.rotateAngleY) * (double)dist);
		
		this.leg2part3.rotateAngleX = 0.669F - upangle;
		
		dist = 8.0F;
		dist = (float)Math.abs((double)dist * Math.cos((double)this.leg2part3.rotateAngleX));
		this.leg2part3b.rotationPointZ = this.leg2part3c.rotationPointZ = (float)((double)this.leg2part3.rotationPointZ - Math.cos((double)this.leg2part3.rotateAngleY) * (double)dist);
		this.leg2part3b.rotationPointX = this.leg2part3c.rotationPointX = (float)((double)this.leg2part3.rotationPointX - Math.sin((double)this.leg2part3.rotateAngleY) * (double)dist);
	...
	private void doRightRearLeg(float angle, float upangle)
	{
		...
		float dist = 14.0F;
		dist = (float)((double)dist * Math.cos((double)this.leg4.rotateAngleX));
		this.leg4part2.rotationPointZ = this.leg4part2b.rotationPointZ = this.leg4part2c.rotationPointZ = this.leg4part2d.rotationPointZ = (float)((double)this.leg4.rotationPointZ - Math.cos((double)this.leg4.rotateAngleY) * (double)dist);
		this.leg4part2.rotationPointX = this.leg4part2b.rotationPointX = this.leg4part2c.rotationPointX = this.leg4part2d.rotationPointX = (float)((double)this.leg4.rotationPointX - Math.sin((double)this.leg4.rotateAngleY) * (double)dist);
		...
		dist = 14.0F;
		dist = (float)((double)dist * Math.cos((double)this.leg4part2.rotateAngleX));
		this.leg4part3.rotationPointZ = (float)((double)this.leg4part2.rotationPointZ - Math.cos((double)this.leg4part2.rotateAngleY) * (double)dist);
		this.leg4part3.rotationPointX = (float)((double)this.leg4part2.rotationPointX - Math.sin((double)this.leg4part2.rotateAngleY) * (double)dist);
		
		this.leg4part3.rotateAngleX = 0.669F - upangle;
		
		dist = 8.0F;
		dist = (float)Math.abs((double)dist * Math.cos((double)this.leg4part3.rotateAngleX));
		this.leg4part3b.rotationPointZ = this.leg4part3c.rotationPointZ = (float)((double)this.leg4part3.rotationPointZ - Math.cos((double)this.leg4part3.rotateAngleY) * (double)dist);
		this.leg4part3b.rotationPointX = this.leg4part3c.rotationPointX = (float)((double)this.leg4part3.rotationPointX - Math.sin((double)this.leg4part3.rotateAngleY) * (double)dist);
	...
	private void doLeftRearLeg(float angle, float upangle)
	{
		...
		float dist = 14.0F;
		dist = (float)((double)dist * Math.cos((double)this.leg3.rotateAngleX));
		this.leg3part2.rotationPointZ = this.leg3part2b.rotationPointZ = this.leg3part2c.rotationPointZ = this.leg3part2d.rotationPointZ = (float)((double)this.leg3.rotationPointZ - Math.cos((double)this.leg3.rotateAngleY) * (double)dist);
		this.leg3part2.rotationPointX = this.leg3part2b.rotationPointX = this.leg3part2c.rotationPointX = this.leg3part2d.rotationPointX = (float)((double)this.leg3.rotationPointX - Math.sin((double)this.leg3.rotateAngleY) * (double)dist);
		...
		dist = 14.0F;
		dist = (float)((double)dist * Math.cos((double)this.leg3part2.rotateAngleX));
		this.leg3part3.rotationPointZ = (float)((double)this.leg3part2.rotationPointZ - Math.cos((double)this.leg3part2.rotateAngleY) * (double)dist);
		this.leg3part3.rotationPointX = (float)((double)this.leg3part2.rotationPointX - Math.sin((double)this.leg3part2.rotateAngleY) * (double)dist);
		
		this.leg3part3.rotateAngleX = 0.669F - upangle;
		
		dist = 8.0F;
		dist = (float)Math.abs((double)dist * Math.cos((double)this.leg3part3.rotateAngleX));
		this.leg3part3b.rotationPointZ = this.leg3part3c.rotationPointZ = (float)((double)this.leg3part3.rotationPointZ - Math.cos((double)this.leg3part3.rotateAngleY) * (double)dist);
		this.leg3part3b.rotationPointX = this.leg3part3c.rotationPointX = (float)((double)this.leg3part3.rotationPointX - Math.sin((double)this.leg3part3.rotateAngleY) * (double)dist);
