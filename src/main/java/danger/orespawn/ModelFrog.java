...
public class ModelFrog extends ModelBase
{
	...
	public ModelFrog(float f1)
	{
		...
		this.setRotation(this.lfleg, (-(float)Math.PI / 6F), 0.0F, -0.4712389F);
		...
		this.setRotation(this.rfleg, (-(float)Math.PI / 6F), 0.0F, 0.4712389F);
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		this.lleg2.rotationPointY = this.lleg1.rotationPointY - (float)Math.cos((double)this.lleg1.rotateAngleZ) * 9.0F;
		this.lleg2.rotationPointX = this.lleg1.rotationPointX + (float)Math.sin((double)this.lleg1.rotateAngleZ) * 9.0F;
		
		this.rleg2.rotationPointY = this.rleg1.rotationPointY - (float)Math.cos((double)this.rleg1.rotateAngleZ) * 9.0F;
		this.rleg2.rotationPointX = this.rleg1.rotationPointX + (float)Math.sin((double)this.rleg1.rotateAngleZ) * 9.0F;
