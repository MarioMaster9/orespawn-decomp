...
public class QueenSpawnerBlock extends BlockReed {
	...
	public void randomDisplayTick(World par1World, int par2, int par3, int par4, Random par5Random) {
		...
		} else if (par1World.rand.nextInt(20) == 1) {
			for (int j1 = 0; j1 < 20; ++j1) {
				par1World.spawnParticle("fireworksSpark", (double)((float)par2 + par1World.rand.nextFloat()), (double)par3 + (double)par1World.rand.nextFloat(), (double)((float)par4 + par1World.rand.nextFloat()), 0.0D, 0.0D, 0.0D);
			}
	...
	public void onBlockDestroyedByPlayer(World par1World, int par2, int par3, int par4, int par5) {
		this.updateTick(par1World, par2, par3, par4, (Random)null);
	}

	public void updateTick(World par1World, int par2, int par3, int par4, Random par5Random) {
		if (!par1World.isRemote) {
			if (OreSpawnMain.TheQueenEnable != 0) {
				this.spawnTheQueen(par1World, (double)par2, (double)(par3 + 8), (double)par4);
			}
