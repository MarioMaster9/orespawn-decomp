...
public class ModelDungeonBeast extends ModelBase
{
	...
	public ModelDungeonBeast(float f1)
	{
		...
		this.setRotation(this.ljaw3, 0.0F, ((float)Math.PI / 6F), 0.0F);
		...
		this.setRotation(this.rjaw3, 0.0F, (-(float)Math.PI / 6F), 0.0F);
		...
		this.setRotation(this.ltoe3, -1.570796F, ((float)Math.PI / 4F), (-(float)Math.PI / 4F));
		...
		this.setRotation(this.ltoe2, -1.570796F, 0.0F, (-(float)Math.PI / 4F));
		...
		this.setRotation(this.ltoe1, -1.570796F, (-(float)Math.PI / 4F), (-(float)Math.PI / 4F));
		...
		this.setRotation(this.rh1, 0.0F, 0.0F, (-(float)Math.PI / 6F));
		...
		this.setRotation(this.lh1, 0.0F, 0.0F, (-(float)Math.PI / 6F));
		...
		this.setRotation(this.bodys1, 0.0F, 0.0F, (-(float)Math.PI / 6F));
		...
		this.setRotation(this.bodys2, 0.0F, 0.0F, (-(float)Math.PI / 6F));
		...
		this.setRotation(this.bodys3, 0.0F, 0.0F, (-(float)Math.PI / 6F));
		...
		this.setRotation(this.rfoot2, -1.570796F, ((float)Math.PI / 4F), 0.0F);
		...
		this.setRotation(this.lfoot2, -1.570796F, (-(float)Math.PI / 4F), 0.0F);
		...
		this.setRotation(this.rtoe3, -1.570796F, (-(float)Math.PI / 4F), (-(float)Math.PI / 4F));
		...
		this.setRotation(this.rtoe2, -1.570796F, 0.0F, (-(float)Math.PI / 4F));
		...
		this.setRotation(this.rtoe1, -1.570796F, ((float)Math.PI / 4F), (-(float)Math.PI / 4F));
	}
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		newangle = MathHelper.cos(f2 * 1.4F * this.wingspeed) * (float)Math.PI * 0.22F * f1;
		this.rleg1.rotateAngleZ = this.rleg2.rotateAngleZ = this.rfoot.rotateAngleZ = this.rfoot2.rotateAngleZ = this.rheel.rotateAngleZ = newangle;
		this.rtoe2.rotateAngleZ = -0.785F + newangle;
		this.lleg1.rotateAngleZ = this.lleg2.rotateAngleZ = this.lfoot.rotateAngleZ = this.lfoot2.rotateAngleZ = this.lheel.rotateAngleZ = -newangle;
		this.ltoe2.rotateAngleZ = -0.785F - newangle;
		
		this.bodys1.rotateAngleX = MathHelper.cos(f2 * 0.5F * this.wingspeed) * (float)Math.PI * 0.07F;
		this.bodys2.rotateAngleX = MathHelper.cos(f2 * 0.5F * this.wingspeed + pi4) * (float)Math.PI * 0.07F;
		this.bodys3.rotateAngleX = MathHelper.cos(f2 * 0.5F * this.wingspeed + 2.0F * pi4) * (float)Math.PI * 0.07F;
		this.t1s1.rotateAngleX = MathHelper.cos(f2 * 0.5F * this.wingspeed + 3.0F * pi4) * (float)Math.PI * 0.07F;
		this.t1s2.rotateAngleX = MathHelper.cos(f2 * 0.5F * this.wingspeed + 4.0F * pi4) * (float)Math.PI * 0.07F;
		this.t1s3.rotateAngleX = MathHelper.cos(f2 * 0.5F * this.wingspeed + 5.0F * pi4) * (float)Math.PI * 0.07F;
		this.t2s1.rotateAngleX = -MathHelper.cos(f2 * 0.5F * this.wingspeed + 6.0F * pi4) * (float)Math.PI * 0.07F;
		this.t2s2.rotateAngleX = -MathHelper.cos(f2 * 0.5F * this.wingspeed + 7.0F * pi4) * (float)Math.PI * 0.07F;
		this.t2s3.rotateAngleX = -MathHelper.cos(f2 * 0.5F * this.wingspeed + 8.0F * pi4) * (float)Math.PI * 0.07F;
		this.t3s1.rotateAngleX = -MathHelper.cos(f2 * 0.5F * this.wingspeed + 9.0F * pi4) * (float)Math.PI * 0.07F;
		this.t3s2.rotateAngleX = -MathHelper.cos(f2 * 0.5F * this.wingspeed + 10.0F * pi4) * (float)Math.PI * 0.07F;
		this.t4s1.rotateAngleX = -MathHelper.cos(f2 * 0.5F * this.wingspeed + 11.0F * pi4) * (float)Math.PI * 0.07F;
		this.t5s1.rotateAngleX = -MathHelper.cos(f2 * 0.5F * this.wingspeed + 12.0F * pi4) * (float)Math.PI * 0.07F;
		this.t6s1.rotateAngleX = -MathHelper.cos(f2 * 0.5F * this.wingspeed + 13.0F * pi4) * (float)Math.PI * 0.07F;
		...
		newangle = MathHelper.cos(f2 * 0.75F * this.wingspeed) * (float)Math.PI * 0.25F * tailamp;
		this.tail1.rotateAngleY = newangle * 0.25F;
		this.t1s1.rotateAngleY = this.t1s2.rotateAngleY = this.t1s3.rotateAngleY = this.tail1.rotateAngleY;
		
		this.tail2.rotateAngleY = newangle * 0.5F;
		this.tail2.rotationPointX = this.tail1.rotationPointX - (float)Math.cos((double)this.tail1.rotateAngleY) * 6.0F;
		this.tail2.rotationPointZ = this.tail1.rotationPointZ - (float)Math.sin((double)this.tail1.rotateAngleY) * 6.0F;
		this.t2s1.rotateAngleY = this.t2s2.rotateAngleY = this.t2s3.rotateAngleY = this.tail2.rotateAngleY;
		this.t2s1.rotationPointZ = this.t2s2.rotationPointZ = this.t2s3.rotationPointZ = this.tail2.rotationPointZ;
		this.t2s1.rotationPointX = this.t2s2.rotationPointX = this.t2s3.rotationPointX = this.tail2.rotationPointX;
		
		this.tail3.rotateAngleY = newangle * 0.75F;
		this.tail3.rotationPointX = this.tail2.rotationPointX - (float)Math.cos((double)this.tail2.rotateAngleY) * 5.0F;
		this.tail3.rotationPointZ = this.tail2.rotationPointZ - (float)Math.sin((double)this.tail2.rotateAngleY) * 5.0F;
		...
		this.tail4.rotationPointX = this.tail3.rotationPointX - (float)Math.cos((double)this.tail3.rotateAngleY) * 4.5F;
		this.tail4.rotationPointZ = this.tail3.rotationPointZ - (float)Math.sin((double)this.tail3.rotateAngleY) * 4.5F;
		...
		this.tail5.rotationPointX = this.tail4.rotationPointX - (float)Math.cos((double)this.tail4.rotateAngleY) * 4.0F;
		this.tail5.rotationPointZ = this.tail4.rotationPointZ - (float)Math.sin((double)this.tail4.rotateAngleY) * 4.0F;
		...
		this.tail6.rotationPointX = this.tail5.rotationPointX - (float)Math.cos((double)this.tail5.rotateAngleY) * 3.0F;
		this.tail6.rotationPointZ = this.tail5.rotationPointZ - (float)Math.sin((double)this.tail5.rotateAngleY) * 3.0F;
		...
		this.tail7.rotationPointX = this.tail6.rotationPointX - (float)Math.cos((double)this.tail6.rotateAngleY) * 3.0F;
		this.tail7.rotationPointZ = this.tail6.rotationPointZ - (float)Math.sin((double)this.tail6.rotateAngleY) * 3.0F;
		...
		newangle = MathHelper.cos(f2 * 2.0F * this.wingspeed) * (float)Math.PI * 0.15F;
		nextangle = MathHelper.cos((f2 + 0.1F) * 2.0F * this.wingspeed) * (float)Math.PI * 0.15F;
