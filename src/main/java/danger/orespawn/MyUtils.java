...
public class MyUtils
{
	public static boolean isRoyalty(Entity e) {
		...
		if (e instanceof ThePrince) return true;
		if (e instanceof ThePrinceTeen) return true;
		if (e instanceof ThePrinceAdult) return true;
		if (e instanceof ThePrincess) return true;
		if (e instanceof TheKing) return true;
		if (e instanceof KingHead) return true;
		if (e instanceof TheQueen) return true;
		if (e instanceof QueenHead) return true;
		if (e instanceof PurplePower) return true;
		return false;
	}
