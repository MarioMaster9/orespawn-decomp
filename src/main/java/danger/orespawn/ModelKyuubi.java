...
public class ModelKyuubi extends ModelBase
{
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		if ((double)f1 > 0.1) {
			newangle = MathHelper.cos(f2 * 1.1F * this.wingspeed) * (float)Math.PI * 0.2F * f1;
		} else {
			newangle = 0.0F;
		}
		...
		this.rtLegLower.rotationPointZ = (float)(Math.sin((double)this.rtLegUpperFire.rotateAngleX) * 8.0D);
		this.rtLegLowerFire.rotationPointZ = (float)(Math.sin((double)this.rtLegUpperFire.rotateAngleX) * 8.0D);
		...
		this.lfLegLower.rotationPointZ = (float)(Math.sin((double)this.lfLegUppperFire.rotateAngleX) * 8.0D);
		this.lfLegLowerFire.rotationPointZ = (float)(Math.sin((double)this.lfLegUppperFire.rotateAngleX) * 8.0D);
		
		
		
		newangle = MathHelper.cos(f2 * 1.1F * this.wingspeed) * (float)Math.PI * 0.08F * f1;
		
		newangle += MathHelper.cos(f2 * 0.5F * this.wingspeed) * (float)Math.PI * 0.01F;
		...
		this.rtArmLower.rotationPointZ = (float)(Math.sin((double)this.rtArmUpperFire.rotateAngleX) * 8.0D);
		this.rtArmLowerFire.rotationPointZ = (float)(Math.sin((double)this.rtArmUpperFire.rotateAngleX) * 8.0D);
		...
		this.lfArmLower.rotationPointZ = (float)(Math.sin((double)this.lfArmUpperFire.rotateAngleX) * 8.0D);
		this.lfArmLowerFire.rotationPointZ = (float)(Math.sin((double)this.lfArmUpperFire.rotateAngleX) * 8.0D);
		
		
		
		float pi4 = 0.7853975F;
		
		this.head.rotateAngleY = (float)Math.toRadians((double)f3) + pi4 * 4.0F;
		this.headFire.rotateAngleY = (float)Math.toRadians((double)f3);
		
		
		
		
		float fc = (float)Math.cos((double)(this.headFire.rotateAngleY + pi4));
		float fs = (float)Math.sin((double)(this.headFire.rotateAngleY + pi4));
		...
		this.lfHorn1.rotateAngleY = this.headFire.rotateAngleY + 0.244F + MathHelper.cos(f2 * 1.3F * this.wingspeed) * (float)Math.PI * 0.1F;
		this.lfHorn2.rotationPointZ = this.lfHorn1.rotationPointZ - (float)Math.cos((double)this.lfHorn1.rotateAngleY) * 2.0F;
		this.lfHorn2.rotationPointX = this.lfHorn1.rotationPointX - (float)Math.sin((double)this.lfHorn1.rotateAngleY) * 2.0F;
		this.lfHorn2.rotateAngleY = this.headFire.rotateAngleY + 0.244F + MathHelper.cos(f2 * 1.3F * this.wingspeed - pi4) * (float)Math.PI * 0.1F;
		this.lfHorn3.rotationPointZ = this.lfHorn2.rotationPointZ - (float)Math.cos((double)this.lfHorn2.rotateAngleY) * 4.0F;
		this.lfHorn3.rotationPointX = this.lfHorn2.rotationPointX - (float)Math.sin((double)this.lfHorn2.rotateAngleY) * 4.0F;
		this.lfHorn3.rotateAngleY = this.headFire.rotateAngleY + 0.244F + MathHelper.cos(f2 * 1.3F * this.wingspeed - 2.0F * pi4) * (float)Math.PI * 0.1F;
		this.lfHorn4.rotationPointZ = this.lfHorn3.rotationPointZ - (float)Math.cos((double)this.lfHorn3.rotateAngleY) * 3.0F;
		this.lfHorn4.rotationPointX = this.lfHorn3.rotationPointX - (float)Math.sin((double)this.lfHorn3.rotateAngleY) * 3.0F;
		this.lfHorn4.rotateAngleY = this.headFire.rotateAngleY + 0.244F + MathHelper.cos(f2 * 1.3F * this.wingspeed - 3.0F * pi4) * (float)Math.PI * 0.1F;
		this.lfHorn5.rotationPointZ = this.lfHorn4.rotationPointZ - (float)Math.cos((double)this.lfHorn4.rotateAngleY) * 2.0F;
		this.lfHorn5.rotationPointX = this.lfHorn4.rotationPointX - (float)Math.sin((double)this.lfHorn4.rotateAngleY) * 2.0F;
		this.lfHorn5.rotateAngleY = this.headFire.rotateAngleY + 0.244F + MathHelper.cos(f2 * 1.3F * this.wingspeed - 4.0F * pi4) * (float)Math.PI * 0.1F;
		
		fc = (float)Math.cos((double)(this.headFire.rotateAngleY - pi4));
		fs = (float)Math.sin((double)(this.headFire.rotateAngleY - pi4));
		...
		this.rtHorn1.rotateAngleY = this.headFire.rotateAngleY + -0.244F - MathHelper.cos(f2 * 1.3F * this.wingspeed) * (float)Math.PI * 0.1F;
		this.rtHorn2.rotationPointZ = this.rtHorn1.rotationPointZ - (float)Math.cos((double)this.rtHorn1.rotateAngleY) * 2.0F;
		this.rtHorn2.rotationPointX = this.rtHorn1.rotationPointX - (float)Math.sin((double)this.rtHorn1.rotateAngleY) * 2.0F;
		this.rtHorn2.rotateAngleY = this.headFire.rotateAngleY + -0.244F - MathHelper.cos(f2 * 1.3F * this.wingspeed - pi4) * (float)Math.PI * 0.1F;
		this.rtHorn3.rotationPointZ = this.rtHorn2.rotationPointZ - (float)Math.cos((double)this.rtHorn2.rotateAngleY) * 4.0F;
		this.rtHorn3.rotationPointX = this.rtHorn2.rotationPointX - (float)Math.sin((double)this.rtHorn2.rotateAngleY) * 4.0F;
		this.rtHorn3.rotateAngleY = this.headFire.rotateAngleY + -0.244F - MathHelper.cos(f2 * 1.3F * this.wingspeed - 2.0F * pi4) * (float)Math.PI * 0.1F;
		this.rtHorn4.rotationPointZ = this.rtHorn3.rotationPointZ - (float)Math.cos((double)this.rtHorn3.rotateAngleY) * 3.0F;
		this.rtHorn4.rotationPointX = this.rtHorn3.rotationPointX - (float)Math.sin((double)this.rtHorn3.rotateAngleY) * 3.0F;
		this.rtHorn4.rotateAngleY = this.headFire.rotateAngleY + -0.244F - MathHelper.cos(f2 * 1.3F * this.wingspeed - 3.0F * pi4) * (float)Math.PI * 0.1F;
		this.rtHorn5.rotationPointZ = this.rtHorn4.rotationPointZ - (float)Math.cos((double)this.rtHorn4.rotateAngleY) * 2.0F;
		this.rtHorn5.rotationPointX = this.rtHorn4.rotationPointX - (float)Math.sin((double)this.rtHorn4.rotateAngleY) * 2.0F;
		this.rtHorn5.rotateAngleY = this.headFire.rotateAngleY + -0.244F - MathHelper.cos(f2 * 1.3F * this.wingspeed - 4.0F * pi4) * (float)Math.PI * 0.1F;
		
		
		
		
		this.tail1.rotateAngleY = MathHelper.cos(f2 * 0.9F * this.wingspeed) * (float)Math.PI * 0.2F;
		
		this.tail2.rotationPointX = this.tail1.rotationPointX - (float)Math.sin((double)this.tail1.rotateAngleY) * 3.0F;
		this.tail2.rotateAngleY = MathHelper.cos(f2 * 0.9F * this.wingspeed - pi4) * (float)Math.PI * 0.2F;
		
		this.tail3.rotationPointX = this.tail2.rotationPointX - (float)Math.sin((double)this.tail2.rotateAngleY) * 4.0F;
		this.tail3.rotateAngleY = MathHelper.cos(f2 * 0.9F * this.wingspeed - 2.0F * pi4) * (float)Math.PI * 0.2F;
		
		this.tail4.rotationPointX = this.tail3.rotationPointX - (float)Math.sin((double)this.tail3.rotateAngleY) * 3.5F;
		this.tail4.rotateAngleY = MathHelper.cos(f2 * 0.9F * this.wingspeed - 3.0F * pi4) * (float)Math.PI * 0.2F;
		
		this.tail5.rotationPointX = this.tail4.rotationPointX - (float)Math.sin((double)this.tail4.rotateAngleY) * 5.0F;
		this.tail5.rotateAngleY = MathHelper.cos(f2 * 0.9F * this.wingspeed - 4.0F * pi4) * (float)Math.PI * 0.2F;
		
		this.tail6.rotationPointX = this.tail5.rotationPointX - (float)Math.sin((double)this.tail5.rotateAngleY) * 4.0F;
		this.tail6.rotateAngleY = MathHelper.cos(f2 * 0.9F * this.wingspeed - 5.0F * pi4) * (float)Math.PI * 0.2F;
		
		this.tail7.rotationPointX = this.tail6.rotationPointX - (float)Math.sin((double)this.tail6.rotateAngleY) * 3.0F;
		this.tail7.rotateAngleY = MathHelper.cos(f2 * 0.9F * this.wingspeed - 6.0F * pi4) * (float)Math.PI * 0.2F;
		
		this.tail8.rotationPointX = this.tail7.rotationPointX - (float)Math.sin((double)this.tail7.rotateAngleY) * 2.0F;
		this.tail8.rotateAngleY = MathHelper.cos(f2 * 0.9F * this.wingspeed - 7.0F * pi4) * (float)Math.PI * 0.2F;
		
		this.tail9.rotationPointX = this.tail8.rotationPointX - (float)Math.sin((double)this.tail8.rotateAngleY) * 1.0F;
		this.tail9.rotateAngleY = MathHelper.cos(f2 * 0.9F * this.wingspeed - 8.0F * pi4) * (float)Math.PI * 0.2F;
		
		
		this.tail1.rotateAngleX = -0.26F + MathHelper.cos(f2 * 0.5F * this.wingspeed) * (float)Math.PI * 0.1F;
		this.tail2.rotationPointY = this.tail1.rotationPointY + (float)Math.sin((double)this.tail1.rotateAngleX) * 3.0F;
		this.tail2.rotationPointZ = this.tail1.rotationPointZ - (float)Math.cos((double)this.tail1.rotateAngleX) * 3.0F;
		this.tail2.rotateAngleX = -0.78F + MathHelper.cos(f2 * 0.5F * this.wingspeed - pi4) * (float)Math.PI * 0.1F;
		this.tail3.rotationPointY = this.tail2.rotationPointY + (float)Math.sin((double)this.tail2.rotateAngleX) * 4.0F;
		this.tail3.rotationPointZ = this.tail2.rotationPointZ - (float)Math.cos((double)this.tail2.rotateAngleX) * 4.0F;
		this.tail3.rotateAngleX = -1.11F + MathHelper.cos(f2 * 0.5F * this.wingspeed - 2.0F * pi4) * (float)Math.PI * 0.1F;
		this.tail4.rotationPointY = this.tail3.rotationPointY + (float)Math.sin((double)this.tail3.rotateAngleX) * 3.5F;
		this.tail4.rotationPointZ = this.tail3.rotationPointZ - (float)Math.cos((double)this.tail3.rotateAngleX) * 3.5F;
		this.tail4.rotateAngleX = -0.18F + MathHelper.cos(f2 * 0.5F * this.wingspeed - 3.0F * pi4) * (float)Math.PI * 0.1F;
		this.tail5.rotationPointY = this.tail4.rotationPointY + (float)Math.sin((double)this.tail4.rotateAngleX) * 5.0F;
		this.tail5.rotationPointZ = this.tail4.rotationPointZ - (float)Math.cos((double)this.tail4.rotateAngleX) * 5.0F;
		this.tail5.rotateAngleX = 0.22F + MathHelper.cos(f2 * 0.5F * this.wingspeed - 4.0F * pi4) * (float)Math.PI * 0.1F;
		this.tail6.rotationPointY = this.tail5.rotationPointY + (float)Math.sin((double)this.tail5.rotateAngleX) * 4.0F;
		this.tail6.rotationPointZ = this.tail5.rotationPointZ - (float)Math.cos((double)this.tail5.rotateAngleX) * 4.0F;
		this.tail6.rotateAngleX = 0.63F + MathHelper.cos(f2 * 0.5F * this.wingspeed - 5.0F * pi4) * (float)Math.PI * 0.1F;
		this.tail7.rotationPointY = this.tail6.rotationPointY + (float)Math.sin((double)this.tail6.rotateAngleX) * 3.0F;
		this.tail7.rotationPointZ = this.tail6.rotationPointZ - (float)Math.cos((double)this.tail6.rotateAngleX) * 3.0F;
		this.tail7.rotateAngleX = 0.89F + MathHelper.cos(f2 * 0.5F * this.wingspeed - 6.0F * pi4) * (float)Math.PI * 0.1F;
		this.tail8.rotationPointY = this.tail7.rotationPointY + (float)Math.sin((double)this.tail7.rotateAngleX) * 2.0F;
		this.tail8.rotationPointZ = this.tail7.rotationPointZ - (float)Math.cos((double)this.tail7.rotateAngleX) * 2.0F;
		this.tail8.rotateAngleX = 1.52F + MathHelper.cos(f2 * 0.5F * this.wingspeed - 7.0F * pi4) * (float)Math.PI * 0.1F;
		this.tail9.rotationPointY = this.tail8.rotationPointY + (float)Math.sin((double)this.tail8.rotateAngleX) * 2.0F;
		this.tail9.rotationPointZ = this.tail8.rotationPointZ - (float)Math.cos((double)this.tail8.rotateAngleX) * 2.0F;
		this.tail9.rotateAngleX = 2.0F + MathHelper.cos(f2 * 0.5F * this.wingspeed - 8.0F * pi4) * (float)Math.PI * 0.1F;
