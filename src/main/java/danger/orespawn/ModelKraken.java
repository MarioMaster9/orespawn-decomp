...
public class ModelKraken extends ModelBase
{
	...
	public ModelKraken(float f1)
	{
		...
		this.setRotation(this.Mouth1, -0.3839724F, -0.3839724F, (-(float)Math.PI / 4F));
		...
		this.setRotation(this.Mouth2, -0.3839724F, 0.3839724F, ((float)Math.PI / 4F));
		...
		this.setRotation(this.Mouth5, 0.3839724F, -0.3839724F, ((float)Math.PI / 4F));
		...
		this.setRotation(this.Tent42, 0.0872665F, (-(float)Math.PI / 6F), 0.0F);
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		this.Finright.rotateAngleZ = MathHelper.cos(f2 * 0.43F * this.wingspeed) * (float)Math.PI * 0.15F;
		this.Finleft.rotateAngleZ = MathHelper.cos(f2 * 0.32F * this.wingspeed) * (float)Math.PI * 0.14F;
		...
		this.Sucktioncupleft.rotationPointY = this.Tent58.rotationPointY + (float)Math.sin((double)this.Tent58.rotateAngleX) * 30.0F * (float)Math.cos((double)this.Tent58.rotateAngleY);
		this.Sucktioncupleft.rotationPointZ = this.Tent58.rotationPointZ - (float)Math.cos((double)this.Tent58.rotateAngleX) * 30.0F * (float)Math.cos((double)this.Tent58.rotateAngleY);
		this.Sucktioncupleft.rotationPointX = this.Tent58.rotationPointX - (float)Math.sin((double)this.Tent58.rotateAngleY) * 30.0F * (float)Math.cos((double)this.Tent58.rotateAngleX);
		this.Sucktioncupleft.rotateAngleX = this.Tent58.rotateAngleX;
		this.Sucktioncupleft.rotateAngleY = this.Tent58.rotateAngleY;
		
		this.Sucktioncupright.rotationPointY = this.Tent68.rotationPointY + (float)Math.sin((double)this.Tent68.rotateAngleX) * 30.0F * (float)Math.cos((double)this.Tent68.rotateAngleY);
		this.Sucktioncupright.rotationPointZ = this.Tent68.rotationPointZ - (float)Math.cos((double)this.Tent68.rotateAngleX) * 30.0F * (float)Math.cos((double)this.Tent68.rotateAngleY);
		this.Sucktioncupright.rotationPointX = this.Tent68.rotationPointX - (float)Math.sin((double)this.Tent68.rotateAngleY) * 30.0F * (float)Math.cos((double)this.Tent68.rotateAngleX);
		...
		newangle = MathHelper.cos(f2 * 0.66F) * (float)Math.PI * 0.15F;
		nextangle = MathHelper.cos((f2 + 0.1F) * 0.66F) * (float)Math.PI * 0.15F;
		...
		if (r.ri1 == 1 || r.ri1 == 3) {
			newangle = MathHelper.cos(f2 * 0.5F * this.wingspeed) * (float)Math.PI * 0.015F;
		} else {
			newangle = 0.0F;
		}
	...
	private void dangle_tentacle(float f2, int dir, int att, ModelRenderer p1, ModelRenderer p2, ModelRenderer p3, ModelRenderer p4, ModelRenderer p5, ModelRenderer p6, ModelRenderer p7, ModelRenderer p8)
	{
		...
		p1.rotateAngleX = xoff + s * MathHelper.cos(f2 * differ * this.wingspeed) * (float)Math.PI * amp;
		p1.rotateAngleY = yoff - MathHelper.cos(f2 * ydiffer * this.wingspeed) * (float)Math.PI * amp;
		
		p2.rotationPointY = p1.rotationPointY + (float)Math.sin((double)p1.rotateAngleX) * (float)dist * (float)Math.cos((double)p1.rotateAngleY);
		p2.rotationPointZ = p1.rotationPointZ - (float)Math.cos((double)p1.rotateAngleX) * (float)dist * (float)Math.cos((double)p1.rotateAngleY);
		p2.rotationPointX = p1.rotationPointX - (float)Math.sin((double)p1.rotateAngleY) * (float)dist * (float)Math.cos((double)p1.rotateAngleX);
		p2.rotateAngleX = xoff / 2.0F + s * MathHelper.cos(f2 * differ * this.wingspeed - pi4) * (float)Math.PI * amp;
		p2.rotateAngleY = yoff / 2.0F - MathHelper.cos(f2 * ydiffer * this.wingspeed - pi4) * (float)Math.PI * amp;
		
		p3.rotationPointY = p2.rotationPointY + (float)Math.sin((double)p2.rotateAngleX) * (float)dist * (float)Math.cos((double)p2.rotateAngleY);
		p3.rotationPointZ = p2.rotationPointZ - (float)Math.cos((double)p2.rotateAngleX) * (float)dist * (float)Math.cos((double)p2.rotateAngleY);
		p3.rotationPointX = p2.rotationPointX - (float)Math.sin((double)p2.rotateAngleY) * (float)dist * (float)Math.cos((double)p2.rotateAngleX);
		p3.rotateAngleX = s * MathHelper.cos(f2 * differ * this.wingspeed - 2.0F * pi4) * (float)Math.PI * amp;
		p3.rotateAngleY = -MathHelper.cos(f2 * ydiffer * this.wingspeed - 2.0F * pi4) * (float)Math.PI * amp;
		
		p4.rotationPointY = p3.rotationPointY + (float)Math.sin((double)p3.rotateAngleX) * (float)dist * (float)Math.cos((double)p3.rotateAngleY);
		p4.rotationPointZ = p3.rotationPointZ - (float)Math.cos((double)p3.rotateAngleX) * (float)dist * (float)Math.cos((double)p3.rotateAngleY);
		p4.rotationPointX = p3.rotationPointX - (float)Math.sin((double)p3.rotateAngleY) * (float)dist * (float)Math.cos((double)p3.rotateAngleX);
		p4.rotateAngleX = s * MathHelper.cos(f2 * differ * this.wingspeed - 3.0F * pi4) * (float)Math.PI * amp;
		p4.rotateAngleY = -MathHelper.cos(f2 * ydiffer * this.wingspeed - 3.0F * pi4) * (float)Math.PI * amp;
		
		p5.rotationPointY = p4.rotationPointY + (float)Math.sin((double)p4.rotateAngleX) * (float)dist * (float)Math.cos((double)p4.rotateAngleY);
		p5.rotationPointZ = p4.rotationPointZ - (float)Math.cos((double)p4.rotateAngleX) * (float)dist * (float)Math.cos((double)p4.rotateAngleY);
		p5.rotationPointX = p4.rotationPointX - (float)Math.sin((double)p4.rotateAngleY) * (float)dist * (float)Math.cos((double)p4.rotateAngleX);
		p5.rotateAngleX = s * MathHelper.cos(f2 * differ * this.wingspeed - 4.0F * pi4) * (float)Math.PI * amp;
		p5.rotateAngleY = -MathHelper.cos(f2 * ydiffer * this.wingspeed - 4.0F * pi4) * (float)Math.PI * amp;
		
		p6.rotationPointY = p5.rotationPointY + (float)Math.sin((double)p5.rotateAngleX) * (float)dist * (float)Math.cos((double)p5.rotateAngleY);
		p6.rotationPointZ = p5.rotationPointZ - (float)Math.cos((double)p5.rotateAngleX) * (float)dist * (float)Math.cos((double)p5.rotateAngleY);
		p6.rotationPointX = p5.rotationPointX - (float)Math.sin((double)p5.rotateAngleY) * (float)dist * (float)Math.cos((double)p5.rotateAngleX);
		p6.rotateAngleX = s * MathHelper.cos(f2 * differ * this.wingspeed - 5.0F * pi4) * (float)Math.PI * amp;
		p6.rotateAngleY = -MathHelper.cos(f2 * ydiffer * this.wingspeed - 5.0F * pi4) * (float)Math.PI * amp;
		
		p7.rotationPointY = p6.rotationPointY + (float)Math.sin((double)p6.rotateAngleX) * (float)dist * (float)Math.cos((double)p6.rotateAngleY);
		p7.rotationPointZ = p6.rotationPointZ - (float)Math.cos((double)p6.rotateAngleX) * (float)dist * (float)Math.cos((double)p6.rotateAngleY);
		p7.rotationPointX = p6.rotationPointX - (float)Math.sin((double)p6.rotateAngleY) * (float)dist * (float)Math.cos((double)p6.rotateAngleX);
		p7.rotateAngleX = s * MathHelper.cos(f2 * differ * this.wingspeed - 6.0F * pi4) * (float)Math.PI * amp;
		p7.rotateAngleY = -MathHelper.cos(f2 * ydiffer * this.wingspeed - 6.0F * pi4) * (float)Math.PI * amp;
		
		p8.rotationPointY = p7.rotationPointY + (float)Math.sin((double)p7.rotateAngleX) * (float)dist * (float)Math.cos((double)p7.rotateAngleY);
		p8.rotationPointZ = p7.rotationPointZ - (float)Math.cos((double)p7.rotateAngleX) * (float)dist * (float)Math.cos((double)p7.rotateAngleY);
		p8.rotationPointX = p7.rotationPointX - (float)Math.sin((double)p7.rotateAngleY) * (float)dist * (float)Math.cos((double)p7.rotateAngleX);
		p8.rotateAngleX = s * MathHelper.cos(f2 * differ * this.wingspeed - 7.0F * pi4) * (float)Math.PI * amp;
		p8.rotateAngleY = -MathHelper.cos(f2 * ydiffer * this.wingspeed - 7.0F * pi4) * (float)Math.PI * amp;
	}
}
