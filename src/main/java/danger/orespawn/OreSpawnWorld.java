...
public class OreSpawnWorld implements IWorldGenerator
{
	...
	public void generate(Random random, int chunkX, int chunkZ, World world, IChunkProvider chunkGenerator, IChunkProvider chunkProvider)
	{
		...
		if (world.provider.dimensionId == OreSpawnMain.DimensionID)
		{
			...
			if (false == this.addHugeTree(world, random, chunkX * 16, chunkZ * 16, chunk))
			{
				if (false == this.addAppleTrees(world, random, chunkX * 16, chunkZ * 16, chunk))
				{
					if (false == this.addOtherTrees(world, random, chunkX * 16, chunkZ * 16)) {
						if (recently_placed == 0) this.addKingAltar(world, random, chunkX * 16, chunkZ * 16);
					}
				}
		...
		if (world.provider.dimensionId == OreSpawnMain.DimensionID2)
		{
			...
			if (recently_placed == 0 && random.nextInt(95) == 1)
			{
				...
				if (i == 0) this.addBasiliskMaze(world, random, chunkX * 16, chunkZ * 16);
				if (i == 1) this.addKyuubiDungeon(world, random, chunkX * 16, chunkZ * 16);
				if (i == 2) this.addBeeHive(world, random, chunkX * 16, chunkZ * 16);
				if (i == 3) this.addShadowDungeon(world, random, chunkX * 16, chunkZ * 16);
				if (i == 4) this.addAlienWTF(world, random, chunkX * 16, chunkZ * 16);
				if (i == 5) this.addEnderKnight(world, random, chunkX * 16, chunkZ * 16);
				if (i == 6) this.addLeonNest(world, random, chunkX * 16, chunkZ * 16);
		...
		if (world.provider.dimensionId == OreSpawnMain.DimensionID3)
		{
			...
			if (recently_placed == 0) this.addDamselInDistress(world, random, chunkX * 16, chunkZ * 16);
			if (recently_placed == 0) this.addSpiderHangout(world, random, chunkX * 16, chunkZ * 16);
			if (recently_placed == 0) this.addRedAntHangout(world, random, chunkX * 16, chunkZ * 16);
		...
		if (world.provider.dimensionId == OreSpawnMain.DimensionID4)
		{
			...
			if (recently_placed == 0 && random.nextInt(100) == 0) {
				if (this.D4BigSpaceCheck(world, chunkX * 16, 7, chunkZ * 16) == true) {
					...
					if (i < 3) {
						...
						if (i == 7) this.addD4EnderCastle(world, random, chunkX * 16, chunkZ * 16);
						if (i == 8) this.addD4IncaPyramid(world, random, chunkX * 16, chunkZ * 16);
						if (i == 9) this.addD4RobotLab(world, random, chunkX * 16, chunkZ * 16);
						if (i == 10) this.addD4Mini(world, random, chunkX * 16, chunkZ * 16);
						if (i == 11) this.addD4RubyDungeon(world, random, chunkX * 16, chunkZ * 16);
						if (i == 12) this.addD4CephadromeAltar(world, random, chunkX * 16, chunkZ * 16);
						if (i == 13) this.addD4Greenhouse(world, random, chunkX * 16, chunkZ * 16);
						if (i == 14) this.addD4NightmareRookery(world, random, chunkX * 16, chunkZ * 16);
						if (i == 15) this.addD4StinkyHouse(world, random, chunkX * 16, chunkZ * 16);
						if (i == 16) this.addD4WhiteHouse(world, random, chunkX * 16, chunkZ * 16);
						if (i == 17) this.addPumpkin(world, random, chunkX * 16, chunkZ * 16);
						if (i == 18) this.addD4Rainbow(world, random, chunkX * 16, chunkZ * 16);
					}
				}
			}
			...
			if (i == 0) this.addD4CloudShark(world, random, chunkX * 16, chunkZ * 16);
		...
		if (world.provider.dimensionId == OreSpawnMain.DimensionID5)
		{
			if (!this.addFairyTree(world, random, chunkX * 16, chunkZ * 16)) {
				...
				if (recently_placed == 0) {
					if (!this.addRotatorStation(world, random, chunkX * 16, chunkZ * 16)) {
						if (!this.addUrchinSpawner(world, random, chunkX * 16, chunkZ * 16)) {
							if (!this.addCrystalHauntedHouse(world, random, chunkX * 16, chunkZ * 16)) {
								if (!this.addRoundRotator(world, random, chunkX * 16, chunkZ * 16)) {
			...
			if (world.rand.nextInt(4) == 1) this.addRocks(world, random, chunkX * 16, chunkZ * 16);
			return;
		}
	...
	private void generateEnd(World world, Random random, int chunkX, int chunkZ)
	{
		...
		if (i == 0) this.addEndKnights(world, random, chunkX, chunkZ);
		if (i == 1) this.addEndReapers(world, random, chunkX, chunkZ);
		if (i == 2) this.addHospital(world, random, chunkX, chunkZ);
		if (i == 3) this.addEnderCastle(world, random, chunkX, chunkZ);
	...
	public void generateSurface(World world, Random random, int chunkX, int chunkZ)
	{
		...
		if (OreSpawnMain.DisableOverworldDungeons == 0 && world.provider.dimensionId == 0) {
			if (recently_placed == 0) {
				...
				if (i == 0) this.addPlayPool(world, random, chunkX, chunkZ);
				if (i == 1) this.addWaterDragonLair(world, random, chunkX, chunkZ);
				if (i == 2) this.addGoldFishBowl(world, random, chunkX, chunkZ);
				if (i == 3) this.addGirlfriendIsland(world, random, chunkX, chunkZ);
				if (i == 4) this.addMonsterIsland(world, random, chunkX, chunkZ);
				if (i == 5) this.addFrogPond(world, random, chunkX, chunkZ);
	
				ahh = this.addANest(world, random, chunkX, chunkZ);
				if (!ahh) ahh = this.addHauntedHouse(world, random, chunkX, chunkZ);
				...
				if (!ahh) ahh = this.addBouncyCastle(world, random, chunkX, chunkZ);
	...
	public void generateRuby(World world, Random random, int chunkX, int chunkZ)
	{
		...
		if (OreSpawnMain.Ruby_stats.rate <= 0) return;
		
		
		patchy = OreSpawnMain.Ruby_stats.rate + random.nextInt(7);
		for (int i = 0; i < patchy; i++) {
			...
			if (randPosY <= OreSpawnMain.Ruby_stats.maxdepth && randPosY >= OreSpawnMain.Ruby_stats.mindepth) {
				for (m = randPosY; m > 5; m--) {
					bid = world.getBlock(randPosX, m, randPosZ);
	...
	{
		if (random.nextInt(285) != 0) return false;
				...
				for (int posY = 100; posY > 40; posY--)
				{
					...
					if (world.isAirBlock(posX, posY, posZ)) {
						if (world.getBlock(posX, posY - 1, posZ) == Blocks.grass)
						{
							...
							for (i = 1; i < 10; i++)
								if (!world.isAirBlock(posX, posY + i, posZ)) is_all_air = 0;

							if (is_all_air != 0)
							{
								corn_height = random.nextInt(5);
								corn_height++;
	...
	{
		if (random.nextInt(350) != 0) return;
	...
	{
		if (random.nextInt(275) != 0) return false;
	...
	{
		if (random.nextInt(190) != 0) return false;
	...
	{
		if (random.nextInt(220) != 0) return false;
	...
	{
		if (random.nextInt(250) != 0) return false;
		...
		for (int i = 0; i < 4; i++) {
			...
			for (int posY = 100; posY > 40; posY--)
			{
				...
				if (world.getBlock(posX, posY, posZ) == Blocks.air && world.getBlock(posX, posY - 1, posZ) == Blocks.grass)
				{
					if (!this.quickSpaceCheck(world, posX, posY - 1, posZ)) continue;
	...
	{
		if (random.nextInt(350) != 0) return false;
		if (OreSpawnMain.SpiderDriverEnable == 0) return false;
	...
	{
		if (random.nextInt(25 + OreSpawnMain.LessLag * 2) != 0) return;
	...
	{
		if (OreSpawnMain.RedAntEnable == 0) return;
	...
	{
		if (OreSpawnMain.RedAntEnable == 0 && OreSpawnMain.BlackAntEnable == 0 && OreSpawnMain.RainbowAntEnable == 0 && OreSpawnMain.UnstableAntEnable == 0) return;
		if (redfreq < 2) redfreq = 2;
		
		if (random.nextInt(30 + OreSpawnMain.LessLag * 4) != 0) return;
	...
	public void addEndKnights(World world, Random random, int chunkX, int chunkZ)
	{
		...
		for (int i = 0; i < 3; i++) {
			...
			for (int posY = 90; posY > 10; posY--)
			{
				...
				{
					if (!this.quickSpaceCheck(world, posX, posY, posZ)) continue;
	...
	public void addEnderCastle(World world, Random random, int chunkX, int chunkZ)
	{
		...
		for (int i = 0; i < 3; i++) {
			...
			for (int posY = 90; posY > 10; posY--)
			{
				...
				if (world.isAirBlock(posX, posY, posZ) && world.getBlock(posX, posY - 1, posZ) == Blocks.end_stone)
				{
					if (!this.quickBigSpaceCheck(world, posX, posY, posZ)) continue;
	...
	{
		if (OreSpawnMain.UnstableAntEnable == 0) return;
	...
	{
		if (OreSpawnMain.TermiteEnable == 0) return;
	...
	{
		if (OreSpawnMain.RotatorEnable == 0) return false;
	...
	{
		if (OreSpawnMain.UrchinEnable == 0) return false;
	...
	{
		if (OreSpawnMain.IrukandjiEnable == 0) return;
		...
		for (int i = 0; i < 3; i++) {
			...
			if (world.isAirBlock(posX, posY, posZ))
			{
				...
				if (bid == Blocks.air) {
					...
					if (bid == Blocks.air) {
						this.addCrystalChest(world, posX, posY, posZ, 5); break;
					}
					bid = world.getBlock(posX - 1, posY, posZ);
					if (bid == Blocks.air) {
						this.addCrystalChest(world, posX, posY, posZ, 4); break;
					}
					bid = world.getBlock(posX, posY, posZ + 1);
					if (bid == Blocks.air) {
						this.addCrystalChest(world, posX, posY, posZ, 2); break;
					}
					bid = world.getBlock(posX, posY, posZ - 1);
					if (bid == Blocks.air) {
	...
	public void addCrystalChest(World world, int x, int y, int z, int dir)
	{
		...
		if (i == 0) {
			...
			if (chest != null)
			{
				...
				WeightedRandomChestContent.generateChestContents(world.rand, OreSpawnMain.OreSpawnTrees.CrystalChestContentsList, chest, 1 + world.rand.nextInt(3)); // referencing static member as if it's non-static
			}
		} else {
			...
			if (tileentitymobspawner != null)
			{
				...
				if (t == 0) tileentitymobspawner.func_145881_a().setEntityName("Dungeon Beast");
				if (t == 1) tileentitymobspawner.func_145881_a().setEntityName("Rat");
			}
		}
	}
	...
	public void addIslands(World world, Random random, int chunkX, int chunkZ)
	{
		...
		if (random.nextInt(10 + OreSpawnMain.LessLag * 2) != 1) return;
	...
	public boolean addAppleTrees(World world, Random random, int chunkX, int chunkZ, Chunk chunk)
	{
		...
		if (random.nextInt(15 + freq) != 0) return false;
		if (OreSpawnMain.LessLag == 1)
			howmany /= 2;
			...
			for (int posY = 100; posY > 50; posY--)
			{
				...
				if (world.isAirBlock(posX, posY, posZ)) {
					if (world.getBlock(posX, posY - 1, posZ) == Blocks.grass) {
						...
						if (which < 8) a.makeTree(world, posX, posY - 1, posZ, OreSpawnMain.MyAppleLeaves, chunk);
						if (which == 8) a.makeTree(world, posX, posY - 1, posZ, OreSpawnMain.MyCherryLeaves, chunk);
						if (which == 9) a.makeTree(world, posX, posY - 1, posZ, OreSpawnMain.MyPeachLeaves, chunk);
						added = true;
						break;
					}
				} else {
		...
		for (int i = 0; i < 3 && made_one == 0; i++) {
			...
			for (int posY = 127; posY > 50 && made_one == 0; posY--)
			{
				...
				if (world.isAirBlock(posX, posY, posZ) && world.getBlock(posX, posY - 1, posZ) == Blocks.grass) {
					...
					rand_treetype = random.nextInt(100);
					if (rand_treetype > 75) {
	...
	public void addRocks(World world, Random random, int chunkX, int chunkZ)
	{
		...
		if (OreSpawnMain.RockEnable == 0) return;
		...
		for (int i = 0; i < howmany; i++) {
			...
			for (int posY = 110; posY > 40; posY--)
			{
				...
				if (world.getBlock(posX, posY, posZ) == Blocks.air) {
					bid = world.getBlock(posX, posY - 1, posZ);
			...
			if (bid == Blocks.grass)
			{
				...
				for (x = -5; x < 60; ++x) {
					for (z = -5; z < 70; ++z) {
						...
						if (bid == Blocks.log) continue;
						if (bid == OreSpawnMain.MyAppleLeaves) continue;
						if (bid == OreSpawnMain.MyScaryLeaves) continue;
						if (bid != Blocks.air) return false;
					}
				}
				...
				if (world.isAirBlock(posX, posY, posZ)) {
					if (world.getBlock(posX, posY - 1, posZ) == Blocks.grass)
					{
						...
						if (bid == Blocks.dirt || bid == Blocks.stone)
						{
							...
							if (bid == Blocks.air) air++;
							if (bid == Blocks.dirt || bid == Blocks.stone || bid == Blocks.grass) non_air++;
							bid = world.getBlock(posX - 1, posY - 1, posZ);
							if (bid == Blocks.air) air++;
							if (bid == Blocks.dirt || bid == Blocks.stone || bid == Blocks.grass) non_air++;
	...
	{
		if (random.nextInt(2000) != 1) return false;
		...
		for (int i = 0; i < 8; i++) {
			...
			for (int posY = 100; posY > 50; posY--)
			{
				...
				if (world.isAirBlock(posX, posY, posZ) && world.getBlock(posX, posY - 1, posZ) == Blocks.grass)
				{
					...
					if (!this.quickReallyBigSpaceCheck(world, posX, posY - 1, posZ)) return false;
					if (random.nextInt(2) == 0) {
	...
	private boolean quickSpaceCheck(World world, int posX, int posY, int posZ)
	{
		...
		for (i = -2; i < 10; i++) {
			for (k = -2; k < 10; k++) {
				if (world.getBlock(posX + i, posY + 4, posZ + k) != Blocks.air) return false;
			}
		}
	...
	private boolean quickBigSpaceCheck(World world, int posX, int posY, int posZ)
	{
		...
		for (i = -5; i < 25; i++) {
			for (k = -5; k < 25; k++) {
				if (world.getBlock(posX + i, posY + 8, posZ + k) != Blocks.air) return false;
			}
		}
	...
	private boolean D4BigSpaceCheck(World world, int posX, int posY, int posZ)
	{
		...
		for (i = -25; i < 40; i++) {
			for (k = -25; k < 30; k++) {
				bid = world.getBlock(posX + i, posY + 4, posZ + k);
				if (bid == Blocks.air) continue;
				if (bid == Blocks.log) continue;
				if (bid == OreSpawnMain.MyAppleLeaves) continue;
				if (bid == OreSpawnMain.MyScaryLeaves) continue;
	...
	private Entity spawnCreature(World par0World, String par1, double par2, double par4, double par6)
	{
		...
		if (var8 != null)
		{
			...
			if (par2 > 0.0D) par2 += 0.5D;
			if (par2 < 0.0D) par2 -= 0.5D;
			if (par6 > 0.0D) par6 += 0.5D;
			if (par6 < 0.0D) par6 -= 0.5D;
