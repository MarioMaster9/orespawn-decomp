...
public class ModelOstrich extends ModelBase
{
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		newangle = MathHelper.cos(f2 * 1.25F * this.wingspeed) * (float)Math.PI * lspeed * 0.4F;
		...
		this.Tail1.rotateAngleX = -0.594F + MathHelper.cos(f2 * 0.05F) * (float)Math.PI * 0.06F;
		this.Tail2.rotateAngleX = this.Tail1.rotateAngleX;
		this.Tail3.rotateAngleX = this.Tail1.rotateAngleX;
		
		this.Tail3.rotateAngleY = -0.334F + MathHelper.cos(f2 * 0.061F) * (float)Math.PI * 0.08F;
		this.Tail2.rotateAngleY = 0.334F - MathHelper.cos(f2 * 0.072F) * (float)Math.PI * 0.08F;
		...
		this.Head1.rotateAngleY = (float)Math.toRadians((double)f3) * 0.65F;
		...
		nextangle = MathHelper.cos((f2 + 0.3F) * 1.0F * this.wingspeed) * (float)Math.PI * 0.15F;
