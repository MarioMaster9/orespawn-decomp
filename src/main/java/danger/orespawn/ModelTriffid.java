...
public class ModelTriffid extends ModelBase
{
	...
	public ModelTriffid(float f1)
	{
		...
		this.setRotation(this.h21, 0.1745329F, (-(float)Math.PI / 4F), 0.3839724F);
		...
		this.setRotation(this.h19, 0.1745329F, (-(float)Math.PI / 4F), 0.0F);
		...
		this.setRotation(this.h20, 0.5759587F, (-(float)Math.PI / 4F), -0.2094395F);
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		if (e.getOpenClosed() == 0) {
			...
			newangle = MathHelper.cos(f2 * 0.25F * this.wingspeed) * (float)Math.PI * 0.039F;
		}
		this.l1.rotateAngleZ = -0.95F + newangle;
		this.l1.rotationPointY = (float)(10.0D - Math.cos((double)this.l1.rotateAngleZ) * 5.0D) + 3.0F;
		this.l1.rotationPointX = (float)(-7.0D + Math.sin((double)this.l1.rotateAngleZ) * 5.0D) + 3.0F;
		...
		this.l31.rotationPointY = (float)(10.0D - Math.cos((double)this.l31.rotateAngleZ) * 5.0D) + 3.0F;
		this.l31.rotationPointX = (float)(7.0D + Math.sin((double)this.l31.rotateAngleZ) * 5.0D) - 3.0F;
		...
		this.l16.rotationPointY = (float)(10.0D + Math.cos((double)this.l16.rotateAngleX) * 5.0D);
		this.l16.rotationPointZ = (float)((double)-9.0F - Math.sin((double)this.l16.rotateAngleX) * 5.0D) - 3.0F;
		...
		if (e.getAttacking() != 0) {
			newangle = MathHelper.cos(f2 * 0.25F * this.wingspeed) * (float)Math.PI * 0.5F;
		...
		this.t14.rotationPointY = (float)((double)this.t15.rotationPointY - Math.sin((double)this.t15.rotateAngleZ) * 6.0D);
		this.t14.rotationPointX = (float)((double)this.t15.rotationPointX - Math.cos((double)this.t15.rotateAngleZ) * 6.0D);
		this.t13.rotateAngleZ = -newangle + delta;
		this.t13.rotationPointY = (float)((double)this.t14.rotationPointY - Math.sin((double)this.t14.rotateAngleZ) * 3.0D);
		this.t13.rotationPointX = (float)((double)this.t14.rotationPointX - Math.cos((double)this.t14.rotateAngleZ) * 3.0D);
		this.t12.rotateAngleZ = newangle + delta;
		this.t12.rotationPointY = (float)((double)this.t13.rotationPointY - Math.sin((double)this.t13.rotateAngleZ) * 3.0D);
		this.t12.rotationPointX = (float)((double)this.t13.rotationPointX - Math.cos((double)this.t13.rotateAngleZ) * 3.0D);
		this.t11.rotateAngleZ = -newangle + delta;
		this.t11.rotationPointY = (float)((double)this.t12.rotationPointY - Math.sin((double)this.t12.rotateAngleZ) * 3.0D);
		this.t11.rotationPointX = (float)((double)this.t12.rotationPointX - Math.cos((double)this.t12.rotateAngleZ) * 3.0D);
		this.t10.rotateAngleZ = newangle + delta;
		this.t10.rotationPointY = (float)((double)this.t11.rotationPointY - Math.sin((double)this.t11.rotateAngleZ) * 3.0D);
		this.t10.rotationPointX = (float)((double)this.t11.rotationPointX - Math.cos((double)this.t11.rotateAngleZ) * 3.0D);
		this.t9.rotateAngleZ = -newangle + delta;
		this.t9.rotationPointY = (float)((double)this.t10.rotationPointY - Math.sin((double)this.t10.rotateAngleZ) * 3.0D);
		this.t9.rotationPointX = (float)((double)this.t10.rotationPointX - Math.cos((double)this.t10.rotateAngleZ) * 3.0D);
		this.t8.rotateAngleZ = newangle + delta;
		this.t8.rotationPointY = (float)((double)this.t9.rotationPointY - Math.sin((double)this.t9.rotateAngleZ) * 6.0D);
		this.t8.rotationPointX = (float)((double)this.t9.rotationPointX - Math.cos((double)this.t9.rotateAngleZ) * 6.0D);
		this.t7.rotateAngleZ = -newangle + delta;
		this.t7.rotationPointY = (float)((double)this.t8.rotationPointY - Math.sin((double)this.t8.rotateAngleZ) * 6.0D);
		this.t7.rotationPointX = (float)((double)this.t8.rotationPointX - Math.cos((double)this.t8.rotateAngleZ) * 6.0D);
		this.t6.rotateAngleZ = newangle + delta;
		this.t6.rotationPointY = (float)((double)this.t7.rotationPointY - Math.sin((double)this.t7.rotateAngleZ) * 6.0D);
		this.t6.rotationPointX = (float)((double)this.t7.rotationPointX - Math.cos((double)this.t7.rotateAngleZ) * 6.0D);
		this.t5.rotateAngleZ = -newangle + delta;
		this.t5.rotationPointY = (float)((double)this.t6.rotationPointY - Math.sin((double)this.t6.rotateAngleZ) * 6.0D);
		this.t5.rotationPointX = (float)((double)this.t6.rotationPointX - Math.cos((double)this.t6.rotateAngleZ) * 6.0D);
		this.t4.rotateAngleZ = newangle + delta;
		this.t4.rotationPointY = (float)((double)this.t5.rotationPointY - Math.sin((double)this.t5.rotateAngleZ) * 6.0D);
		this.t4.rotationPointX = (float)((double)this.t5.rotationPointX - Math.cos((double)this.t5.rotateAngleZ) * 6.0D);
		this.t3.rotateAngleZ = -newangle + delta;
		this.t3.rotationPointY = (float)((double)this.t4.rotationPointY - Math.sin((double)this.t4.rotateAngleZ) * 6.0D);
		this.t3.rotationPointX = (float)((double)this.t4.rotationPointX - Math.cos((double)this.t4.rotateAngleZ) * 6.0D);
		this.t2.rotationPointY = this.t1.rotationPointY = (float)((double)this.t3.rotationPointY - Math.sin((double)this.t3.rotateAngleZ) * 3.0D);
		this.t2.rotationPointX = this.t1.rotationPointX = (float)((double)this.t3.rotationPointX - Math.cos((double)this.t3.rotateAngleZ) * 3.0D);
	...
	private void leafpartA(float newangle, ModelRenderer l1, ModelRenderer l2, int j)
	{
		...
		l2.rotationPointY = (float)((double)l1.rotationPointY - Math.cos((double)l1.rotateAngleZ) * (double)j);
		l2.rotationPointX = (float)((double)l1.rotationPointX + Math.sin((double)l1.rotateAngleZ) * (double)j);
	}
	...
	private void leafpartB(float newangle, ModelRenderer l1, ModelRenderer l2, int j)
	{
		...
		l2.rotationPointY = (float)((double)l1.rotationPointY + Math.sin((double)l1.rotateAngleX) * (double)j);
		l2.rotationPointZ = (float)((double)l1.rotationPointZ - Math.cos((double)l1.rotateAngleX) * (double)j);
	}
