...
public class ModelThePrincess extends ModelBase
{
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		if ((double)f1 > 0.1 || c.getAttacking() != 0) {
			newangle = MathHelper.cos(f2 * 2.3F * this.wingspeed) * (float)Math.PI * 0.4F * f1;
		} else {
		...
		this.tail3.rotationPointZ = this.tail2.rotationPointZ + (float)Math.cos((double)this.tail2.rotateAngleY) * 6.0F;
		this.tail3.rotationPointX = this.tail2.rotationPointX + (float)Math.sin((double)this.tail2.rotateAngleY) * 6.0F;
		...
		this.Tail5.rotationPointZ = this.tail4.rotationPointZ + (float)Math.cos((double)this.tail4.rotateAngleY) * 4.0F;
		this.Tail5.rotationPointX = this.tail4.rotationPointX + (float)Math.sin((double)this.tail4.rotateAngleY) * 4.0F;
		this.Tail5.rotateAngleY = newangle * 3.6F;
		
		this.Tail6.rotationPointZ = this.Tail5.rotationPointZ + (float)Math.cos((double)this.Tail5.rotateAngleY) * 4.0F;
		...
		this.jaw.rotationPointZ = this.snout.rotationPointZ - (float)Math.cos((double)this.snout.rotateAngleY);
		this.jaw.rotationPointX = this.snout.rotationPointX - (float)Math.sin((double)this.snout.rotateAngleY);
		...
		this.Ljaw.rotationPointZ = this.Lsnout.rotationPointZ - (float)Math.cos((double)this.Lsnout.rotateAngleY);
		this.Ljaw.rotationPointX = this.Lsnout.rotationPointX - (float)Math.sin((double)this.Lsnout.rotateAngleY);
		...
		this.Rjaw.rotationPointZ = this.Rsnout.rotationPointZ - (float)Math.cos((double)this.Rsnout.rotateAngleY);
		...
		if (c.getAttacking() != 0) {
			...
			Ljx = 0.2F + newangle;
			newangle = MathHelper.cos(f2 * 2.1F * this.wingspeed) * (float)Math.PI * 0.2F;
			Rjx = 0.2F + newangle;
			newangle = MathHelper.cos(f2 * 2.3F * this.wingspeed) * (float)Math.PI * 0.2F;
			jx = 0.2F + newangle;
		}
		...
		this.Lhead.rotationPointY = this.Lneck.rotationPointY - (float)Math.cos((double)this.Lneck.rotateAngleX) * 7.0F;
		this.Lheadfin.rotationPointY = this.Lsnout.rotationPointY = this.Ljaw.rotationPointY = this.Lhead.rotationPointY;
		this.Lhead.rotationPointZ = this.Lneck.rotationPointZ - (float)Math.sin((double)this.Lneck.rotateAngleX) * 7.0F;
		this.Lheadfin.rotationPointZ = this.Lsnout.rotationPointZ = this.Ljaw.rotationPointZ = this.Lhead.rotationPointZ;
		this.Lhead.rotationPointX = this.Lneck.rotationPointX - (float)Math.sin((double)this.Lneck.rotateAngleY) * 7.0F * (float)Math.sin((double)this.Lneck.rotateAngleX);
		this.Lheadfin.rotationPointX = this.Lsnout.rotationPointX = this.Ljaw.rotationPointX = this.Lhead.rotationPointX;
		
		this.Rhead.rotationPointY = this.Rneck.rotationPointY - (float)Math.cos((double)this.Rneck.rotateAngleX) * 7.0F;
		this.Rheadfin.rotationPointY = this.Rsnout.rotationPointY = this.Rjaw.rotationPointY = this.Rhead.rotationPointY;
		this.Rhead.rotationPointZ = this.Rneck.rotationPointZ - (float)Math.sin((double)this.Rneck.rotateAngleX) * 7.0F;
		this.Rheadfin.rotationPointZ = this.Rsnout.rotationPointZ = this.Rjaw.rotationPointZ = this.Rhead.rotationPointZ;
		this.Rhead.rotationPointX = this.Rneck.rotationPointX - (float)Math.sin((double)this.Rneck.rotateAngleY) * 7.0F * (float)Math.sin((double)this.Rneck.rotateAngleX);
		this.Rheadfin.rotationPointX = this.Rsnout.rotationPointX = this.Rjaw.rotationPointX = this.Rhead.rotationPointX;
		
		this.head.rotationPointY = this.neck.rotationPointY - (float)Math.cos((double)this.neck.rotateAngleX) * 7.0F;
		this.headfin.rotationPointY = this.snout.rotationPointY = this.jaw.rotationPointY = this.head.rotationPointY;
		this.head.rotationPointZ = this.neck.rotationPointZ - (float)Math.sin((double)this.neck.rotateAngleX) * 7.0F;
		this.headfin.rotationPointZ = this.snout.rotationPointZ = this.jaw.rotationPointZ = this.head.rotationPointZ;
		this.head.rotationPointX = this.neck.rotationPointX - (float)Math.sin((double)this.neck.rotateAngleY) * 7.0F * (float)Math.sin((double)this.neck.rotateAngleX);
		...
		if ((double)this.Lpower.rotateAngleX > Math.PI) this.Lpower.rotateAngleX -= (Math.PI * 2D);
		this.Cpower.rotateAngleX += 0.04F;
		if ((double)this.Cpower.rotateAngleX > Math.PI) this.Cpower.rotateAngleX -= (Math.PI * 2D);
		this.Rpower.rotateAngleX += 0.05F;
		if ((double)this.Rpower.rotateAngleX > Math.PI) this.Rpower.rotateAngleX -= (Math.PI * 2D);
		
		this.Lpower.rotateAngleY += 0.035F;
		if ((double)this.Lpower.rotateAngleY > Math.PI) this.Lpower.rotateAngleY -= (Math.PI * 2D);
		this.Cpower.rotateAngleY += 0.046F;
		if ((double)this.Cpower.rotateAngleY > Math.PI) this.Cpower.rotateAngleY -= (Math.PI * 2D);
		this.Rpower.rotateAngleY += 0.065F;
		if ((double)this.Rpower.rotateAngleY > Math.PI) this.Rpower.rotateAngleY -= (Math.PI * 2D);
		
		this.Lpower.rotateAngleZ += 0.05F;
		if ((double)this.Lpower.rotateAngleZ > Math.PI) this.Lpower.rotateAngleZ -= (Math.PI * 2D);
		this.Cpower.rotateAngleZ += 0.13F;
		if ((double)this.Cpower.rotateAngleZ > Math.PI) this.Cpower.rotateAngleZ -= (Math.PI * 2D);
		this.Rpower.rotateAngleZ += 0.03F;
		if ((double)this.Rpower.rotateAngleZ > Math.PI) this.Rpower.rotateAngleZ -= (Math.PI * 2D);
