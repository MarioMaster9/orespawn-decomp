	...
	public void onUpdate() {
		...
		if (this.worldObj.isRemote) {
			...
			if (this.rock_type == 10 && this.worldObj.rand.nextInt(20) == 0) {
				this.worldObj.spawnParticle("happyVillager", this.posX, this.posY + 0.25D, this.posZ, (double)((this.worldObj.rand.nextFloat() - this.worldObj.rand.nextFloat()) / 60.0F), (double)(this.worldObj.rand.nextFloat() / 2.0F), (double)((this.worldObj.rand.nextFloat() - this.worldObj.rand.nextFloat()) / 60.0F));
			}
			...
			if (this.rock_type == 12 && this.worldObj.rand.nextInt(20) == 0) {
				this.worldObj.spawnParticle("fireworksSpark", this.posX, this.posY + 0.25D, this.posZ, (double)((this.worldObj.rand.nextFloat() - this.worldObj.rand.nextFloat()) / 60.0F), (double)(this.worldObj.rand.nextFloat() / 5.0F), (double)((this.worldObj.rand.nextFloat() - this.worldObj.rand.nextFloat()) / 60.0F));
			}
		}
