...
public class WaterBall extends EntityThrowable {
	...
	private int my_index = OreSpawnConstants.WaterBallIndex;
	...
	protected void onImpact(MovingObjectPosition par1MovingObjectPosition) {
		...
		for (int var3 = 0; var3 < 8; ++var3) {
			this.worldObj.spawnParticle("bubble", this.posX + (double)this.rand.nextFloat() - (double)this.rand.nextFloat(), this.posY + (double)this.rand.nextFloat() - (double)this.rand.nextFloat(), this.posZ + (double)this.rand.nextFloat(), 0.0D, 0.0D, 0.0D);
			this.worldObj.spawnParticle("splash", this.posX + (double)this.rand.nextFloat() - (double)this.rand.nextFloat(), this.posY + (double)this.rand.nextFloat() - (double)this.rand.nextFloat(), this.posZ + (double)this.rand.nextFloat() - (double)this.rand.nextFloat(), 0.0D, 0.0D, 0.0D);
		}
