...
public class ModelThePrinceAdult extends ModelBase
{
	...
	public ModelThePrinceAdult(float f1)
	{
		...
		this.setRotation(this.LThigh, ((float)Math.PI / 4F), 0.0F, 0.0F);
		...
		this.setRotation(this.LUpperLeg, ((float)Math.PI / 4F), 0.0F, 0.0F);
		...
		this.setRotation(this.RThigh, ((float)Math.PI / 4F), 0.0F, 0.0F);
		...
		this.setRotation(this.RUpperLeg, ((float)Math.PI / 4F), 0.0F, 0.0F);
		...
		this.setRotation(this.LHeadMane, ((float)Math.PI / 6F), -0.3839724F, 0.0F);
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		if (k.getAttacking() != 0) {
			newangle = MathHelper.cos(f2 * 0.75F * this.wingspeed) * (float)Math.PI * 0.21F;
		} else {
			newangle = MathHelper.cos(f2 * 0.35F * this.wingspeed) * (float)Math.PI * 0.15F;
			if (k.getActivity() == 0) {
				newangle = MathHelper.cos(f2 * 0.35F * this.wingspeed) * (float)Math.PI * 0.15F * f1;
			}
		}
		if (k.isSitting()) {
			newangle = 0.0F;
		...
		this.Lwing3.rotationPointY = this.Lwing1.rotationPointY + (float)Math.sin((double)this.Lwing1.rotateAngleZ) * 84.0F;
		this.Lwing3.rotationPointX = this.Lwing1.rotationPointX + (float)Math.cos((double)this.Lwing1.rotateAngleZ) * 84.0F;
		...
		this.Lwing5.rotationPointY = this.Lwing3.rotationPointY + (float)Math.sin((double)this.Lwing3.rotateAngleZ) * 184.0F;
		this.Lwing5.rotationPointX = this.Lwing3.rotationPointX + (float)Math.cos((double)this.Lwing3.rotateAngleZ) * 184.0F;
		...
		this.Rwing3.rotationPointY = this.Rwing1.rotationPointY - (float)Math.sin((double)this.Rwing1.rotateAngleZ) * 84.0F;
		this.Rwing3.rotationPointX = this.Rwing1.rotationPointX - (float)Math.cos((double)this.Rwing1.rotateAngleZ) * 84.0F;
		...
		this.Rwing5.rotationPointY = this.Rwing3.rotationPointY - (float)Math.sin((double)this.Rwing3.rotateAngleZ) * 184.0F;
		this.Rwing5.rotationPointX = this.Rwing3.rotationPointX - (float)Math.cos((double)this.Rwing3.rotateAngleZ) * 184.0F;
		...
		newangle = 0.0F;
		if (k.getAttacking() != 0) {
			newangle = MathHelper.cos(f2 * 0.75F * this.wingspeed) * (float)Math.PI * 0.25F;
		}
		...
		newangle = 0.0F;
		if (k.getAttacking() != 0) {
			newangle = MathHelper.cos(f2 * 0.6F * this.wingspeed) * (float)Math.PI * 0.45F;
		} else {
			if (!k.isSitting()) {
				if (k.getActivity() == 0) {
					newangle = MathHelper.cos(f2 * 0.3F * this.wingspeed) * (float)Math.PI * 0.25F * f1;
				}
			}
		}
		...
		this.LLowerLeg.rotationPointY = this.LFoot.rotationPointY = this.LUpperLeg.rotationPointY + (float)Math.cos((double)this.LUpperLeg.rotateAngleX) * 50.0F;
		this.LLowerLeg.rotationPointZ = this.LFoot.rotationPointZ = this.LUpperLeg.rotationPointZ + (float)Math.sin((double)this.LUpperLeg.rotateAngleX) * 50.0F;
		this.LLClaw1.rotationPointY = this.LLClaw2.rotationPointY = this.LLowerLeg.rotationPointY + (float)Math.cos((double)(this.LLowerLeg.rotateAngleX - 0.1F)) * 66.0F;
		this.LLClaw1.rotationPointZ = this.LLClaw2.rotationPointZ = this.LLowerLeg.rotationPointZ + (float)Math.sin((double)(this.LLowerLeg.rotateAngleX - 0.1F)) * 66.0F;
		...
		this.LClawRear.rotationPointY = this.LLowerLeg.rotationPointY + (float)Math.cos((double)(this.LLowerLeg.rotateAngleX + 0.15F)) * 66.0F;
		this.LClawRear.rotationPointZ = this.LLowerLeg.rotationPointZ + (float)Math.sin((double)(this.LLowerLeg.rotateAngleX + 0.15F)) * 66.0F;
		...
		this.RLowerLeg.rotationPointY = this.RFoot.rotationPointY = this.RUpperLeg.rotationPointY + (float)Math.cos((double)this.RUpperLeg.rotateAngleX) * 50.0F;
		this.RLowerLeg.rotationPointZ = this.RFoot.rotationPointZ = this.RUpperLeg.rotationPointZ + (float)Math.sin((double)this.RUpperLeg.rotateAngleX) * 50.0F;
		this.RLClaw1.rotationPointY = this.RLClaw2.rotationPointY = this.RLowerLeg.rotationPointY + (float)Math.cos((double)(this.RLowerLeg.rotateAngleX - 0.1F)) * 66.0F;
		this.RLClaw1.rotationPointZ = this.RLClaw2.rotationPointZ = this.RLowerLeg.rotationPointZ + (float)Math.sin((double)(this.RLowerLeg.rotateAngleX - 0.1F)) * 66.0F;
		...
		this.RClawRear.rotationPointY = this.RLowerLeg.rotationPointY + (float)Math.cos((double)(this.RLowerLeg.rotateAngleX + 0.15F)) * 66.0F;
		this.RClawRear.rotationPointZ = this.RLowerLeg.rotationPointZ + (float)Math.sin((double)(this.RLowerLeg.rotateAngleX + 0.15F)) * 66.0F;
		...
		this.Tail1.rotateAngleY = MathHelper.cos(f2 * tailspeed * this.wingspeed) * (float)Math.PI * tailamp / 2.0F;
		this.Ridge4.rotateAngleY = this.Ridge5.rotateAngleY = this.Tail1.rotateAngleY;
		
		this.Tail2.rotationPointZ = this.Tail1.rotationPointZ + (float)Math.cos((double)this.Tail1.rotateAngleY) * 54.0F;
		this.Tail2.rotationPointX = this.Tail1.rotationPointX - 1.0F + (float)Math.sin((double)this.Tail1.rotateAngleY) * 54.0F;
		this.Tail2.rotateAngleY = MathHelper.cos(f2 * tailspeed * this.wingspeed - pi4) * (float)Math.PI * tailamp;
		
		this.Tail3.rotationPointZ = this.Tail2.rotationPointZ + (float)Math.cos((double)this.Tail2.rotateAngleY) * 42.0F;
		this.Tail3.rotationPointX = this.Tail2.rotationPointX + (float)Math.sin((double)this.Tail2.rotateAngleY) * 42.0F;
		this.Tail3.rotateAngleY = MathHelper.cos(f2 * tailspeed * this.wingspeed - 2.0F * pi4) * (float)Math.PI * tailamp;
		
		this.Tail4.rotationPointZ = this.Tail3.rotationPointZ + (float)Math.cos((double)this.Tail3.rotateAngleY) * 41.0F;
		this.Tail4.rotationPointX = this.Tail3.rotationPointX + (float)Math.sin((double)this.Tail3.rotateAngleY) * 41.0F;
		...
		newangle /= 2.0F;
		this.Tail5.rotationPointZ = this.Tail4.rotationPointZ + (float)Math.cos((double)this.Tail4.rotateAngleY) * 34.0F;
		this.Tail5.rotationPointX = this.Tail4.rotationPointX + (float)Math.sin((double)this.Tail4.rotateAngleY) * 34.0F;
		this.Tail5.rotateAngleY = this.Tail4.rotateAngleY + newangle;
		
		this.Tail6.rotationPointZ = this.Tail5.rotationPointZ + (float)Math.cos((double)this.Tail5.rotateAngleY) * 34.0F;
		this.Tail6.rotationPointX = this.Tail5.rotationPointX + (float)Math.sin((double)this.Tail5.rotateAngleY) * 34.0F;
		this.Tail6.rotateAngleY = this.Tail5.rotateAngleY + newangle;
		
		this.Tail7.rotationPointZ = this.Ridge6.rotationPointZ = this.Tail6.rotationPointZ + (float)Math.cos((double)this.Tail6.rotateAngleY) * 40.0F;
		this.Tail7.rotationPointX = this.Ridge6.rotationPointX = this.Tail6.rotationPointX + (float)Math.sin((double)this.Tail6.rotateAngleY) * 40.0F;
		this.Tail7.rotateAngleY = this.Ridge6.rotateAngleY = this.Tail6.rotateAngleY + newangle;
		
		this.TailTip.rotationPointZ = this.TailTip2.rotationPointZ = this.Tail7.rotationPointZ + (float)Math.cos((double)this.Tail7.rotateAngleY) * 43.0F;
		this.TailTip.rotationPointX = this.TailTip2.rotationPointX = this.Tail7.rotationPointX + (float)Math.sin((double)this.Tail7.rotateAngleY) * 43.0F;
		this.TailTip.rotateAngleY = this.TailTip2.rotateAngleY = this.Tail7.rotateAngleY + newangle;
		
		this.TailSpike.rotationPointZ = this.TailTip.rotationPointZ + (float)Math.cos((double)this.TailTip.rotateAngleY) * 58.0F;
		this.TailSpike.rotationPointX = this.TailTip.rotationPointX + (float)Math.sin((double)this.TailTip.rotateAngleY) * 58.0F;
		this.TailSpike.rotateAngleY = this.TailTip.rotateAngleY + newangle;
		
		float h1, h2, h3;
		float d1, d2, d3;
		if (k.getAttacking() != 0) {
			Lheadlr = MathHelper.sin(f2 * 0.3F * this.wingspeed) * (float)Math.PI * 0.25F;
			Lheadud = (float)Math.toRadians((double)(k.getHead1Ext() - 30));
			Ljawangle = MathHelper.sin(f2 * 0.85F * this.wingspeed) * (float)Math.PI * 0.12F;
			
			Rheadlr = MathHelper.sin(f2 * 0.32F * this.wingspeed) * (float)Math.PI * 0.25F;
			Rheadud = (float)Math.toRadians((double)(k.getHead3Ext() - 30));
			Rjawangle = MathHelper.sin(f2 * 0.95F * this.wingspeed) * (float)Math.PI * 0.12F;
			
			Cheadlr = MathHelper.sin(f2 * 0.28F * this.wingspeed) * (float)Math.PI * 0.25F;
			Cheadud = (float)Math.toRadians((double)(k.getHead2Ext() - 30));
			Cjawangle = MathHelper.sin(f2 * 0.75F * this.wingspeed) * (float)Math.PI * 0.12F;
		...
		{
			if (k.getActivity() != 0) {
				Lheadlr = MathHelper.sin(f2 * 0.17F * this.wingspeed) * (float)Math.PI * 0.08F;
				Lheadud = (float)Math.toRadians((double)(k.getHead1Ext() - 30));
				Ljawangle = MathHelper.sin(f2 * 0.45F * this.wingspeed) * (float)Math.PI * 0.04F;
				
				Rheadlr = MathHelper.sin(f2 * 0.19F * this.wingspeed) * (float)Math.PI * 0.08F;
				Rheadud = (float)Math.toRadians((double)(k.getHead3Ext() - 30));
				Rjawangle = MathHelper.sin(f2 * 0.55F * this.wingspeed) * (float)Math.PI * 0.04F;
				
				Cheadlr = MathHelper.sin(f2 * 0.13F * this.wingspeed) * (float)Math.PI * 0.08F;
				Cheadud = (float)Math.toRadians((double)(k.getHead2Ext() - 30));
				Cjawangle = MathHelper.sin(f2 * 0.65F * this.wingspeed) * (float)Math.PI * 0.04F;
			}
			else
			{
				Lheadud = (float)Math.toRadians((double)(k.getHead1Ext() - 30));
				...
				Lheadlr = (float)Math.toRadians((double)h1);
				Cheadlr = (float)Math.toRadians((double)h2);
				Rheadlr = (float)Math.toRadians((double)h3);
				Lheadud += (float)Math.toRadians((double)d1);
				Cheadud += (float)Math.toRadians((double)d2);
				Rheadud += (float)Math.toRadians((double)d3);
				
				Ljawangle = MathHelper.sin(f2 * 0.25F * this.wingspeed) * (float)Math.PI * 0.03F;
				Rjawangle = MathHelper.sin(f2 * 0.35F * this.wingspeed) * (float)Math.PI * 0.03F;
				Cjawangle = MathHelper.sin(f2 * 0.45F * this.wingspeed) * (float)Math.PI * 0.03F;
			}
	...
	private void moveLeftHead(float Lheadlr, float Lheadud, float Ljawangle)
	{
		...
		this.NeckL2.rotationPointZ = this.NeckL1.rotationPointZ - (float)Math.cos((double)this.NeckL1.rotateAngleY) * 20.0F;
		this.NeckL2.rotationPointX = this.NeckL1.rotationPointX - (float)Math.sin((double)this.NeckL1.rotateAngleY) * 20.0F;
		this.NeckL2.rotateAngleY = Lheadlr * 0.25F;
		this.NeckL3.rotationPointZ = this.NeckL2.rotationPointZ - (float)Math.cos((double)this.NeckL2.rotateAngleY) * 36.0F;
		this.NeckL3.rotationPointX = this.NeckL2.rotationPointX - (float)Math.sin((double)this.NeckL2.rotateAngleY) * 36.0F;
		this.NeckL3.rotateAngleY = Lheadlr * 0.38F;
		this.NeckL4.rotationPointZ = this.NeckL3.rotationPointZ - (float)Math.cos((double)this.NeckL3.rotateAngleY) * 36.0F;
		this.NeckL4.rotationPointX = this.NeckL3.rotationPointX - (float)Math.sin((double)this.NeckL3.rotateAngleY) * 36.0F;
		this.NeckL4.rotateAngleY = Lheadlr * 0.5F;
		this.LHead1.rotationPointZ = this.NeckL4.rotationPointZ - (float)Math.cos((double)this.NeckL4.rotateAngleY) * 36.0F;
		this.LHead1.rotationPointX = this.NeckL4.rotationPointX - (float)Math.sin((double)this.NeckL4.rotateAngleY) * 36.0F;
		...
		this.NeckL2.rotationPointY = this.NeckL1.rotationPointY + (float)Math.sin((double)this.NeckL1.rotateAngleX) * 20.0F;
		this.NeckL2.rotationPointZ = this.NeckL1.rotationPointZ + (this.NeckL2.rotationPointZ - this.NeckL1.rotationPointZ) * (float)Math.cos((double)this.NeckL1.rotateAngleX);
		this.NeckL2.rotationPointX = this.NeckL1.rotationPointX + (this.NeckL2.rotationPointX - this.NeckL1.rotationPointX) * (float)Math.cos((double)this.NeckL1.rotateAngleX);
		this.NeckL2.rotateAngleX = Lheadud * 0.25F;
		this.NeckL3.rotationPointY = this.NeckL2.rotationPointY + (float)Math.sin((double)this.NeckL2.rotateAngleX) * 36.0F;
		this.NeckL3.rotationPointZ = this.NeckL2.rotationPointZ + (this.NeckL3.rotationPointZ - this.NeckL2.rotationPointZ) * (float)Math.cos((double)this.NeckL2.rotateAngleX);
		this.NeckL3.rotationPointX = this.NeckL2.rotationPointX + (this.NeckL3.rotationPointX - this.NeckL2.rotationPointX) * (float)Math.cos((double)this.NeckL2.rotateAngleX);
		this.NeckL3.rotateAngleX = Lheadud * 0.38F;
		this.NeckL4.rotationPointY = this.NeckL3.rotationPointY + (float)Math.sin((double)this.NeckL3.rotateAngleX) * 36.0F;
		this.NeckL4.rotationPointZ = this.NeckL3.rotationPointZ + (this.NeckL4.rotationPointZ - this.NeckL3.rotationPointZ) * (float)Math.cos((double)this.NeckL3.rotateAngleX);
		this.NeckL4.rotationPointX = this.NeckL3.rotationPointX + (this.NeckL4.rotationPointX - this.NeckL3.rotationPointX) * (float)Math.cos((double)this.NeckL3.rotateAngleX);
		this.NeckL4.rotateAngleX = Lheadud * 0.5F;
		this.LHead1.rotationPointY = this.NeckL4.rotationPointY + (float)Math.sin((double)this.NeckL4.rotateAngleX) * 36.0F;
		this.LHead1.rotationPointZ = this.NeckL4.rotationPointZ + (this.LHead1.rotationPointZ - this.NeckL4.rotationPointZ) * (float)Math.cos((double)this.NeckL4.rotateAngleX);
		this.LHead1.rotationPointX = this.NeckL4.rotationPointX + (this.LHead1.rotationPointX - this.NeckL4.rotationPointX) * (float)Math.cos((double)this.NeckL4.rotateAngleX);
		...
		this.LJaw1.rotationPointY = this.LHead1.rotationPointY + (float)Math.cos((double)this.LHead1.rotateAngleX) * 14.0F;
		this.LJaw1.rotationPointZ = this.NeckL4.rotationPointZ + -38.0F * (float)Math.cos((double)this.NeckL4.rotateAngleX);
		this.LJaw1.rotationPointZ += (float)Math.sin((double)this.LHead1.rotateAngleX) * 12.0F;
		this.LJaw1.rotationPointX = (float)((double)this.LHead1.rotationPointX - Math.sin((double)this.LHead1.rotateAngleY) * 7.0D);
	...
	private void moveCenterHead(float Cheadlr, float Cheadud, float Cjawangle)
	{
		...
		this.NeckC2.rotationPointZ = this.NeckC1.rotationPointZ - (float)Math.cos((double)this.NeckC1.rotateAngleY) * 20.0F;
		this.NeckC2.rotationPointX = this.NeckC1.rotationPointX - (float)Math.sin((double)this.NeckC1.rotateAngleY) * 20.0F;
		this.NeckC2.rotateAngleY = Cheadlr * 0.25F;
		this.NeckC3.rotationPointZ = this.NeckC2.rotationPointZ - (float)Math.cos((double)this.NeckC2.rotateAngleY) * 36.0F;
		this.NeckC3.rotationPointX = this.NeckC2.rotationPointX - (float)Math.sin((double)this.NeckC2.rotateAngleY) * 36.0F;
		this.NeckC3.rotateAngleY = Cheadlr * 0.38F;
		this.NeckC4.rotationPointZ = this.NeckC3.rotationPointZ - (float)Math.cos((double)this.NeckC3.rotateAngleY) * 36.0F;
		this.NeckC4.rotationPointX = this.NeckC3.rotationPointX - (float)Math.sin((double)this.NeckC3.rotateAngleY) * 36.0F;
		this.NeckC4.rotateAngleY = Cheadlr * 0.5F;
		this.CHead1.rotationPointZ = this.NeckC4.rotationPointZ - (float)Math.cos((double)this.NeckC4.rotateAngleY) * 36.0F;
		this.CHead1.rotationPointX = this.NeckC4.rotationPointX - (float)Math.sin((double)this.NeckC4.rotateAngleY) * 36.0F;
		...
		this.NeckC2.rotationPointY = this.NeckC1.rotationPointY + (float)Math.sin((double)this.NeckC1.rotateAngleX) * 20.0F;
		this.NeckC2.rotationPointZ = this.NeckC1.rotationPointZ + (this.NeckC2.rotationPointZ - this.NeckC1.rotationPointZ) * (float)Math.cos((double)this.NeckC1.rotateAngleX);
		this.NeckC2.rotationPointX = this.NeckC1.rotationPointX + (this.NeckC2.rotationPointX - this.NeckC1.rotationPointX) * (float)Math.cos((double)this.NeckC1.rotateAngleX);
		this.NeckC2.rotateAngleX = Cheadud * 0.25F;
		this.NeckC3.rotationPointY = this.NeckC2.rotationPointY + (float)Math.sin((double)this.NeckC2.rotateAngleX) * 36.0F;
		this.NeckC3.rotationPointZ = this.NeckC2.rotationPointZ + (this.NeckC3.rotationPointZ - this.NeckC2.rotationPointZ) * (float)Math.cos((double)this.NeckC2.rotateAngleX);
		this.NeckC3.rotationPointX = this.NeckC2.rotationPointX + (this.NeckC3.rotationPointX - this.NeckC2.rotationPointX) * (float)Math.cos((double)this.NeckC2.rotateAngleX);
		this.NeckC3.rotateAngleX = Cheadud * 0.38F;
		this.NeckC4.rotationPointY = this.NeckC3.rotationPointY + (float)Math.sin((double)this.NeckC3.rotateAngleX) * 36.0F;
		this.NeckC4.rotationPointZ = this.NeckC3.rotationPointZ + (this.NeckC4.rotationPointZ - this.NeckC3.rotationPointZ) * (float)Math.cos((double)this.NeckC3.rotateAngleX);
		this.NeckC4.rotationPointX = this.NeckC3.rotationPointX + (this.NeckC4.rotationPointX - this.NeckC3.rotationPointX) * (float)Math.cos((double)this.NeckC3.rotateAngleX);
		this.NeckC4.rotateAngleX = Cheadud * 0.5F;
		this.CHead1.rotationPointY = this.NeckC4.rotationPointY + (float)Math.sin((double)this.NeckC4.rotateAngleX) * 36.0F;
		this.CHead1.rotationPointZ = this.NeckC4.rotationPointZ + (this.CHead1.rotationPointZ - this.NeckC4.rotationPointZ) * (float)Math.cos((double)this.NeckC4.rotateAngleX);
		this.CHead1.rotationPointX = this.NeckC4.rotationPointX + (this.CHead1.rotationPointX - this.NeckC4.rotationPointX) * (float)Math.cos((double)this.NeckC4.rotateAngleX);
		...
		this.CJaw1.rotationPointY = this.CHead1.rotationPointY + (float)Math.cos((double)this.CHead1.rotateAngleX) * 14.0F;
		this.CJaw1.rotationPointZ = this.NeckC4.rotationPointZ + -38.0F * (float)Math.cos((double)this.NeckC4.rotateAngleX);
		this.CJaw1.rotationPointZ += (float)Math.sin((double)this.CHead1.rotateAngleX) * 12.0F;
		this.CJaw1.rotationPointX = (float)((double)this.CHead1.rotationPointX - Math.sin((double)this.CHead1.rotateAngleY) * 7.0D);
	...
	private void moveRightHead(float Rheadlr, float Rheadud, float Rjawangle)
	{
		...
		this.NeckR2.rotationPointZ = this.NeckR1.rotationPointZ - (float)Math.cos((double)this.NeckR1.rotateAngleY) * 20.0F;
		this.NeckR2.rotationPointX = this.NeckR1.rotationPointX - (float)Math.sin((double)this.NeckR1.rotateAngleY) * 20.0F;
		this.NeckR2.rotateAngleY = Rheadlr * 0.25F;
		this.NeckR3.rotationPointZ = this.NeckR2.rotationPointZ - (float)Math.cos((double)this.NeckR2.rotateAngleY) * 36.0F;
		this.NeckR3.rotationPointX = this.NeckR2.rotationPointX - (float)Math.sin((double)this.NeckR2.rotateAngleY) * 36.0F;
		this.NeckR3.rotateAngleY = Rheadlr * 0.38F;
		this.NeckR4.rotationPointZ = this.NeckR3.rotationPointZ - (float)Math.cos((double)this.NeckR3.rotateAngleY) * 36.0F;
		this.NeckR4.rotationPointX = this.NeckR3.rotationPointX - (float)Math.sin((double)this.NeckR3.rotateAngleY) * 36.0F;
		this.NeckR4.rotateAngleY = Rheadlr * 0.5F;
		this.RHead1.rotationPointZ = this.NeckR4.rotationPointZ - (float)Math.cos((double)this.NeckR4.rotateAngleY) * 36.0F;
		this.RHead1.rotationPointX = this.NeckR4.rotationPointX - (float)Math.sin((double)this.NeckR4.rotateAngleY) * 36.0F;
		...
		this.NeckR2.rotationPointY = this.NeckR1.rotationPointY + (float)Math.sin((double)this.NeckR1.rotateAngleX) * 20.0F;
		this.NeckR2.rotationPointZ = this.NeckR1.rotationPointZ + (this.NeckR2.rotationPointZ - this.NeckR1.rotationPointZ) * (float)Math.cos((double)this.NeckR1.rotateAngleX);
		this.NeckR2.rotationPointX = this.NeckR1.rotationPointX + (this.NeckR2.rotationPointX - this.NeckR1.rotationPointX) * (float)Math.cos((double)this.NeckR1.rotateAngleX);
		this.NeckR2.rotateAngleX = Rheadud * 0.25F;
		this.NeckR3.rotationPointY = this.NeckR2.rotationPointY + (float)Math.sin((double)this.NeckR2.rotateAngleX) * 36.0F;
		this.NeckR3.rotationPointZ = this.NeckR2.rotationPointZ + (this.NeckR3.rotationPointZ - this.NeckR2.rotationPointZ) * (float)Math.cos((double)this.NeckR2.rotateAngleX);
		this.NeckR3.rotationPointX = this.NeckR2.rotationPointX + (this.NeckR3.rotationPointX - this.NeckR2.rotationPointX) * (float)Math.cos((double)this.NeckR2.rotateAngleX);
		this.NeckR3.rotateAngleX = Rheadud * 0.38F;
		this.NeckR4.rotationPointY = this.NeckR3.rotationPointY + (float)Math.sin((double)this.NeckR3.rotateAngleX) * 36.0F;
		this.NeckR4.rotationPointZ = this.NeckR3.rotationPointZ + (this.NeckR4.rotationPointZ - this.NeckR3.rotationPointZ) * (float)Math.cos((double)this.NeckR3.rotateAngleX);
		this.NeckR4.rotationPointX = this.NeckR3.rotationPointX + (this.NeckR4.rotationPointX - this.NeckR3.rotationPointX) * (float)Math.cos((double)this.NeckR3.rotateAngleX);
		this.NeckR4.rotateAngleX = Rheadud * 0.5F;
		this.RHead1.rotationPointY = this.NeckR4.rotationPointY + (float)Math.sin((double)this.NeckR4.rotateAngleX) * 36.0F;
		this.RHead1.rotationPointZ = this.NeckR4.rotationPointZ + (this.RHead1.rotationPointZ - this.NeckR4.rotationPointZ) * (float)Math.cos((double)this.NeckR4.rotateAngleX);
		this.RHead1.rotationPointX = this.NeckR4.rotationPointX + (this.RHead1.rotationPointX - this.NeckR4.rotationPointX) * (float)Math.cos((double)this.NeckR4.rotateAngleX);
		...
		this.RJaw1.rotationPointY = this.RHead1.rotationPointY + (float)Math.cos((double)this.RHead1.rotateAngleX) * 14.0F;
		this.RJaw1.rotationPointZ = this.NeckR4.rotationPointZ + -38.0F * (float)Math.cos((double)this.NeckR4.rotateAngleX);
		this.RJaw1.rotationPointZ += (float)Math.sin((double)this.RHead1.rotateAngleX) * 12.0F;
		this.RJaw1.rotationPointX = (float)((double)this.RHead1.rotationPointX - Math.sin((double)this.RHead1.rotateAngleY) * 7.0D);
