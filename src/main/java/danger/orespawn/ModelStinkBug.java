...
public class ModelStinkBug extends ModelBase
{
	...
	public ModelStinkBug(float ff1)
	{
		...
		this.setRotation(this.b10, (-(float)Math.PI / 6F), 0.0F, 0.0F);
		...
		this.b9.mirror = true;
		this.setRotation(this.b9, ((float)Math.PI / 6F), 0.0F, 0.0F);
		...
		this.h1.mirror = true;
		this.setRotation(this.h1, ((float)Math.PI / 6F), 0.3490659F, 0.0F);
		...
		this.h2.mirror = true;
		this.setRotation(this.h2, ((float)Math.PI / 6F), -0.3490659F, 0.0F);
	...
	public void render(Entity entity, float ff, float ff1, float ff2, float ff3, float ff4, float ff5)
	{
		...
		newangle = MathHelper.sin(ff2 * 3.1F * this.wingspeed) * (float)Math.PI * 0.3F * ff1;
		
		this.f1.rotateAngleX = this.f3.rotateAngleX = this.f3.rotateAngleX = newangle;
		this.f2.rotateAngleX = this.f4.rotateAngleX = this.f6.rotateAngleX = -newangle;
		
		newangle = MathHelper.sin(ff2 * 0.4F * this.wingspeed) * (float)Math.PI * 0.2F;
		this.b9.rotateAngleZ = newangle;
		this.b10.rotateAngleZ = -newangle;
		
		newangle = MathHelper.sin(ff2 * 0.2F * this.wingspeed) * (float)Math.PI * 0.04F;
		this.jaw.rotateAngleX = 0.18F + newangle;
		
		this.h1.rotateAngleX = 0.52F + MathHelper.sin(ff2 * 0.4F * this.wingspeed) * (float)Math.PI * 0.15F;
		this.h1.rotateAngleY = -0.3F + MathHelper.sin(ff2 * 0.43F * this.wingspeed) * (float)Math.PI * 0.15F;
		this.h2.rotateAngleX = 0.52F + MathHelper.sin(ff2 * 0.46F * this.wingspeed) * (float)Math.PI * 0.15F;
		this.h2.rotateAngleY = 0.3F + MathHelper.sin(ff2 * 0.49F * this.wingspeed) * (float)Math.PI * 0.15F;
		
		this.tail.rotateAngleX = -0.2F + MathHelper.sin(ff2 * 0.1F * this.wingspeed) * (float)Math.PI * 0.1F;
		this.t1.rotateAngleX = this.t2.rotateAngleX = this.t3.rotateAngleX = this.t4.rotateAngleX = this.t5.rotateAngleX = this.tail.rotateAngleX;
		this.t6.rotateAngleX = this.t7.rotateAngleX = this.t8.rotateAngleX = this.t9.rotateAngleX = this.t10.rotateAngleX = this.tail.rotateAngleX;
		this.t11.rotateAngleX = this.t12.rotateAngleX = this.t13.rotateAngleX = this.t14.rotateAngleX = this.t15.rotateAngleX = this.tail.rotateAngleX;
		this.t16.rotateAngleX = this.t17.rotateAngleX = this.t18.rotateAngleX = this.t19.rotateAngleX = this.t20.rotateAngleX = this.tail.rotateAngleX;
