...
public class ModelCrab extends ModelBase
{
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		this.leg1.rotationPointX = this.leg2.rotationPointX = this.leg3.rotationPointX = 36.0F;
		this.leg1.rotationPointY = this.leg2.rotationPointY = this.leg3.rotationPointY = 3.0F;
		this.leg1.rotationPointZ = this.leg2.rotationPointZ = this.leg3.rotationPointZ = 0.0F;
		this.leg1.rotateAngleY = this.leg2.rotateAngleY = this.leg3.rotateAngleY = (float)((-Math.PI / 2D) + (double)(MathHelper.cos(f2 * 1.7F) * (float)Math.PI * 0.15F * f1));
		this.leg1.render(f5);
		this.leg2.render(f5);
		this.leg3.render(f5);
		
		this.leg1.rotationPointZ = this.leg2.rotationPointZ = this.leg3.rotationPointZ = 10.0F;
		this.leg1.rotateAngleY = this.leg2.rotateAngleY = this.leg3.rotateAngleY = (float)((-Math.PI / 2D) - (double)(MathHelper.cos(f2 * 1.7F) * (float)Math.PI * 0.15F * f1));
		this.leg1.render(f5);
		this.leg2.render(f5);
		this.leg3.render(f5);
		
		this.leg1.rotationPointZ = this.leg2.rotationPointZ = this.leg3.rotationPointZ = 20.0F;
		this.leg1.rotateAngleY = this.leg2.rotateAngleY = this.leg3.rotateAngleY = (float)((-Math.PI / 2D) + (double)(MathHelper.cos(f2 * 1.7F) * (float)Math.PI * 0.15F * f1));
		this.leg1.render(f5);
		this.leg2.render(f5);
		this.leg3.render(f5);
		
		this.leg1.rotationPointZ = this.leg2.rotationPointZ = this.leg3.rotationPointZ = 30.0F;
		this.leg1.rotateAngleY = this.leg2.rotateAngleY = this.leg3.rotateAngleY = (float)((-Math.PI / 2D) - (double)(MathHelper.cos(f2 * 1.7F) * (float)Math.PI * 0.15F * f1));
		this.leg1.render(f5);
		this.leg2.render(f5);
		this.leg3.render(f5);
		...
		if (e.getAttacking() == 0) {
			this.Leye1.rotateAngleX = this.Leye2.rotateAngleX = MathHelper.cos(f2 * 0.35F) * (float)Math.PI * 0.05F;
			this.Leye1.rotateAngleZ = this.Leye2.rotateAngleZ = 0.54F + MathHelper.cos(f2 * 0.25F) * (float)Math.PI * 0.05F;
			this.Reye1.rotateAngleX = this.Reye2.rotateAngleX = MathHelper.cos(f2 * 0.3F) * (float)Math.PI * 0.05F;
			this.Reye1.rotateAngleZ = this.Reye2.rotateAngleZ = -0.54F + MathHelper.cos(f2 * 0.45F) * (float)Math.PI * 0.05F;
			this.Lmouth.rotateAngleY = -0.72F + MathHelper.cos(f2 * 0.25F) * (float)Math.PI * 0.05F;
			this.Rmouth.rotateAngleY = 0.72F - MathHelper.cos(f2 * 0.25F) * (float)Math.PI * 0.05F;
			...
			this.Leye1.rotateAngleX = this.Leye2.rotateAngleX = MathHelper.cos(f2 * 0.45F) * (float)Math.PI * 0.1F;
			this.Leye1.rotateAngleZ = this.Leye2.rotateAngleZ = 0.54F + MathHelper.cos(f2 * 0.35F) * (float)Math.PI * 0.1F;
			this.Reye1.rotateAngleX = this.Reye2.rotateAngleX = MathHelper.cos(f2 * 0.4F) * (float)Math.PI * 0.1F;
			this.Reye1.rotateAngleZ = this.Reye2.rotateAngleZ = -0.54F + MathHelper.cos(f2 * 0.55F) * (float)Math.PI * 0.1F;
			this.Lmouth.rotateAngleY = -0.72F + MathHelper.cos(f2 * 0.45F) * (float)Math.PI * 0.15F;
			this.Rmouth.rotateAngleY = 0.72F - MathHelper.cos(f2 * 0.45F) * (float)Math.PI * 0.15F;
