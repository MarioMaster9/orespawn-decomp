...
public class ModelPitchBlack extends ModelBase
{
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		if (e.getActivity() != 0) {
			newangle = MathHelper.cos(f2 * 0.45F * this.wingspeed / pscale) * (float)Math.PI * 0.24F;
		} else {
			newangle = -pi4 + MathHelper.cos(f2 * 0.05F * this.wingspeed / pscale) * (float)Math.PI * 0.02F;
		}

		this.wing1.rotateAngleZ = newangle;
		this.mem1.rotateAngleZ = newangle;
		this.wing2.rotateAngleZ = newangle * 5.0F / 3.0F;
		this.wing2.rotationPointY = this.wing1.rotationPointY + (float)Math.sin((double)this.wing1.rotateAngleZ) * 21.0F;
		this.wing2.rotationPointX = this.wing1.rotationPointX + (float)Math.cos((double)this.wing1.rotateAngleZ) * 21.0F;
		...
		this.wing3.rotationPointY = this.wing2.rotationPointY + (float)Math.sin((double)this.wing2.rotateAngleZ) * 43.0F;
		this.wing3.rotationPointX = this.wing2.rotationPointX + (float)Math.cos((double)this.wing2.rotateAngleZ) * 43.0F;
		...
		this.wingclaw1.rotateAngleZ = this.wingclaw2.rotateAngleZ = this.wingclaw3.rotateAngleZ = newangle * 3.0F / 2.0F;
		this.wingclaw1.rotationPointY = this.wingclaw2.rotationPointY = this.wingclaw3.rotationPointY = this.wing3.rotationPointY;
		this.wingclaw1.rotationPointX = this.wingclaw2.rotationPointX = this.wingclaw3.rotationPointX = this.wing3.rotationPointX;
		
		this.rwing1.rotateAngleZ = -newangle;
		this.rmem1.rotateAngleZ = -newangle;
		this.rwing2.rotateAngleZ = -newangle * 5.0F / 3.0F;
		this.rwing2.rotationPointY = this.rwing1.rotationPointY - (float)Math.sin((double)this.rwing1.rotateAngleZ) * 21.0F;
		this.rwing2.rotationPointX = this.rwing1.rotationPointX - (float)Math.cos((double)this.rwing1.rotateAngleZ) * 21.0F;
		...
		this.rwing3.rotationPointY = this.rwing2.rotationPointY - (float)Math.sin((double)this.rwing2.rotateAngleZ) * 43.0F;
		this.rwing3.rotationPointX = this.rwing2.rotationPointX - (float)Math.cos((double)this.rwing2.rotateAngleZ) * 43.0F;
		...
		this.rwingclaw1.rotateAngleZ = this.rwingclaw2.rotateAngleZ = this.rwingclaw3.rotateAngleZ = -newangle * 3.0F / 2.0F;
		this.rwingclaw1.rotationPointY = this.rwingclaw2.rotationPointY = this.rwingclaw3.rotationPointY = this.rwing3.rotationPointY;
		this.rwingclaw1.rotationPointX = this.rwingclaw2.rotationPointX = this.rwingclaw3.rotationPointX = this.rwing3.rotationPointX;
		...
		this.neck3.rotateAngleY = (float)Math.toRadians((double)f3) * 0.5F;
		this.head1.rotateAngleY = this.head2.rotateAngleY = this.head3.rotateAngleY = this.head4.rotateAngleY = (float)Math.toRadians((double)f3);
		this.head5.rotateAngleY = this.head6.rotateAngleY = this.head7.rotateAngleY = this.head1.rotateAngleY;
		this.jaw1.rotateAngleY = this.jaw2.rotateAngleY = this.jaw3.rotateAngleY = this.jaw4.rotateAngleY = this.jaw5.rotateAngleY = this.head1.rotateAngleY;
		this.tooth1.rotateAngleY = this.tooth2.rotateAngleY = this.tooth3.rotateAngleY = this.tooth4.rotateAngleY = this.tooth5.rotateAngleY = this.head1.rotateAngleY;
		this.tooth6.rotateAngleY = this.tooth7.rotateAngleY = this.tooth8.rotateAngleY = this.tooth9.rotateAngleY = this.tooth10.rotateAngleY = this.head1.rotateAngleY;
		this.tooth11.rotateAngleY = this.tooth12.rotateAngleY = this.tooth13.rotateAngleY = this.tooth14.rotateAngleY = this.tooth15.rotateAngleY = this.head1.rotateAngleY;
		this.tooth16.rotateAngleY = this.tooth17.rotateAngleY = this.tooth18.rotateAngleY = this.tooth19.rotateAngleY = this.tooth20.rotateAngleY = this.head1.rotateAngleY;
		this.tooth21.rotateAngleY = this.tooth22.rotateAngleY = this.tooth23.rotateAngleY = this.head1.rotateAngleY;
		...
		this.jaw1.rotateAngleX = this.jaw2.rotateAngleX = this.jaw3.rotateAngleX = this.jaw4.rotateAngleX = this.jaw5.rotateAngleX = newangle;
		...
		if (e.getActivity() == 0)
		{
			...
			this.leftleg1.rotationPointY = this.leftleg2.rotationPointY = this.leftleg3.rotationPointY - (float)Math.cos((double)this.leftleg3.rotateAngleX) * 17.0F + t2 / 2.0F;
			...
			this.rightleg1.rotationPointY = this.rightleg2.rotationPointY = this.rightleg3.rotationPointY - (float)Math.cos((double)this.rightleg3.rotateAngleX) * 17.0F + t2 / 2.0F;
		...
		else
		{
			...
			this.lclaw2.rotationPointZ = this.lclaw3.rotationPointZ = this.lclaw4.rotationPointZ = this.lclaw5.rotationPointZ = this.lclaw6.rotationPointZ = this.lclaw7.rotationPointZ = this.lclaw1.rotationPointZ;
			this.lclaw2.rotationPointY = this.lclaw3.rotationPointY = this.lclaw4.rotationPointY = this.lclaw5.rotationPointY = this.lclaw6.rotationPointY = this.lclaw7.rotationPointY = this.lclaw1.rotationPointY;
			this.lclaw2.rotateAngleX = this.lclaw3.rotateAngleX = this.lclaw4.rotateAngleX = this.lclaw5.rotateAngleX = this.lclaw6.rotateAngleX = this.lclaw7.rotateAngleX = this.lclaw1.rotateAngleX;
			...
			this.rclaw2.rotationPointZ = this.rclaw3.rotationPointZ = this.rclaw4.rotationPointZ = this.rclaw5.rotationPointZ = this.rclaw6.rotationPointZ = this.rclaw7.rotationPointZ = this.rclaw1.rotationPointZ;
			this.rclaw2.rotationPointY = this.rclaw3.rotationPointY = this.rclaw4.rotationPointY = this.rclaw5.rotationPointY = this.rclaw6.rotationPointY = this.rclaw7.rotationPointY = this.rclaw1.rotationPointY;
			this.rclaw2.rotateAngleX = this.rclaw3.rotateAngleX = this.rclaw4.rotateAngleX = this.rclaw5.rotateAngleX = this.rclaw6.rotateAngleX = this.rclaw7.rotateAngleX = this.rclaw1.rotateAngleX;
		...
		this.tail2.rotationPointX = this.tail1.rotationPointX - 1.0F + (float)Math.sin((double)this.tail1.rotateAngleY) * 11.0F;
		...
		this.tail6.rotationPointZ = this.tail5.rotationPointZ + (float)Math.cos((double)this.tail5.rotateAngleY) * 9.0F;
		this.tail6.rotationPointX = this.tail5.rotationPointX + (float)Math.sin((double)this.tail5.rotateAngleY) * 9.0F;
		...
		this.tail9.rotationPointZ = this.tail6.rotationPointZ + (float)Math.cos((double)this.tail6.rotateAngleY) * 9.0F;
		this.tail9.rotationPointX = this.tail6.rotationPointX + (float)Math.sin((double)this.tail6.rotateAngleY) * 9.0F;
		...
		this.tailpoint1.rotationPointZ = this.tail9.rotationPointZ + (float)Math.cos((double)this.tail9.rotateAngleY) * 9.0F;
		this.tailpoint1.rotationPointX = this.tail9.rotationPointX + (float)Math.sin((double)this.tail9.rotateAngleY) * 9.0F;
		...
		this.tail7.rotationPointZ = this.tail5.rotationPointZ + (float)Math.cos((double)this.tail5.rotateAngleY) * 9.0F;
		this.tail7.rotationPointX = this.tail5.rotationPointX + (float)Math.sin((double)this.tail5.rotateAngleY) * 9.0F;
		...
		this.tail8.rotationPointZ = this.tail7.rotationPointZ + (float)Math.cos((double)this.tail7.rotateAngleY) * 9.0F;
		this.tail8.rotationPointX = this.tail7.rotationPointX + (float)Math.sin((double)this.tail7.rotateAngleY) * 9.0F;
		...
		this.tailpoint2.rotationPointZ = this.tail8.rotationPointZ + (float)Math.cos((double)this.tail8.rotateAngleY) * 9.0F;
		this.tailpoint2.rotationPointX = this.tail8.rotationPointX + (float)Math.sin((double)this.tail8.rotateAngleY) * 9.0F;
