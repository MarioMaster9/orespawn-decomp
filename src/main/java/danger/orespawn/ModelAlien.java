...
public class ModelAlien extends ModelBase
{
	...
	public ModelAlien(float f1)
	{
		...
		this.setRotation(this.fanl2, 0.0F, 0.0F, ((float)Math.PI / 6F));
		...
		this.setRotation(this.fanr2, 0.0F, 0.0F, (-(float)Math.PI / 6F));
		...
		this.setRotation(this.fanl3, 0.0F, 0.0F, ((float)Math.PI / 4F));
		...
		this.setRotation(this.fanr3, 0.0F, 0.0F, (-(float)Math.PI / 4F));
		...
		this.setRotation(this.spike4, -0.0523599F, ((float)Math.PI / 6F), 0.0F);
		...
		this.setRotation(this.arml1, 0.0F, (-(float)Math.PI / 6F), 0.1745329F);
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		newangle = MathHelper.cos(f2 * 4.0F * this.wingspeed) * (float)Math.PI * 0.5F * f1;
		...
		if (e.getAttacking() == 0) {
			...
			float pi6 = ((float)Math.PI / 6F);
			float fanspeed = 1.22F;
			float fanamp = 0.1F;
			
			this.fan.rotateAngleX = MathHelper.cos(f2 * fanspeed * this.wingspeed) * (float)Math.PI * fanamp;
			this.fanl1.rotateAngleX = MathHelper.cos(f2 * fanspeed * this.wingspeed - 1.0F * pi6) * (float)Math.PI * fanamp;
			this.fanl2.rotateAngleX = MathHelper.cos(f2 * fanspeed * this.wingspeed - 2.0F * pi6) * (float)Math.PI * fanamp;
			this.fanl3.rotateAngleX = MathHelper.cos(f2 * fanspeed * this.wingspeed - 3.0F * pi6) * (float)Math.PI * fanamp;
			this.fanl4.rotateAngleX = MathHelper.cos(f2 * fanspeed * this.wingspeed - 4.0F * pi6) * (float)Math.PI * fanamp;
			this.fanl5.rotateAngleX = MathHelper.cos(f2 * fanspeed * this.wingspeed - 5.0F * pi6) * (float)Math.PI * fanamp;
			this.fanl6.rotateAngleX = MathHelper.cos(f2 * fanspeed * this.wingspeed - 6.0F * pi6) * (float)Math.PI * fanamp;
			this.fanl7.rotateAngleX = MathHelper.cos(f2 * fanspeed * this.wingspeed - 7.0F * pi6) * (float)Math.PI * fanamp;
			this.fanr1.rotateAngleX = MathHelper.cos(f2 * fanspeed * this.wingspeed - 1.0F * pi6) * (float)Math.PI * fanamp;
			this.fanr2.rotateAngleX = MathHelper.cos(f2 * fanspeed * this.wingspeed - 2.0F * pi6) * (float)Math.PI * fanamp;
			this.fanr3.rotateAngleX = MathHelper.cos(f2 * fanspeed * this.wingspeed - 3.0F * pi6) * (float)Math.PI * fanamp;
			this.fanr4.rotateAngleX = MathHelper.cos(f2 * fanspeed * this.wingspeed - 4.0F * pi6) * (float)Math.PI * fanamp;
			this.fanr5.rotateAngleX = MathHelper.cos(f2 * fanspeed * this.wingspeed - 5.0F * pi6) * (float)Math.PI * fanamp;
			this.fanr6.rotateAngleX = MathHelper.cos(f2 * fanspeed * this.wingspeed - 6.0F * pi6) * (float)Math.PI * fanamp;
			this.fanr7.rotateAngleX = MathHelper.cos(f2 * fanspeed * this.wingspeed - 7.0F * pi6) * (float)Math.PI * fanamp;
		...
		this.neck.rotateAngleY = (float)Math.toRadians((double)f3) * 0.35F;
		
		this.head.rotateAngleY = (float)Math.toRadians((double)f3) * 0.75F;
		this.head.rotationPointZ = this.neck.rotationPointZ - (float)Math.cos((double)this.neck.rotateAngleY) * 3.0F;
		this.head.rotationPointX = this.neck.rotationPointX + (float)Math.sin((double)this.neck.rotateAngleY) * 3.0F;
		...
		this.jaw1.rotationPointZ = this.head.rotationPointZ - (float)Math.cos((double)this.head.rotateAngleY) * 8.0F;
		this.jaw1.rotationPointX = this.head.rotationPointX - (float)Math.sin((double)this.head.rotateAngleY) * 8.0F;
		...
		newangle = MathHelper.cos(f2 * 3.5F * this.wingspeed) * (float)Math.PI * 0.5F;
		nextangle = MathHelper.cos((f2 + 0.2F) * 3.5F * this.wingspeed) * (float)Math.PI * 0.5F;
		...
		if (r.ri2 == 1) {
			...
			newangle = MathHelper.cos(f2 * this.wingspeed) * (float)Math.PI * 0.05F;
			this.doTail(newangle);
		}

		
		if (r.ri3 == 1) {
			newangle = MathHelper.cos(f2 * 3.5F * this.wingspeed) * (float)Math.PI * 0.35F;
			this.doJaw(newangle);
		} else {
			newangle = MathHelper.cos(f2 * this.wingspeed) * (float)Math.PI * 0.02F;
			this.doJaw(newangle);
		}

		
		newangle = MathHelper.cos(f2 * this.wingspeed * 3.5F) * (float)Math.PI * 0.2F;
		if (r.ri1 == 1 || r.ri1 == 3) {
			this.doLeftClaw(newangle);
		} else {
			newangle = MathHelper.cos(f2 * this.wingspeed) * (float)Math.PI * 0.03F;
			this.doLeftClaw(newangle);
		}
		if (r.ri1 == 2 || r.ri1 == 3) {
	...
	private void doLeftClaw(float angle)
	{
		...
		this.arml2.rotationPointZ = this.arml1.rotationPointZ - (float)Math.sin((double)this.arml1.rotateAngleY) * 9.0F;
		this.arml2.rotationPointX = this.arml1.rotationPointX + (float)Math.cos((double)this.arml1.rotateAngleY) * 9.0F;
		this.arml2.rotateAngleY = 0.855F + Math.abs(angle);
		this.clawl1.rotationPointZ = this.arml2.rotationPointZ - (float)Math.sin((double)this.arml2.rotateAngleY) * 14.0F;
		this.clawl1.rotationPointX = this.arml2.rotationPointX + (float)Math.cos((double)this.arml2.rotateAngleY) * 14.0F;
	...
	private void doRightClaw(float angle)
	{
		...
		this.armr2.rotationPointZ = this.armr1.rotationPointZ - (float)Math.sin((double)this.armr1.rotateAngleY) * 9.0F;
		this.armr2.rotationPointX = this.armr1.rotationPointX + (float)Math.cos((double)this.armr1.rotateAngleY) * 9.0F;
		this.armr2.rotateAngleY = 2.27F - Math.abs(angle);
		this.clawr1.rotationPointZ = this.armr2.rotationPointZ - (float)Math.sin((double)this.armr2.rotateAngleY) * 14.0F;
		this.clawr1.rotationPointX = this.armr2.rotationPointX + (float)Math.cos((double)this.armr2.rotateAngleY) * 14.0F;
