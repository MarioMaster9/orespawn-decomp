...
public class ModelEnderKnight extends ModelBase
{
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		newangle = MathHelper.cos(f2 * 2.7F * this.wingspeed) * (float)Math.PI * 0.3F;
		if (e.isScreaming()) {
			...
			this.blade.rotateAngleX = this.handle.rotateAngleX = 0.35F;
		}
		this.larm1.rotationPointY = (float)((double)this.larm2.rotationPointY + Math.cos((double)this.larm2.rotateAngleX) * 10.0D);
		this.larm1.rotationPointZ = (float)((double)this.larm2.rotationPointZ + Math.sin((double)this.larm2.rotateAngleX) * 10.0D);
		this.rarm1.rotationPointY = (float)((double)this.rarm2.rotationPointY + Math.cos((double)this.rarm2.rotateAngleX) * 10.0D);
		this.rarm1.rotationPointZ = (float)((double)this.rarm2.rotationPointZ + Math.sin((double)this.rarm2.rotateAngleX) * 10.0D);
		this.blade.rotationPointY = this.handle.rotationPointY = (float)((double)this.rarm1.rotationPointY + Math.cos((double)this.rarm1.rotateAngleX) * 7.0D) + 1.0F;
		this.blade.rotationPointZ = this.handle.rotationPointZ = (float)((double)this.rarm1.rotationPointZ + Math.sin((double)this.rarm1.rotateAngleX) * 7.0D);
