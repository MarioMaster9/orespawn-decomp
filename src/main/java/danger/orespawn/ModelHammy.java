...
public class ModelHammy extends ModelBase
{
	...
	public ModelHammy()
	{
		...
		this.setRotation(this.Head3, ((float)Math.PI / 4F), 0.0F, 0.0F);
		...
		this.setRotation(this.Head4, (-(float)Math.PI / 4F), 0.0F, 0.0F);
		...
		this.setRotation(this.Band3, ((float)Math.PI / 4F), 0.0F, 0.0F);
		...
		this.setRotation(this.Band4, (-(float)Math.PI / 4F), 0.0F, 0.0F);
		...
		this.setRotation(this.Band6, (-(float)Math.PI / 4F), 0.0F, 0.0F);
		...
		this.setRotation(this.Band7, ((float)Math.PI / 4F), 0.0F, 0.0F);
		...
		this.setRotation(this.Point1, 0.0F, 0.0F, ((float)Math.PI / 4F));
		...
		this.setRotation(this.Spike3, ((float)Math.PI / 4F), 0.0F, 0.0F);
		...
		this.setRotation(this.Spike4, (-(float)Math.PI / 4F), 0.0F, 0.0F);
		...
		this.setRotation(this.Band3b, ((float)Math.PI / 4F), 0.0F, 0.0F);
		...
		this.setRotation(this.Band4b, (-(float)Math.PI / 4F), 0.0F, 0.0F);
		...
		this.setRotation(this.Band6b, (-(float)Math.PI / 4F), 0.0F, 0.0F);
		...
		this.setRotation(this.Band7b, ((float)Math.PI / 4F), 0.0F, 0.0F);
		...
		this.setRotation(this.Point1b, 0.0F, 0.0F, ((float)Math.PI / 4F));
		...
		this.setRotation(this.Spike3b, ((float)Math.PI / 4F), 0.0F, 0.0F);
		...
		this.setRotation(this.Spike4b, (-(float)Math.PI / 4F), 0.0F, 0.0F);
	}
