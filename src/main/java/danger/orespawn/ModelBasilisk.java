...
public class ModelBasilisk extends ModelBase
{
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		if ((double)f1 > 0.1) {
			newangle = MathHelper.cos(f2 * 1.3F * this.wingspeed) * (float)Math.PI * 0.1F * f1;
		} else {
			newangle = 0.0F;
		}
		...
		this.body1.rotateAngleY = MathHelper.cos(f2 * 1.3F * this.wingspeed) * (float)Math.PI * 0.1F * f1;
		this.body2.rotationPointZ = this.body1.rotationPointZ + (float)Math.cos((double)this.body1.rotateAngleY) * 12.0F;
		this.body2.rotationPointX = this.body1.rotationPointX + (float)Math.sin((double)this.body1.rotateAngleY) * 12.0F;
		this.body2.rotateAngleY = MathHelper.cos(f2 * 1.3F * this.wingspeed - pi4) * (float)Math.PI * 0.1F * f1;
		this.body3.rotationPointZ = this.body2.rotationPointZ + (float)Math.cos((double)this.body2.rotateAngleY) * 11.0F;
		this.body3.rotationPointX = this.body2.rotationPointX + (float)Math.sin((double)this.body2.rotateAngleY) * 11.0F;
		this.body3.rotateAngleY = MathHelper.cos(f2 * 1.3F * this.wingspeed - 2.0F * pi4) * (float)Math.PI * 0.1F * f1;
		this.body4.rotationPointZ = this.body3.rotationPointZ + (float)Math.cos((double)this.body3.rotateAngleY) * 12.0F;
		this.body4.rotationPointX = this.body3.rotationPointX + (float)Math.sin((double)this.body3.rotateAngleY) * 12.0F;
		this.body4.rotateAngleY = MathHelper.cos(f2 * 1.3F * this.wingspeed - 3.0F * pi4) * (float)Math.PI * 0.1F * f1;
		this.body5.rotationPointZ = this.body4.rotationPointZ + (float)Math.cos((double)this.body4.rotateAngleY) * 12.0F;
		this.body5.rotationPointX = this.body4.rotationPointX + (float)Math.sin((double)this.body4.rotateAngleY) * 12.0F;
		this.body5.rotateAngleY = MathHelper.cos(f2 * 1.3F * this.wingspeed - 4.0F * pi4) * (float)Math.PI * 0.1F * f1;
		this.body6.rotationPointZ = this.body5.rotationPointZ + (float)Math.cos((double)this.body5.rotateAngleY) * 12.0F;
		this.body6.rotationPointX = this.body5.rotationPointX + 0.5F + (float)Math.sin((double)this.body5.rotateAngleY) * 12.0F;
		
		
		
		this.body6.rotateAngleY = MathHelper.cos(f2 * 1.3F * this.wingspeed - 5.0F * pi4) * (float)Math.PI * 0.1F * f1;
		...
		this.tail1.rotationPointZ = this.body6.rotationPointZ + (float)Math.cos((double)this.body6.rotateAngleY) * 12.0F;
		this.tail1.rotationPointX = this.body6.rotationPointX + 1.0F + (float)Math.sin((double)this.body6.rotateAngleY) * 12.0F;
		this.tail1.rotateAngleY = MathHelper.cos(f2 * 1.3F * this.wingspeed - 6.0F * pi4) * (float)Math.PI * 0.1F * f1;
		this.tail2.rotationPointZ = this.tail1.rotationPointZ + (float)Math.cos((double)this.tail1.rotateAngleY) * 10.0F;
		this.tail2.rotationPointX = this.tail1.rotationPointX + 1.5F + (float)Math.sin((double)this.tail1.rotateAngleY) * 10.0F;
		this.tail2.rotateAngleY = MathHelper.cos(f2 * 1.3F * this.wingspeed - 7.0F * pi4) * (float)Math.PI * 0.1F * f1;
		this.tail3.rotationPointZ = this.tail2.rotationPointZ + (float)Math.cos((double)this.tail2.rotateAngleY) * 10.0F;
		this.tail3.rotationPointX = this.tail2.rotationPointX + 1.0F + (float)Math.sin((double)this.tail2.rotateAngleY) * 10.0F;
		this.tail3.rotateAngleY = MathHelper.cos(f2 * 1.3F * this.wingspeed - 8.0F * pi4) * (float)Math.PI * 0.1F * f1;
		this.tail4.rotationPointZ = this.tail3.rotationPointZ + (float)Math.cos((double)this.tail3.rotateAngleY) * 10.0F;
		this.tail4.rotationPointX = this.tail3.rotationPointX + 1.0F + (float)Math.sin((double)this.tail3.rotateAngleY) * 10.0F;
		this.tail4.rotateAngleY = MathHelper.cos(f2 * 1.3F * this.wingspeed - 9.0F * pi4) * (float)Math.PI * 0.1F * f1;
		
		if (e.getAttacking() != 0) {
			this.jaw.rotateAngleX = -1.0F + MathHelper.cos(f2 * 0.45F) * (float)Math.PI * 0.18F;
		} else {
