...
public class ThePrinceTeen extends EntityTameable {
	...
	public String getLivingSound() {
		if (this.isSitting()) {
			...
			return this.getActivity() == 1 && this.riddenByEntity == null ? "orespawn:roar" : null;
		}
	}
	...
	public boolean attackEntityFrom(DamageSource par1DamageSource, float par2) {
		...
		if (this.hurt_timer > 0) {
			...
			if (e != null && e instanceof BetterFireball) {
				...
				e.setDead();
				return ret;
			} else if (e != null && e instanceof ThePrinceTeen) {
				return false;
				...
				if (!this.worldObj.isRemote) {
					if (this.worldObj.rand.nextInt(5) == 1 && this.worldObj.difficultySetting != EnumDifficulty.PEACEFUL) {
						...
						if (e != null) {
							...
							} else if (this.getDistanceSqToEntity(e) > (double)100.0F && this.getDistanceSqToEntity(e) < (double)625.0F && !this.isInWater() && this.getThePrinceTeenFire() != 0) {
					...
					if (e != null) {
						if (this.isTamed() && this.getHealth() / (float)this.mygetMaxHealth() < 0.25F) {
							...
							if (this.getDistanceSqToEntity(e) < (double)((8.0F + e.width / 2.0F) * (8.0F + e.width / 2.0F))) {
								...
								do_new = 1;
							} else if (this.getDistanceSqToEntity(e) < (double)400.0F && !this.isInWater() && this.getThePrinceTeenFire() != 0 && this.worldObj.rand.nextInt(2) == 1) {
								this.shoot_something(e.posX, e.posY, e.posZ);
							}
						}
					} else {
			...
			if (this.worldObj.isRemote) {
				...
				if (this.getActivity() != 0) {
					...
					if (this.riddenByEntity == null) {
						...
						this.motionZ *= 0.985;
						if (!this.worldObj.isRemote) {
							list = this.worldObj.getEntitiesWithinAABBExcludingEntity(this, this.boundingBox.expand((double)3.25F, 4.0D, (double)3.25F));
	...
	public boolean interact(EntityPlayer par1EntityPlayer) {
		...
		if (var2 != null && var2.getItem() == Item.getItemFromBlock(Blocks.diamond_block) && par1EntityPlayer.getDistanceSqToEntity(this) < 25.0D) {
			if (!this.worldObj.isRemote) {
				this.setTamed(true);
