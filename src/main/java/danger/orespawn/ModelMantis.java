...
public class ModelMantis extends ModelBase
{
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		newangle = MathHelper.cos(f2 * 0.9F * this.wingspeed) * (float)Math.PI * 0.25F;
		this.lfwing.rotateAngleZ = -0.698F - newangle;
		this.rfwing.rotateAngleZ = 0.698F + newangle;
		newangle = MathHelper.cos(f2 * 0.9F * this.wingspeed) * (float)Math.PI * 0.35F;
		this.lrwing.rotateAngleZ = -0.349F + newangle;
		this.rrwing.rotateAngleZ = 0.349F - newangle;

		
		if (b.getAttacking() == 0) {
			newangle = MathHelper.cos(f2 * 0.051F * this.wingspeed) * (float)Math.PI * 0.013F;
			a1 = -0.2F;
		} else {
			newangle = MathHelper.cos(f2 * 0.51F * this.wingspeed) * (float)Math.PI * 0.25F;
			a1 = -0.698F;
		}
		this.larm1.rotateAngleX = a1 + newangle;
		this.larm2.rotationPointZ = (float)((double)(this.larm1.rotationPointZ + 1.0F) + Math.sin((double)this.larm1.rotateAngleX) * (double)22.0F);
		this.larm2.rotationPointY = (float)((double)this.larm1.rotationPointY + Math.cos((double)this.larm1.rotateAngleX) * (double)22.0F);
		this.larm2.rotateAngleX = -a1 - newangle;
		this.larm3.rotationPointZ = (float)((double)(this.larm2.rotationPointZ + 1.0F) - Math.sin((double)this.larm2.rotateAngleX) * 17.0D);
		this.larm3.rotationPointY = (float)((double)this.larm2.rotationPointY - Math.cos((double)this.larm2.rotateAngleX) * 17.0D);
		this.larm3.rotateAngleX = a1 + newangle;
		
		this.rarm1.rotateAngleX = a1 - newangle;
		this.rarm2.rotationPointZ = (float)((double)(this.rarm1.rotationPointZ + 1.0F) + Math.sin((double)this.rarm1.rotateAngleX) * (double)22.0F);
		this.rarm2.rotationPointY = (float)((double)this.rarm1.rotationPointY + Math.cos((double)this.rarm1.rotateAngleX) * (double)22.0F);
		this.rarm2.rotateAngleX = -a1 + newangle;
		this.rarm3.rotationPointZ = (float)((double)(this.rarm2.rotationPointZ + 1.0F) - Math.sin((double)this.rarm2.rotateAngleX) * 17.0D);
		this.rarm3.rotationPointY = (float)((double)this.rarm2.rotationPointY - Math.cos((double)this.rarm2.rotateAngleX) * 17.0D);
