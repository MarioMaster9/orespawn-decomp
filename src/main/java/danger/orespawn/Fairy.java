...
public class Fairy extends EntityAmbientCreature
{
	...
	public Fairy(World par1World) {
		...
		if (par1World != null) this.fairy_type = par1World.rand.nextInt(9);
	...
	public ResourceLocation getTexture(Fairy a) {
		if (this.fairy_type == 8) return texture8;
		if (this.fairy_type == 7) return texture7;
		if (this.fairy_type == 6) return texture6;
		if (this.fairy_type == 5) return texture5;
		if (this.fairy_type == 4) return texture4;
		if (this.fairy_type == 3) return texture3;
		if (this.fairy_type == 2) return texture2;
		if (this.fairy_type == 1) return texture1;
		return texture0;
	}
