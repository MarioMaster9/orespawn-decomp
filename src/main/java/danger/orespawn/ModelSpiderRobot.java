...
public class ModelSpiderRobot extends ModelBase
{
	...
	public ModelSpiderRobot(float f1)
	{
		...
		this.setRotation(this.Leg1p1, ((float)Math.PI / 4F), 0.0F, 0.0F);
		...
		this.setRotation(this.Foot, (-(float)Math.PI / 4F), 0.0F, 0.0F);
		...
		this.setRotation(this.FootSpike1, (-(float)Math.PI / 4F), 0.0F, 0.0F);
		...
		this.setRotation(this.FootSpike2, (-(float)Math.PI / 4F), 0.0F, 0.0F);
		...
		this.setRotation(this.FootSpike3, (-(float)Math.PI / 4F), 0.0F, 0.0F);
		...
		this.setRotation(this.FootSpike4, (-(float)Math.PI / 4F), 0.0F, 0.0F);
		...
		this.setRotation(this.AnkleSpike1, (-(float)Math.PI / 4F), 0.0F, 0.0F);
		...
		this.setRotation(this.AnkleSpike2, (-(float)Math.PI / 4F), 0.0F, 0.0F);
		...
		this.setRotation(this.AnkleSpike3, (-(float)Math.PI / 4F), 0.0F, 0.0F);
		...
		this.setRotation(this.AnkleSpike4, (-(float)Math.PI / 4F), 0.0F, 0.0F);
		...
		this.setRotation(this.LowerKnee, (-(float)Math.PI / 4F), 0.0F, 0.0F);
		...
		this.setRotation(this.LegBump1, (-(float)Math.PI / 4F), 0.0F, 0.0F);
		...
		this.setRotation(this.LegBump2, (-(float)Math.PI / 4F), 0.0F, 0.0F);
		...
		this.setRotation(this.UpperKnee2, ((float)Math.PI / 4F), 0.0F, 0.0F);
		...
		this.setRotation(this.HipJoint, ((float)Math.PI / 4F), 0.0F, 0.0F);
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		for (i = 0; i < 8; i++)
		{
			this.Leg1p1.rotateAngleY = this.Leg1p2.rotateAngleY = this.Leg1p3.rotateAngleY = r.ydisplayangle[i];
			...
			this.Leg1p1.rotationPointX = -((float)Math.cos((double)r.ymid[i])) * r.legoff[i] * 16.0F;
			this.Leg1p1.rotationPointZ = (float)Math.sin((double)r.ymid[i]) * r.legoff[i] * 16.0F;
			...
			this.Leg1p2.rotationPointY = this.Leg1p1.rotationPointY - (float)Math.sin((double)this.Leg1p1.rotateAngleX) * 99.0F;
			this.Leg1p2.rotationPointZ = this.Leg1p1.rotationPointZ + (float)Math.cos((double)this.Leg1p1.rotateAngleX) * (float)Math.cos((double)this.Leg1p1.rotateAngleY) * 99.0F;
			this.Leg1p2.rotationPointX = this.Leg1p1.rotationPointX + (float)Math.cos((double)this.Leg1p1.rotateAngleX) * (float)Math.sin((double)this.Leg1p1.rotateAngleY) * 99.0F;
			...
			this.Leg1p3.rotationPointY = this.Leg1p2.rotationPointY - (float)Math.sin((double)this.Leg1p2.rotateAngleX) * 99.0F;
			this.Leg1p3.rotationPointZ = this.Leg1p2.rotationPointZ + (float)Math.cos((double)this.Leg1p2.rotateAngleX) * (float)Math.cos((double)this.Leg1p2.rotateAngleY) * 99.0F;
			this.Leg1p3.rotationPointX = this.Leg1p2.rotationPointX + (float)Math.cos((double)this.Leg1p2.rotateAngleX) * (float)Math.sin((double)this.Leg1p2.rotateAngleY) * 99.0F;
