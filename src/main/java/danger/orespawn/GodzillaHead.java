		...
		if (!this.isDead) {
			...
			if (this.worldObj.isRemote) {
				...
				if (var2.hasNext()) {
					...
					this.posX = var4.posX - 17.0D * Math.sin(Math.toRadians((double)var4.rotationYawHead));
					this.posZ = var4.posZ + 17.0D * Math.cos(Math.toRadians((double)var4.rotationYawHead));
