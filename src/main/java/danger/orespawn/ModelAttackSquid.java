...
public class ModelAttackSquid extends ModelBase
{
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		if ((double)f1 > 0.1) {
			newangleA = MathHelper.cos(f2 * 0.25F * this.wingspeed) * (float)Math.PI * 0.04F * f1;
			newangleB = MathHelper.cos(f2 * 0.39F * this.wingspeed) * (float)Math.PI * 0.04F * f1;
			newangle1 = MathHelper.cos(f2 * 1.2F * this.wingspeed) * (float)Math.PI * 0.4F * f1;
			newangle2 = MathHelper.cos(f2 * 1.1F * this.wingspeed) * (float)Math.PI * 0.4F * f1;
			newangle3 = MathHelper.cos(f2 * 1.0F * this.wingspeed) * (float)Math.PI * 0.4F * f1;
			newangle4 = MathHelper.cos(f2 * 1.9F * this.wingspeed) * (float)Math.PI * 0.4F * f1;
			newangle5 = MathHelper.cos(f2 * 1.8F * this.wingspeed) * (float)Math.PI * 0.4F * f1;
			newangle6 = MathHelper.cos(f2 * 1.7F * this.wingspeed) * (float)Math.PI * 0.4F * f1;
			newangle7 = MathHelper.cos(f2 * 1.6F * this.wingspeed) * (float)Math.PI * 0.4F * f1;
			newangle8 = MathHelper.cos(f2 * 1.5F * this.wingspeed) * (float)Math.PI * 0.4F * f1;
		} else {
			newangleA = MathHelper.cos(f2 * 0.25F * this.wingspeed) * (float)Math.PI * 0.01F;
			newangleB = MathHelper.cos(f2 * 0.39F * this.wingspeed) * (float)Math.PI * 0.01F;
			newangle1 = MathHelper.cos(f2 * 1.2F * this.wingspeed) * (float)Math.PI * 0.1F;
			newangle2 = MathHelper.cos(f2 * 1.1F * this.wingspeed) * (float)Math.PI * 0.1F;
			newangle3 = MathHelper.cos(f2 * 1.0F * this.wingspeed) * (float)Math.PI * 0.1F;
			newangle4 = MathHelper.cos(f2 * 1.9F * this.wingspeed) * (float)Math.PI * 0.1F;
			newangle5 = MathHelper.cos(f2 * 1.8F * this.wingspeed) * (float)Math.PI * 0.1F;
			newangle6 = MathHelper.cos(f2 * 1.7F * this.wingspeed) * (float)Math.PI * 0.1F;
			newangle7 = MathHelper.cos(f2 * 1.6F * this.wingspeed) * (float)Math.PI * 0.1F;
			newangle8 = MathHelper.cos(f2 * 1.5F * this.wingspeed) * (float)Math.PI * 0.1F;
		}
		...
		newangleA = (float)Math.toRadians((double)f3) * 0.75F;
