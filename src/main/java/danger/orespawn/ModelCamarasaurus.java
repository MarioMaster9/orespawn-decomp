...
public class ModelCamarasaurus extends ModelBase
{
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		this.Tail1.rotationPointZ = this.Tail0.rotationPointZ + (float)Math.cos((double)this.Tail0.rotateAngleY) * 5.0F;
		this.Tail1.rotationPointX = this.Tail0.rotationPointX + (float)Math.sin((double)this.Tail0.rotateAngleY) * 5.0F;
		this.Tail1.rotateAngleY = newangle * 0.5F;
		this.Tail2.rotationPointZ = this.Tail1.rotationPointZ + (float)Math.cos((double)this.Tail1.rotateAngleY) * 8.0F;
		this.Tail2.rotationPointX = this.Tail1.rotationPointX + (float)Math.sin((double)this.Tail1.rotateAngleY) * 8.0F;
		...
		this.Head1.rotationPointZ = this.Neck3.rotationPointZ - (float)Math.cos((double)this.Neck3.rotateAngleY) * 7.0F;
		this.Head1.rotationPointX = this.Neck3.rotationPointX - (float)Math.sin((double)this.Neck3.rotateAngleY) * 7.0F;
		this.Head1.rotateAngleY = (float)Math.toRadians((double)f3);
		this.Head2.rotationPointZ = this.Head1.rotationPointZ - (float)Math.cos((double)this.Head1.rotateAngleY) * 5.0F;
		this.Head2.rotationPointX = this.Head1.rotationPointX - (float)Math.sin((double)this.Head1.rotateAngleY) * 5.0F;
