...
{
	private final WeightedRandomChestContent[] RainbowContentsList = new WeightedRandomChestContent[]
	{
	...
	private final WeightedRandomChestContent[] StinkyHouseContentsList = new WeightedRandomChestContent[]
	{
		new WeightedRandomChestContent(OreSpawnMain.MyDeadStinkBug, 0, 4, 10, 35),
	...
	private final WeightedRandomChestContent[] CrystalBattleTowerDungeonBeastContentsList = new WeightedRandomChestContent[]{
	...
	private final WeightedRandomChestContent[] CrystalBattleTowerUrchinContentsList = new WeightedRandomChestContent[]{
		new WeightedRandomChestContent(OreSpawnMain.CrystalPinkHelmet, 0, 1, 1, 10),
		new WeightedRandomChestContent(OreSpawnMain.CrystalPinkBody, 0, 1, 1, 10),
		new WeightedRandomChestContent(OreSpawnMain.CrystalPinkLegs, 0, 1, 1, 10),
		new WeightedRandomChestContent(OreSpawnMain.CrystalPinkBoots, 0, 1, 1, 10),
		new WeightedRandomChestContent(OreSpawnMain.MyFairySword, 0, 1, 1, 15)
	};
	private final WeightedRandomChestContent[] CrystalBattleTowerRotatorContentsList = new WeightedRandomChestContent[]{
		new WeightedRandomChestContent(OreSpawnMain.TigersEyeHelmet, 0, 1, 1, 10),
		new WeightedRandomChestContent(OreSpawnMain.TigersEyeBody, 0, 1, 1, 10),
		new WeightedRandomChestContent(OreSpawnMain.TigersEyeLegs, 0, 1, 1, 10),
		new WeightedRandomChestContent(OreSpawnMain.TigersEyeBoots, 0, 1, 1, 10),
	...
	private final WeightedRandomChestContent[] DamselContentsList = new WeightedRandomChestContent[]
	{
	...
	private final WeightedRandomChestContent[] CloudSharkContentsList = new WeightedRandomChestContent[]
	{
		new WeightedRandomChestContent(Items.fish, 0, 6, 16, 25),
		new WeightedRandomChestContent(Items.bone, 0, 6, 16, 25),
		new WeightedRandomChestContent(Items.string, 0, 6, 16, 25),
	...
	private final WeightedRandomChestContent[] blazeContentsList = new WeightedRandomChestContent[]
	{
		...
		new WeightedRandomChestContent(OreSpawnMain.LavaEelHelmet, 0, 1, 1, 15),
		new WeightedRandomChestContent(OreSpawnMain.LavaEelBody, 0, 1, 1, 15),
		new WeightedRandomChestContent(OreSpawnMain.LavaEelLegs, 0, 1, 1, 15),
		new WeightedRandomChestContent(OreSpawnMain.LavaEelBoots, 0, 1, 1, 15),
	...
	private final WeightedRandomChestContent[] level1ContentsList = new WeightedRandomChestContent[]{
		...
		new WeightedRandomChestContent(OreSpawnMain.EmeraldBody, 0, 1, 1, 15),
		new WeightedRandomChestContent(OreSpawnMain.EmeraldLegs, 0, 1, 1, 15),
		new WeightedRandomChestContent(OreSpawnMain.EmeraldHelmet, 0, 1, 1, 15),
		new WeightedRandomChestContent(OreSpawnMain.EmeraldBoots, 0, 1, 1, 15)
	};
	private final WeightedRandomChestContent[] level2ContentsList = new WeightedRandomChestContent[]{
		...
		new WeightedRandomChestContent(OreSpawnMain.MyEmeraldAxe, 0, 1, 1, 15),
		new WeightedRandomChestContent(OreSpawnMain.MyEmeraldSword, 0, 1, 1, 15),
		new WeightedRandomChestContent(OreSpawnMain.ExperienceBody, 0, 1, 1, 15),
		new WeightedRandomChestContent(OreSpawnMain.ExperienceLegs, 0, 1, 1, 15),
		new WeightedRandomChestContent(OreSpawnMain.ExperienceHelmet, 0, 1, 1, 15),
		new WeightedRandomChestContent(OreSpawnMain.ExperienceBoots, 0, 1, 1, 15)
	};
	...
	private final WeightedRandomChestContent[] chestContentsList = new WeightedRandomChestContent[]
	{
		...
		new WeightedRandomChestContent(OreSpawnMain.MothScaleBody, 0, 1, 1, 15),
		new WeightedRandomChestContent(OreSpawnMain.MothScaleLegs, 0, 1, 1, 15),
		new WeightedRandomChestContent(OreSpawnMain.MothScaleHelmet, 0, 1, 1, 15),
		new WeightedRandomChestContent(OreSpawnMain.MothScaleBoots, 0, 1, 1, 15),
	...
	public void makeDungeon(World world, int cposx, int cposy, int cposz)
	{
		...
		if (tileentitymobspawner != null)
		{
			...
			if (t == 0) tileentitymobspawner.func_145881_a().setEntityName("Scorpion");
			if (t == 1) tileentitymobspawner.func_145881_a().setEntityName("Alien");
			if (t == 2) tileentitymobspawner.func_145881_a().setEntityName("Cryolophosaurus");
			if (t == 3) tileentitymobspawner.func_145881_a().setEntityName("WTF?");
			if (t == 4) tileentitymobspawner.func_145881_a().setEntityName("Kyuubi");
			if (t == 5) tileentitymobspawner.func_145881_a().setEntityName("Bee");
			if (t == 6) tileentitymobspawner.func_145881_a().setEntityName("Cloud Shark");
			if (t == 7) tileentitymobspawner.func_145881_a().setEntityName("Lurking Terror");
			if (t == 8) tileentitymobspawner.func_145881_a().setEntityName("Terrible Terror");
			if (t == 9) tileentitymobspawner.func_145881_a().setEntityName("Rotator");
			if (t == 10) tileentitymobspawner.func_145881_a().setEntityName("Rat");
			if (t == 11) tileentitymobspawner.func_145881_a().setEntityName("Dungeon Beast");
		}
	...
	public void makeEnormousCastle(World world, int cposx, int cposy, int cposz)
	{
		...
		if (level <= 3 && world.rand.nextInt(3) != 1) level += 3;
		...
		{	
			...
			if (tileentitymobspawner != null) tileentitymobspawner.func_145881_a().setEntityName("Terrible Terror");
		...
		if (tileentitymobspawner != null) tileentitymobspawner.func_145881_a().setEntityName("Emperor Scorpion");
		...
		j += 10;
		if (level >= 2) this.buildLevel(world, cposx + 1, cposy + j, cposz + 1, width - 2, 10, 4, "Lurking Terror", 0, 0, 4, 2, level);
		j += 10;
		if (level >= 3) this.buildLevel(world, cposx + 2, cposy + j, cposz + 2, width - 4, 9, 4, "Rotator", 1, 1, 4, 3, level);
		j += 9;
		if (level >= 4) this.buildLevel(world, cposx + 2, cposy + j, cposz + 2, width - 4, 9, 3, "Bee", 0, 0, 4, 4, level);
		j += 9;
		if (level >= 5) this.buildLevel(world, cposx + 3, cposy + j, cposz + 3, width - 6, 8, 3, "Mantis", 1, 1, 4, 5, level);
		j += 8;
		if (level >= 6) this.buildLevel(world, cposx + 3, cposy + j, cposz + 3, width - 6, 16, 3, "Mothra", 0, 0, 3, 6, level);
		j += 16;
		...
		for (j = height; j >= 0; j--)
		{
			for (k = -2; k < 3; k++)
			{
				for (int t = 0; t < 6; t++) this.FastSetBlock(world, cposx + i, cposy + j + t + 1, cposz + k + width / 2, Blocks.air);
		...
		if (level >= 6)
		{
			...
			for (int tries = 0; tries < 100; tries++) {
				...
				if (i < span / 4 || i > span * 3 / 4 || k < span / 4 || k > span * 3 / 4) {
					...
					if (tileentitymobspawner != null) tileentitymobspawner.func_145881_a().setEntityName("Large Worm");
	...
	public void buildLevel(World world, int cposx, int cposy, int cposz, int width, int height, int pw, String critter, int stepside, int stepoff, int holelen, int decor, int level)
	{
		...
		for (k = 0; k < width; k++) {
			for (j = 1; j < height; j++) {
				blk = Blocks.bedrock;
				if (k == 0 || k == width - 1) blk = Blocks.gold_block;
				i = 0;
		...
		for (j = 0; j < 4; j++)
		{
			...
			if (tileentitymobspawner != null) tileentitymobspawner.func_145881_a().setEntityName(critter);
	...
	public void addLevelDecorations(World world, int cposx, int cposy, int cposz, int width, int height, int decor, int difficulty)
	{
		...
		if (decor == 6) {
			...
			if (tileentitymobspawner != null) tileentitymobspawner.func_145881_a().setEntityName("Nightmare");
			world.setBlock(cposx + width / 2 + 1, cposy + height + 2, cposz + width / 2, Blocks.mob_spawner, 0, 2);
			tileentitymobspawner = this.getSpawnerTileEntity(world, cposx + width / 2 + 1, cposy + height + 2, cposz + width / 2);
			if (tileentitymobspawner != null) tileentitymobspawner.func_145881_a().setEntityName("Nightmare");
		...
		if (decor == 1) {
			if (difficulty == 1) critter = "Alosaurus";
			if (difficulty == 2) critter = "T. Rex";
			if (difficulty == 3) critter = "Basilisk";
			if (difficulty == 4) critter = "Hercules Beetle";
			if (difficulty == 5) critter = "Jumpy Bug";
			if (difficulty == 6) critter = "Hammerhead";
			reward = difficulty;
	...
	private void fill_chests(World world, int cposx, int cposy, int cposz, int width, int height, int decor, int reward)
	{
		...
		if (reward == 2) chestContents = this.level2ContentsList;
		if (reward == 3) chestContents = this.level3ContentsList;
		if (reward == 4) chestContents = this.level4ContentsList;
		if (reward == 5) chestContents = this.level5ContentsList;
	...
	public void makeRotatorStation(World world, int cposx, int cposy, int cposz)
	{
		...
		if (tileentitymobspawner != null) tileentitymobspawner.func_145881_a().setEntityName("Rotator");
	...
	public void makeBeeHive(World world, int cposx, int cposy, int cposz)
	{
		...
		for (j = 0; j < 4; j++)
		{
			...
			if (tileentitymobspawner != null) tileentitymobspawner.func_145881_a().setEntityName("Bee");
	...
	private void fill_beehive_chests(World world, int cposx, int cposy, int cposz, int width, int height)
	{
		...
		for (j = 2; j < height - 1; j += 2) {
			world.setBlock(cposx + 1, cposy - j, cposz + width / 2, Blocks.chest, 0, 2);
			...
			world.setBlock(cposx + width / 2, cposy - j, cposz + 1, Blocks.chest, 0, 2);
	...
	public void makeHauntedHouse(World world, int cposx, int cposy, int cposz)
	{
		...
		i = 0;
		world.setBlock(x + i * deltax + j * deltaz, y + k, z + i * deltaz + j * deltax, Blocks.chest);
		world.setBlockMetadataWithNotify(x + i * deltax + j * deltaz, y + k, z + i * deltaz + j * deltax, stuffdir, 3);
		
		TileEntityChest chest = this.getChestTileEntity(world, x + i * deltax + j * deltaz, y + k, z + i * deltaz + j * deltax);
		if (chest != null)
		{
			if (world.rand.nextInt(2) == 0) chest.setInventorySlotContents(0, new ItemStack(Items.compass));
			if (world.rand.nextInt(2) == 0) chest.setInventorySlotContents(1, new ItemStack(Items.map));
			if (world.rand.nextInt(2) == 0) chest.setInventorySlotContents(2, new ItemStack(Items.cooked_porkchop, 8));
			if (world.rand.nextInt(2) == 0) chest.setInventorySlotContents(3, new ItemStack(Item.getItemFromBlock(Blocks.torch), 32));
			if (world.rand.nextInt(2) == 0) chest.setInventorySlotContents(4, new ItemStack(Items.coal, 16));
			if (world.rand.nextInt(2) == 0) chest.setInventorySlotContents(5, new ItemStack(Items.bed));
			if (world.rand.nextInt(2) == 0) chest.setInventorySlotContents(6, new ItemStack(Items.bed));
			if (world.rand.nextInt(2) == 0) chest.setInventorySlotContents(7, new ItemStack(Items.wooden_door));
			if (world.rand.nextInt(2) == 0) chest.setInventorySlotContents(8, new ItemStack(Items.iron_pickaxe));
			if (world.rand.nextInt(2) == 0) chest.setInventorySlotContents(9, new ItemStack(Items.iron_sword));
			if (world.rand.nextInt(2) == 0) chest.setInventorySlotContents(10, new ItemStack(Items.iron_axe));
			if (world.rand.nextInt(2) == 0) chest.setInventorySlotContents(11, new ItemStack(Items.bucket));
			if (world.rand.nextInt(2) == 0) chest.setInventorySlotContents(12, new ItemStack(OreSpawnMain.MyOreSaltBlock, 4));
			if (world.rand.nextInt(2) == 0) chest.setInventorySlotContents(13, new ItemStack(Blocks.chest));
		}
		...
		if (tileentitymobspawner != null) tileentitymobspawner.func_145881_a().setEntityName("Rat");
		...
		if (tileentitymobspawner != null) tileentitymobspawner.func_145881_a().setEntityName("Ghost");
		...
		if (tileentitymobspawner != null) tileentitymobspawner.func_145881_a().setEntityName("Ghost Pumpkin Skelly");
	...
	public void makeMantisHive(World world, int cposx, int cposy, int cposz)
	{
		...
		for (; width > 0; width -= 2) {
			for (i = 0; i < width; i++) {
				for (k = 0; k < width; k++) {
					if (k == 0 || k == width - 1 || i == 0 || i == width - 1) {
						blk = Blocks.gold_ore;
						if ((yoff & 1) != 0) blk = Blocks.emerald_ore;
			...
			if (width <= 11 && width >= 7) this.fill_mantishive_chests(world, cposx + xoff, cposy - yoff, cposz + zoff, width, 0);
		...
		for (j = 4; j < 7; j++)
		{
			...
			if (tileentitymobspawner != null) tileentitymobspawner.func_145881_a().setEntityName("Mantis");
		}
			...
			for (k = 0; k < width; k++) {
				for (j = 0; j < width; j++) {
					if (k == 0 || k == width - 1 || j == 0 || j == width - 1) {
						blk = Blocks.stone;
						if (j > 0 && j < width - 1) blk = Blocks.lava;
						this.FastSetBlock(world, x + i, y + j, z + k, blk);
					} else {
						this.FastSetBlock(world, x + i, y + j, z + k, Blocks.air);
					}
	...
	private void addkyuubi(World world, int x, int y, int z) {
		...
		for (int j = 0; j < 3; j++)
		{
			...
			if (tileentitymobspawner != null) tileentitymobspawner.func_145881_a().setEntityName("Kyuubi");
	...
	private void addblaze(World world, int x, int y, int z) {
		...
		for (j = 0; j < 2; j++)
		{
			...
			if (tileentitymobspawner != null) tileentitymobspawner.func_145881_a().setEntityName("Blaze");
			world.setBlock(xx + 1, yy + height + j - 3, zz, Blocks.mob_spawner, 0, 2);
			tileentitymobspawner = this.getSpawnerTileEntity(world, xx + 1, yy + height + j - 3, zz);
			if (tileentitymobspawner != null) tileentitymobspawner.func_145881_a().setEntityName("Blaze");
	...
	public void makeSmallBeeHive(World world, int cposx, int cposy, int cposz)
	{
		...
		for (i = 0; i < width; i++) {
			for (k = 0; k < width; k++) {
				...
				if (blk < 1) blk = 1;
				if (i == width / 2 && k == width / 2) blk = height * 2 / 3;
				for (j = 0; j < blk; j++) {
		...
		for (width = totalwidth; width > 0; width -= 2) {
			for (i = 0; i < width; i++) {
				for (k = 0; k < width; k++) {
					if (k == 0 || k == width - 1 || i == 0 || i == width - 1) {
						blk = Blocks.obsidian;
						if ((yoff & 1) != 0) blk = Blocks.bedrock;
						if (k >= width / 2 - 1 && k <= width / 2 + 1 || i >= width / 2 - 1 && i <= width / 2 + 1) blk = Blocks.soul_sand;
						this.FastSetBlock(world, cposx + i + xoff, cposy - yoff, cposz + k + zoff, blk);
					} else {
						this.FastSetBlock(world, cposx + i + xoff, cposy - yoff, cposz + k + zoff, Blocks.air);
					}
			...
			if (width <= 15 && width >= 9) {
				...
				if (tileentitymobspawner != null) tileentitymobspawner.func_145881_a().setEntityName(whichmob);
	...
	public void makeAlienWTFDungeon(World world, int cposx, int cposy, int cposz)
	{
		...
		for (j = 3; j < depth; j++) {
			for (i = 0; i < 4; i++) {
				for (k = 0; k < 4; k++) {
					blk = Blocks.air;
					if (i == 0 || k == 0 || i == 3 || k == 3) blk = Blocks.lapis_ore;
		...
		for (i = 0; i < xwidth; i++) {
			for (k = 0; k < zwidth; k++) {
				for (j = 0; j < 4; j++) {
					blk = Blocks.air;
					if (j == 0 || j == 3) blk = Blocks.lapis_ore;
					if (i == 0 || i == xwidth - 1) blk = Blocks.lapis_ore;
		...
		for (i = 0; i < xwidth; i++) {
			for (k = 0; k < zwidth; k++) {
				for (j = 0; j < 4; j++) {
					blk = Blocks.air;
					if (j == 0 || j == 3) blk = Blocks.lapis_ore;
					if (k == 0 || k == zwidth - 1) blk = Blocks.lapis_ore;
	...
	private void makePart(World world, int cposx, int cposy, int cposz, int width, int height, int dx, int dz, int difficulty)
	{
		...
		for (i = 0; i < width; i++) {
			...
			for (k = 0; k < width; k++) {
				...
				if (i == width / 2 || k == width / 2) blk = Blocks.obsidian;
		...
		for (j = 0; j < difficulty; j++)
		{
			...
			if (tileentitymobspawner != null)
			{
				...
				if (t == 0) tileentitymobspawner.func_145881_a().setEntityName("Alien");
				if (t == 1) tileentitymobspawner.func_145881_a().setEntityName("WTF?");
			}
	...
	public void makeEnderKnightDungeon(World world, int cposx, int cposy, int cposz)
	{
		...
		for (k = 0; k < zwidth; k++) {
			for (j = 0; j < height; j++) {
				blk = Blocks.air;
				if (j == 0 || j == height - 1) blk = Blocks.obsidian;
				if (j == 0 && k > 0 && k < zwidth - 1) blk = Blocks.end_stone;
				if (k == 0 || k == zwidth - 1) blk = Blocks.obsidian;
				this.FastSetBlock(world, cposx, cposy + j, cposz + k, blk);
			}
	...
	public void makeWaterDragonLair(World world, int cposx, int cposy, int cposz)
	{
		...
		for (currad = 0.0F; currad < radius; currad += 0.33F) {
			for (curdeg = 0.0F; curdeg < 360.0F; curdeg += 5.0F) {
				curx = (float)((double)currad * Math.cos(Math.toRadians((double)curdeg)));
				curz = (float)((double)currad * Math.sin(Math.toRadians((double)curdeg)));
				blk = Blocks.bedrock;
				if (currad > 5.0F && currad < 6.0F) blk = Blocks.iron_block;
		...
		for (curdeg = 0.0F; curdeg < 360.0F; curdeg += 5.0F) {
			...
			if (world.rand.nextInt(2) == 0) blk = OreSpawnMain.MyWaterDragonSpawnBlock;
	...
	public void makeLeafMonsterDungeon(World world, int cposx, int cposy, int cposz)
	{
		...
		for (i = 0; i < 4; i++) {
			for (k = 0; k < 4; k++) {
				for (j = 0; j < 10; j++) {
					blk = Blocks.log;
					if (j < 2 && (k == 0 || k == 1) && (i == 1 || i == 2)) blk = Blocks.air;
					if (k == 1 && (i == 1 || i == 2)) blk = Blocks.air;
					if (k == 2 && (i == 1 || i == 2)) {
						continue;
					} else {
						this.FastSetBlock(world, cposx + i, cposy + j, cposz + k, blk);
		...
		for (i = -2; i < 6; i++) {
			for (k = -2; k < 6; k++) {
				j = 13;
				blk = Blocks.air;
				if (i == -2 || i == 5 || k == -2 || k == 5) blk = Blocks.log;
				if (i == -1 || i == 4 || k == -1 || k == 4) blk = Blocks.leaves;
				this.FastSetBlock(world, cposx + i, cposy + j, cposz + k, blk);
			}
		}
		for (i = -1; i < 5; i++) {
	...
	public void makeMiniDungeon(World world, int cposx, int cposy, int cposz)
	{
		...
		for (i = 0; i < 10; i++) {
			for (k = 0; k < 10; k++) {
				for (j = 0; j < 7; j++) {
					blk = Blocks.air;
					if (i == 0 || k == 0 || i == 9 || k == 9) blk = Blocks.iron_bars;
					if (i == 0 && k == 0) blk = Blocks.cobblestone;
					if (i == 9 && k == 9) blk = Blocks.cobblestone;
					if (i == 0 && k == 9) blk = Blocks.cobblestone;
					if (i == 9 && k == 0) blk = Blocks.cobblestone;
					if (j == 0) blk = Blocks.cobblestone;
					if (j == 6 && (i == 0 || k == 0 || i == 9 || k == 9)) blk = Blocks.cobblestone;
					this.FastSetBlock(world, cposx + i, cposy + j, cposz + k, blk);
				}
			}
		}
		...
		for (i = 1; i < 9; i++) {
			for (k = 1; k < 9; k++) {
				j = 7;
				blk = Blocks.air;
				if (i == 1 || i == 8 || k == 1 || k == 8) blk = Blocks.grass;
				this.FastSetBlock(world, cposx + i, cposy + j, cposz + k, blk);
			}
		}
		...
		for (i = 2; i < 8; i++) {
			for (k = 2; k < 8; k++) {
				j = 8;
				blk = Blocks.air;
				if (i == 2 || i == 7 || k == 2 || k == 7) blk = Blocks.grass;
				this.FastSetBlock(world, cposx + i, cposy + j, cposz + k, blk);
			}
		}
	...
	public void makeEnderReaperGraveyard(World world, int cposx, int cposy, int cposz)
	{
		...
		for (j = 1; j < 5; j++) {
			for (i = 0; i < width; i++) {
				for (k = 0; k < length; k++) {
					blk = Blocks.air;
					if (i == 0 || k == 0 || i == width - 1 || k == length - 1) blk = Blocks.iron_bars;
					this.FastSetBlock(world, cposx + i, cposy + j, cposz + k, blk);
				}
			}
		}
	...
	public void makeUrchinSpawner(World world, int cposx, int cposy, int cposz)
	{
		...
		for (int i = 0; i < patchy; i++) {
			...
			if (i == 1) bid = OreSpawnMain.CrystalCrystal;
			if (i == 2) bid = OreSpawnMain.TigersEye;
			dx = world.rand.nextFloat() - world.rand.nextFloat();
			dz = world.rand.nextFloat() - world.rand.nextFloat();
			dy = 0.5F + world.rand.nextFloat() / 2.0F;
			width = world.rand.nextInt(2);
			length = 10 + width * 3 + world.rand.nextInt(5);
			if (i != 0) length /= 2;
			rx = (float)cposx;
			ry = (float)cposy;
			rz = (float)cposz;
		...
		world.setBlock(cposx, cposy + 1, cposz, Blocks.mob_spawner, 0, 2);
		tileentitymobspawner = this.getSpawnerTileEntity(world, cposx, cposy + 1, cposz);
		if (tileentitymobspawner != null) tileentitymobspawner.func_145881_a().setEntityName("Crystal Urchin");
		world.setBlock(cposx, cposy + 2, cposz, Blocks.mob_spawner, 0, 2);
		tileentitymobspawner = this.getSpawnerTileEntity(world, cposx, cposy + 2, cposz);
		if (tileentitymobspawner != null) tileentitymobspawner.func_145881_a().setEntityName("Crystal Urchin");
		world.setBlock(cposx, cposy + 3, cposz, Blocks.mob_spawner, 0, 2);
	...
	public void makeSpitBugLair(World world, int cposx, int cposy, int cposz)
	{
		...
		if (tileentitymobspawner != null) tileentitymobspawner.func_145881_a().setEntityName("Spit Bug");
	...
	public void makeIgloo(World world, int cposx, int cposy, int cposz)
	{
		...
		ItemDoor.placeDoorBlock(world, (int)((float)cposx - 6.0F + 0.5F), cposy + 1, (int)((float)cposz + 0.5F), 2, Blocks.wooden_door);
		...
		if (chest != null)
		{
			...
			if (world.rand.nextInt(2) == 0) chest.setInventorySlotContents(1, new ItemStack(Items.map));
			if (world.rand.nextInt(2) == 0) chest.setInventorySlotContents(2, new ItemStack(Items.cooked_porkchop, 8));
			if (world.rand.nextInt(2) == 0) chest.setInventorySlotContents(3, new ItemStack(Blocks.torch, 32));
			if (world.rand.nextInt(2) == 0) chest.setInventorySlotContents(4, new ItemStack(Items.coal, 16));
			if (world.rand.nextInt(2) == 0) chest.setInventorySlotContents(5, new ItemStack(Items.bed));
			if (world.rand.nextInt(2) == 0) chest.setInventorySlotContents(6, new ItemStack(Items.bed));
			if (world.rand.nextInt(2) == 0) chest.setInventorySlotContents(7, new ItemStack(Items.wooden_door));
			...
			if (world.rand.nextInt(2) == 0) chest.setInventorySlotContents(13, new ItemStack(Blocks.chest));
			if (world.rand.nextInt(2) == 0) chest.setInventorySlotContents(14, new ItemStack(Items.gold_nugget, 6));
			if (world.rand.nextInt(2) == 0) chest.setInventorySlotContents(15, new ItemStack(Items.gold_nugget, 8));
			if (world.rand.nextInt(2) == 0) chest.setInventorySlotContents(16, new ItemStack(Items.gold_nugget, 10));
		}
	...
	public void makeEnderDragonHospital(World world, int cposx, int cposy, int cposz)
	{
		...
		for (i = 0; i < 10; i++) {
			for (k = 0; k < 10; k++) {
				for (j = 0; j < 7; j++) {
					blk = Blocks.air;
					if (i == 0 || k == 0 || i == 9 || k == 9) blk = Blocks.iron_bars;
					if (i == 0 && k == 0) blk = Blocks.obsidian;
					if (i == 9 && k == 9) blk = Blocks.obsidian;
					if (i == 0 && k == 9) blk = Blocks.obsidian;
					if (i == 9 && k == 0) blk = Blocks.obsidian;
					if (j == 0) blk = Blocks.end_stone;
					if (j == 6 && (i == 0 || k == 0 || i == 9 || k == 9)) blk = Blocks.end_stone;
					this.FastSetBlock(world, cposx + i, cposy + j, cposz + k, blk);
				}
			}
		}
		...
		for (i = 1; i < 9; i++) {
			for (k = 1; k < 9; k++) {
				j = 7;
				blk = Blocks.air;
				if (i == 1 || i == 8 || k == 1 || k == 8) blk = OreSpawnMain.MyEyeOfEnderBlock;
				this.FastSetBlock(world, cposx + i, cposy + j, cposz + k, blk);
			}
		}
		for (i = 2; i < 8; i++) {
			for (k = 2; k < 8; k++) {
				j = 8;
				blk = Blocks.air;
				if (i == 2 || i == 7 || k == 2 || k == 7) blk = OreSpawnMain.MyEyeOfEnderBlock;
				this.FastSetBlock(world, cposx + i, cposy + j, cposz + k, blk);
			}
		}
		for (i = 3; i < 7; i++) {
			for (k = 3; k < 7; k++) {
				j = 9;
				blk = Blocks.air;
				if (i == 3 || i == 6 || k == 3 || k == 6) blk = OreSpawnMain.MyEyeOfEnderBlock;
				this.FastSetBlock(world, cposx + i, cposy + j, cposz + k, blk);
			}
		}
	...
	public void makeCrystalHauntedHouse(World world, int cposx, int cposy, int cposz)
	{
		...
		i = 2; k = 1; j = length - 1;
		world.setBlock(x + i * deltax + j * deltaz, y + k, z + i * deltaz + j * deltax, OreSpawnMain.CrystalFurnaceBlock);
		world.setBlockMetadataWithNotify(x + i * deltax + j * deltaz, y + k, z + i * deltaz + j * deltax, stuffdir, 3);
		i = 1;
		...
		if (chest != null)
		{
			...
			if (world.rand.nextInt(3) != 0) chest.setInventorySlotContents(2, new ItemStack(OreSpawnMain.MyPeacock, 8));
			if (world.rand.nextInt(3) != 0) chest.setInventorySlotContents(3, new ItemStack(OreSpawnMain.CrystalTorch, 32));
			if (world.rand.nextInt(2) == 0) chest.setInventorySlotContents(4, new ItemStack(OreSpawnMain.CrystalCoal, 16));
			if (world.rand.nextInt(2) == 0) chest.setInventorySlotContents(5, new ItemStack(Items.bed));
			if (world.rand.nextInt(2) == 0) chest.setInventorySlotContents(6, new ItemStack(Items.bed));
			if (world.rand.nextInt(2) == 0) chest.setInventorySlotContents(7, new ItemStack(Items.wooden_door));
			if (world.rand.nextInt(2) == 0) chest.setInventorySlotContents(8, new ItemStack(OreSpawnMain.MyCrystalPinkPickaxe));
			if (world.rand.nextInt(2) == 0) chest.setInventorySlotContents(9, new ItemStack(OreSpawnMain.MyCrystalPinkSword));
			if (world.rand.nextInt(2) == 0) chest.setInventorySlotContents(10, new ItemStack(OreSpawnMain.MyCrystalPinkAxe));
	...
	public void makeBouncyCastle(World world, int cposx, int cposy, int cposz)
	{
		...
		for (i = -width; i <= width; i++)
		{
			for (j = -length; j <= length; j++)
			{
				for (k = 0; k < height; k++)
				{
					...
					if (i == -width || i == width) bid = OreSpawnMain.MyLavafoamBlock;
					if (j == -length || j == length) bid = OreSpawnMain.MyLavafoamBlock;
		...
		if (tileentitymobspawner != null) tileentitymobspawner.func_145881_a().setEntityName("Silverfish");
		...
		world.setBlock(cposx + 1, cposy + 3, cposz + length - 1, Blocks.mob_spawner, 0, 2);
		tileentitymobspawner = this.getSpawnerTileEntity(world, cposx + 1, cposy + 3, cposz + length - 1);
		if (tileentitymobspawner != null) tileentitymobspawner.func_145881_a().setEntityName("Scorpion");
	...
	public void makeEnderCastle(World world, int cposx, int cposy, int cposz)
	{
		...
		for (i = -3; i <= width + 3; i++) {
			for (k = -3; k <= width + 3; k++) {
				for (j = 0; j <= 1; j++) {
					bid = Blocks.air;
					if (j == 0) bid = Blocks.obsidian;
					if (j == 1) {
						if (i == -3 || i == width + 3 || k == width + 3 | k == -3) bid = Blocks.iron_bars;
					}
		...
		for (i = 0; i <= width; i++) {
			for (k = 0; k <= width; k++) {
				for (j = 1; j <= height; j++) {
					bid = Blocks.air;
					if (i == 0 || i == width || k == width | k == 0) bid = Blocks.bedrock;
					
					if (j == height) {
						if (bid == Blocks.bedrock) {
							if ((i + k & 1) == 0) bid = Blocks.air;
						}
					}
					if (j == height - 2) {
						if (bid == Blocks.bedrock) {
							if ((i + k & 1) == 0) {
								which = world.rand.nextInt(4);
								if (which == 0) bid = OreSpawnMain.MyEnderKnightSpawnBlock;
								if (which == 1) bid = OreSpawnMain.MyEnderReaperSpawnBlock;
								if (which == 2) bid = OreSpawnMain.MyEndermanSpawnBlock;
								if (which == 3) bid = OreSpawnMain.MyEnderDragonSpawnBlock;
							}
						}
					}
					if (j == 7) {
		...
		for (i = -1; i <= width + 1; i++) {
			for (k = -1; k <= width + 1; k++) {
				for (j = 1; j <= height - 1; j++) {
					bid = Blocks.air;
					if (j == 6 || j > 8) {
						if (i == -1 || i == width + 1 || k == width + 1 | k == -1) bid = Blocks.bedrock;
						if (j == 6 && bid != Blocks.air) {
							if (world.rand.nextInt(2) == 1) {
					...
					if (bid != Blocks.air) OreSpawnMain.setBlockFast(world, cposx + i, cposy + j, cposz + k, bid, 0, 2);
				}
			}
		}
		...
		for (i = 1; i <= width - 1; i++) {
			for (k = 1; k <= width - 1; k++) {
				bid = Blocks.obsidian;
				if (i == width / 2 || k == width / 2 || i == k || i == width - k) bid = Blocks.bedrock;
				OreSpawnMain.setBlockFast(world, cposx + i, cposy + j, cposz + k, bid, 0, 2);
			}
		}
		...
		if (tileentitymobspawner != null) tileentitymobspawner.func_145881_a().setEntityName("Ender Reaper");
		...
		if (tileentitymobspawner != null) tileentitymobspawner.func_145881_a().setEntityName("Ender Knight");
		...
		for (i = 1; i <= width - 1; i++) {
			for (k = 1; k <= width - 1; k++) {
				bid = Blocks.air;
				if (i <= 5 || k <= 5 || i >= width - 5 || k >= width - 5) bid = Blocks.bedrock;
				if (bid != Blocks.air) OreSpawnMain.setBlockFast(world, cposx + i, cposy + j, cposz + k, bid, 0, 2);
		...
		if (tileentitymobspawner != null) tileentitymobspawner.func_145881_a().setEntityName("CaveFisher");
		world.setBlock(cposx + 1, cposy + j, cposz + width / 2 + 1, Blocks.mob_spawner, 0, 2);
		tileentitymobspawner = this.getSpawnerTileEntity(world, cposx + 1, cposy + j, cposz + width / 2 + 1);
		if (tileentitymobspawner != null) tileentitymobspawner.func_145881_a().setEntityName("CaveFisher");
		world.setBlock(cposx + 1, cposy + j, cposz + width / 2, Blocks.chest, 2, 2);
		chest = this.getChestTileEntity(world, cposx + 1, cposy + j, cposz + width / 2);
		if (chest != null) WeightedRandomChestContent.generateChestContents(world.rand, chestContents, chest, 6 + world.rand.nextInt(5));
	...
	private void makeAColumn(World world, int cposx, int cposy, int cposz, int height, int dir)
	{
		...
		for (i = -2; i <= width + 2; i++) {
			for (k = -2; k <= width + 2; k++) {
				bid = Blocks.air;
				if (i == -2 || i == width + 2 || k == width + 2 | k == -2) bid = Blocks.obsidian;
				j = height + 3;
				if (bid != Blocks.air) {
					if ((i + k & 1) == 0) {
						bid = Blocks.air;
		...
		for (i = 0; i <= width; i++) {
			for (k = 0; k <= width; k++) {
				for (j = 1; j <= height + 2; j++) {
					bid = Blocks.air;
					if (i == 0 || i == width || k == width | k == 0) bid = Blocks.obsidian;
					if ((j % 3 == 0 || j % 3 == 1) && j != height + 2) {
						if (bid == Blocks.obsidian) {
							if (i == halfwidth || k == halfwidth) bid = Blocks.iron_bars;
						}
					}
					OreSpawnMain.setBlockFast(world, cposx + i, cposy + j, cposz + k, bid, 0, 2);
				}
		...
		for (i = -width; i <= width; i++)
		{
			for (j = -length; j <= length; j++)
			{
				for (k = 0; k < height; k++)
				{
					...
					if (i == -width || i == width) bid = Blocks.cobblestone;
					if (j == -length || j == length) bid = Blocks.cobblestone;
					if (bid == Blocks.cobblestone) {
						if (world.rand.nextInt(8) == 1) bid = Blocks.mossy_cobblestone;
					}
	...
	public void makeIncaPyramid(World world, int cposx, int cposy, int cposz)
	{
		...
		int baseheight, basewidth, basedepth;
		int meta = 0;
			...
			for (i = 0; i < basewidth - j * 2; i++) {
				for (k = 0; k < basedepth - j * 2; k++) {
					...
					if (i == 0 || k == 0 || i == basewidth - j * 2 - 1 || k == basedepth - j * 2 - 1) {
						bid = Blocks.stone;
						if (world.rand.nextInt(2) == 0) bid = Blocks.cobblestone;
						if (world.rand.nextInt(4) == 0) bid = Blocks.mossy_cobblestone;
					}
					if (j == 0) bid = Blocks.stonebrick;
					if (k == 1 && j % 3 == 2) {
						if (i != 0 && i != basewidth - j * 2 - 1) {
							bid = Blocks.torch;
							meta = 3;
						}
					}
		...
		for (m = 0; m < baseheight * 2 - 1; ++m) {
			...
			for (p = -2; p <= 2; ++p) {
				...
				if (p < -1 || p > 1) {
					...
					bid = world.getBlock(cposx + i, cposy + j + 1, cposz + k);
					if (bid == Blocks.air) OreSpawnMain.setBlockFast(world, cposx + i, cposy + j + 1, cposz + k, Blocks.stone_slab, meta, 2);
				}
		...
		for (j = 0; j < height; ++j) {
			for (i = 0; i < width; i++) {
				for (k = 0; k < depth; k++) {
					...
					if (j == 0 || j == height - 1) bid = Blocks.stonebrick;
					if (j == 1 || j == 2 || j == 3) {
						if (k == 0 || k == depth - 1) {
					...
					if (j == height - 3 || j == height - 2) {
						if ((i + k) % 2 == 1) {
							if (j == height - 3) {
								if (bid != Blocks.air) bid = Blocks.lit_redstone_lamp;
							} else {
								bid = Blocks.air;
							}
						}
		...
		if (tileentitymobspawner != null) tileentitymobspawner.func_145881_a().setEntityName("Molenoid");
	...
	private void makeincagrave(World world, int cposx, int cposy, int cposz, int dir)
	{
		...
		if (dir == 1) {
			...
			chest = this.getChestTileEntity(world, cposx, cposy + 1, cposz - 1);
			if (chest != null) WeightedRandomChestContent.generateChestContents(world.rand, chestContents, chest, 10 + world.rand.nextInt(5));
		}
	...
	public void makeRobotLab(World world, int cposx, int cposy, int cposz)
	{
		...
		for (j = 0; j <= height; j++) {
			for (i = 0; i < width; i++) {
				for (k = 0; k < length; k++) {
					bid = Blocks.air;
					if (i == 0 || k == 0 || i == width - 1 || k == length - 1) bid = Blocks.quartz_block;
					if (j == 0) {
						bid = Blocks.quartz_block;
						if (i == width / 2 || i == width / 2 - 1) bid = Blocks.iron_block;
					}
					if (j == height) {
						bid = Blocks.quartz_block;
						if (i == 0 || k == 0 || i == width - 1 || k == length - 1) bid = Blocks.air;
					}
					OreSpawnMain.setBlockFast(world, cposx + i, cposy + j, cposz + k, bid, 0, 2);
				}
			}
	...
	private void makerobopillar(World world, int cposx, int cposy, int cposz, int dir)
	{
		...
		if (dir == 0) {
			...
			if (tileentitymobspawner != null) tileentitymobspawner.func_145881_a().setEntityName("Robo-Sniper");
		}
		if (dir == 1) {
			world.setBlock(cposx - 1, cposy + 1, cposz, Blocks.mob_spawner, 0, 2);
			tileentitymobspawner = this.getSpawnerTileEntity(world, cposx - 1, cposy + 1, cposz);
		...
		for (j = 0; j <= height; j++) {
			for (i = 0; i < width; i++) {
				for (k = 0; k < length; k++) {
					...
					if (j == 1 || j == 2 || j == 3) {
						if (k == 0) {
							if (i >= width / 3 && i < width * 2 / 3) bid = Blocks.air;
						}
					}
					OreSpawnMain.setBlockFast(world, cposx + i, cposy + j, cposz + k, bid, 0, 2);
				}
		...
		for (j = 0; j < 2; j++) {
			for (i = 0; i < 12; i++) {
				for (k = 0; k < 12; k++) {
					...
					if (j == 1) {
						if (i == 0 || k == 0 || i == 11 || k == 11) bid = Blocks.iron_bars;
						if (i == 0 && (k == 0 || k == 11)) bid = Blocks.redstone_block;
						if (i == 11 && (k == 0 || k == 11)) bid = Blocks.redstone_block;
					}
					if (j == 0) bid = Blocks.quartz_block;
					OreSpawnMain.setBlockFast(world, cposx + i, cposy + j, cposz + k, bid, 0, 2);
				}
			}
		}
			...
			for (i = 0; i < 2; i++) {
				for (k = 0; k < 3; k++) {
					...
					if (j < 15) {
						...
						bid = Blocks.quartz_block;
						if (k == 2) bid = Blocks.iron_bars;
					} else {
						bid = Blocks.quartz_block;
						if (k == 1) bid = Blocks.iron_bars;
						if (k == 2) bid = Blocks.air;
					}
	...
	public void makeroboaltar(World world, int cposx, int cposy, int cposz)
	{
		...
		if (tileentitymobspawner != null) tileentitymobspawner.func_145881_a().setEntityName("Robo-Pounder");
	...
	public void makerobotreasureroom(World world, int cposx, int cposy, int cposz)
	{
		...
		for (j = 1; j < 7; j++) {
			for (i = 0; i < 12; i++) {
				for (k = 0; k < 8; k++) {
					bid = Blocks.air;
					if (i == 0 || k == 0 || i == 11 || k == 7) bid = Blocks.quartz_block;
					if (j == 2) {
						if (i == 11) bid = Blocks.iron_bars;
					}
					if (j == 3) {
						if (bid != Blocks.air) bid = Blocks.iron_bars;
					}
					if (j == 1 || j == 2 || j == 3) {
						if (k == 0) {
							if (i == 1 || i == 2) {
		...
		if (tileentitymobspawner != null) tileentitymobspawner.func_145881_a().setEntityName("Robo-Warrior");
		...
		for (j = 0; j < height; j++) {
			for (i = 0; i < width; i++) {
				for (k = 0; k < length; k++) {
					...
					if (j % 4 == 0) {
						if (bid != Blocks.air) {
							if (i == 2 || k == 2) bid = Blocks.gold_block;
						}
					}
					if (j % 4 == 1) {
						if (bid != Blocks.air) {
							if (i == 1 || k == 1) bid = Blocks.gold_block;
							if (i == 3 || k == 3) bid = Blocks.gold_block;
						}
					}
					if (j % 4 == 2) {
						if (bid != Blocks.air) {
							if (i == 1 || k == 1) bid = Blocks.gold_block;
							if (i == 3 || k == 3) bid = Blocks.gold_block;
							if (i == 2 || k == 2) bid = Blocks.emerald_block;
						}
					}
					if (j % 4 == 3) {
						if (bid != Blocks.air) {
					...
					meta = 0;
					if (bid == Blocks.quartz_block) meta = 2;
					OreSpawnMain.setBlockFast(world, cposx + i, cposy + j, cposz + k, bid, meta, 2);
				}
			}
		}
	...
	private void makekingcenteraltar(World world, int cposx, int cposy, int cposz)
	{
		...
		for (i = -width; i <= width; i++) {
			for (k = -length; k <= length; k++) {
				bid = Blocks.quartz_block;
				if (i == width) {
					if (k == -length || k == length) bid = Blocks.lapis_block;
				}
				if (i == -width) {
					if (k == -length || k == length) bid = Blocks.lapis_block;
				}
	...
	public void makeLeonNest(World world, int cposx, int cposy, int cposz)
	{
		...
		if (tileentitymobspawner != null) tileentitymobspawner.func_145881_a().setEntityName("Leonopteryx");
	...
	public void makeCephadromeAltar(World world, int cposx, int cposy, int cposz)
	{
		...
		for (i = -width; i <= width; i++) {
			for (k = -length; k <= length; k++) {
				bid = Blocks.cobblestone;
				if (k == 0 || i == 0) bid = Blocks.stonebrick;
				if (k == -length || k == length) {
					if (i == -width || i == width) {
		...
		for (i = -width; i <= width; i++) {
			for (k = -length; k <= length; k++) {
				bid = Blocks.cobblestone;
				if (k == 0 && i == 0) bid = OreSpawnMain.MyEyeOfEnderBlock;
				if (k == -length || k == length) {
					if (i == -width || i == width) {
						bid = Blocks.end_stone;
					}
	...
	public void makeCrystalBattleTower(World world, int cposx, int cposy, int cposz)
	{
		Block blk;
		int unused1, j;
		float radius, curdeg, curx, curz, currad;
		TileEntityMobSpawner tileentitymobspawner = null;
		TileEntityChest chest = null;
		WeightedRandomChestContent[] chestContents = null;
		...
		for (j = 0; j <= 20; j++) {
			...
			if (j % 5 == 0) {
				...
				for (curdeg = 0.0F; curdeg < 360.0F; curdeg += 5.0F) {
					...
					curz = (float)((double)currad * Math.sin(Math.toRadians((double)curdeg)));
					blk = OreSpawnMain.CrystalStone;
					if (j % 5 >= 1 && j % 5 <= 3 && (curdeg < 10.0F || curdeg > 350.0F)) blk = Blocks.air;
					this.FastSetBlock(world, (int)((float)cposx + curx + 0.5F), cposy + j, (int)((float)cposz + curz + 0.5F), blk);
				}
			}
		}
		...
		if (chest != null) WeightedRandomChestContent.generateChestContents(world.rand, chestContents, chest, 5 + world.rand.nextInt(5));

		j = 6;
		chestContents = this.CrystalBattleTowerDungeonBeastContentsList;
		world.setBlock(cposx, cposy + j + 1, cposz, Blocks.mob_spawner, 0, 2);
		tileentitymobspawner = this.getSpawnerTileEntity(world, cposx, cposy + j + 1, cposz);
		if (tileentitymobspawner != null) tileentitymobspawner.func_145881_a().setEntityName("Dungeon Beast");
		world.setBlock(cposx, cposy + j + 2, cposz, Blocks.mob_spawner, 0, 2);
		tileentitymobspawner = this.getSpawnerTileEntity(world, cposx, cposy + j + 2, cposz);
		if (tileentitymobspawner != null) tileentitymobspawner.func_145881_a().setEntityName("Dungeon Beast");
		world.setBlock(cposx, cposy + j, cposz, Blocks.chest, 0, 2);
		...
		world.setBlock(cposx, cposy + j + 1, cposz, Blocks.mob_spawner, 0, 2);
		tileentitymobspawner = this.getSpawnerTileEntity(world, cposx, cposy + j + 1, cposz);
		if (tileentitymobspawner != null) tileentitymobspawner.func_145881_a().setEntityName("Vortex");
		world.setBlock(cposx, cposy + j + 2, cposz, Blocks.mob_spawner, 0, 2);
		tileentitymobspawner = this.getSpawnerTileEntity(world, cposx, cposy + j + 2, cposz);
		if (tileentitymobspawner != null) tileentitymobspawner.func_145881_a().setEntityName("Vortex");
		world.setBlock(cposx, cposy + j, cposz, Blocks.chest, 0, 2);
		chest = this.getChestTileEntity(world, cposx, cposy + j, cposz);
		if (chest != null) WeightedRandomChestContent.generateChestContents(world.rand, chestContents, chest, 6 + world.rand.nextInt(6));
	...
	public void makeGreenhouseDungeon(World world, int cposx, int cposy, int cposz)
	{
		...
		for (i = 0; i < length; i++) {
			for (k = 0; k < width; k++) {
				for (j = 0; j < height; j++) {
					blk = Blocks.air;
					if (i == 0 || k == 0 || i == length - 1 || k == width - 1) blk = Blocks.glass;
					if (j == height - 1) {
						blk = Blocks.iron_block;
						if (i % 4 == 3 && k % 4 == 3) blk = Blocks.glowstone;
						if (k % 4 == 1) blk = Blocks.glass;
					}
					if (j == 0) {
						blk = Blocks.grass;
						if (i != 0 && k != 0 && i != length - 1 && k != width - 1) {
							if (i % 3 == 2) blk = Blocks.water;
						}
					}
					if (j == 1) {
						if (i != 0 && k != 0 && i != length - 1 && k != width - 1) {
							if (i % 3 != 2) {
								if (world.rand.nextInt(3) != 1) {
									...
									blk = Blocks.air;
									if (t == 0) blk = Blocks.yellow_flower;
									if (t == 1) blk = Blocks.red_flower;
									if (t == 2) blk = Blocks.brown_mushroom;
									if (t == 3) blk = Blocks.red_mushroom;
									if (t == 4) blk = Blocks.wheat;
									if (t == 5) blk = Blocks.carrots;
									if (t == 6) blk = Blocks.potatoes;
									if (t == 7) blk = Blocks.reeds;
									//if (t == 8) blk = Blocks.air;
									if (t == 9) blk = OreSpawnMain.MyCornPlant1;
									if (t == 10) blk = OreSpawnMain.MyTomatoPlant1;
									if (t == 11) blk = OreSpawnMain.MyStrawberryPlant;
									if (t == 12) blk = OreSpawnMain.MyButterflyPlant;
									if (t == 13) blk = OreSpawnMain.MyMothPlant;
									if (t == 14) blk = OreSpawnMain.MyRadishPlant;
									if (t == 15) blk = OreSpawnMain.MyLettucePlant1;
									if (t == 16) blk = OreSpawnMain.MyFlowerPinkBlock;
									if (t == 17) blk = OreSpawnMain.MyFlowerBlueBlock;
									if (t == 18) blk = OreSpawnMain.MyQuinoaPlant1;
									if (t == 19) blk = OreSpawnMain.MyRicePlant;
								}
							}
						}
					}
	...
	public void makeMonsterIsland(World world, int cposx, int cposy, int cposz)
	{
		...
		if (world.rand.nextInt(2) == 0) monster = "Sea Monster";
	...
	public void makeNightmareRookery(World world, int cposx, int cposy, int cposz)
	{
		...
		for (i = -5; i <= 20; i++) {
			...
			for (j = 0; j < h; j++) {
				this.FastSetBlock(world, cposx + i, cposy + j, cposz + k, Blocks.stone);
				if (world.rand.nextInt(j + 5) == 1) this.FastSetBlock(world, cposx + i + 1, cposy + j, cposz + k, Blocks.stone);
				if (world.rand.nextInt(j + 5) == 1) this.FastSetBlock(world, cposx + i - 1, cposy + j, cposz + k, Blocks.stone);
				if (world.rand.nextInt(j + 5) == 1) this.FastSetBlock(world, cposx + i, cposy + j, cposz + k + 1, Blocks.stone);
				if (world.rand.nextInt(j + 5) == 1) this.FastSetBlock(world, cposx + i, cposy + j, cposz + k - 1, Blocks.stone);
				if (j >= 18) {
	...
	public void makeStinkyHouse(World world, int cposx, int cposy, int cposz)
	{
		...
		for (i = 0; i <= yardlength; i++) {
			for (k = 0; k <= yardwidth; k++) {
				bid = Blocks.air;
				if (i == 0 || i == yardlength || k == 0 || k == yardwidth) bid = Blocks.fence;
				if (bid == Blocks.fence && world.rand.nextInt(3) == 1) bid = Blocks.air;
				if (bid == Blocks.air && world.rand.nextInt(10) == 1) bid = Blocks.deadbush;
				if (bid != Blocks.air) this.FastSetBlock(world, cposx + i - 5, cposy + 1, cposz + k - 4, bid);
			}
		}
		...
		for (i = 0; i <= length; i++) {
			for (k = 0; k <= width; k++) {
				for (j = 0; j <= height; j++) {
					bid = Blocks.air;
					if (i == 0 || i == length || k == 0 || k == width) bid = Blocks.planks;
					if (bid == Blocks.planks && j == 1) {
						if (i == 1 || i == length - 1 || k == 1 || k == width - 1) bid = Blocks.glass_pane;
					}
					if (j == height) bid = Blocks.planks;
					if (world.rand.nextInt(10) == 1) bid = Blocks.air;
					if (j == 0 || j == 1) {
						if (i == 0) {
	...
	private void makefountain(World world, int cposx, int cposy, int cposz) {
		...
		for (i = 0; i < 7; i++) {
			for (k = 0; k < 5; k++) {
				for (j = 0; j < 15; j++) {
					bid = Blocks.water;
					if (i == 0 || k == 0 || i == 6 || k == 4) bid = Blocks.quartz_block;
					if (j == 0) bid = Blocks.quartz_block;
					if (j == 1 && i == 3 && k == 2) bid = Blocks.glowstone;
					if (j > 1) {
						bid = Blocks.air;
						if (j <= 4 && i == 3 && k == 2) bid = Blocks.quartz_block;
					}
		...
		for (i = 0; i < 3; i++) {
			for (k = 0; k < 10; k++) {
				for (j = 0; j < 15; j++) {
					...
					if (j == 1) {
						bid = Blocks.air;
						if (k > 6) bid = Blocks.quartz_block;
					}

					if (j > 1) bid = Blocks.air;
					this.FastSetBlock(world, cposx + i, cposy + j, cposz + k, bid);
				}
			}
		}
	...
	private void makewhbase(World world, int cposx, int cposy, int cposz) {
		...
		for (i = 0; i < 25; i++) {
			for (k = 0; k < 25; k++) {
				...
				if (i == 0 || i == 24) {
					if (k == 0 || k == 24) this.FastSetBlock(world, cposx + i, cposy + 2, cposz + k, OreSpawnMain.CrystalTorch);
				}
			}
		}
		for (i = 1; i < 24; i++) {
	...
	private void makewhwalls(World world, int cposx, int cposy, int cposz) { // holy shit this method sucks
		int i, k, j;
		Block bid = Blocks.air;
		for (i = 0; i < 23; i++) {
			for (k = 0; k < 23; k++) {
				for (j = 0; j < 6; j++) {
					bid = Blocks.air;
					if (i == 0 || k == 0 || i == 22 || k == 22) bid = Blocks.quartz_block;
					if (j != 0 && bid != Blocks.air)
					{
						if (k == 22){
							if ((j & 1) == 1){
								if ((i & 1) == 0 || (k & 1) == 0) bid = Blocks.glass_pane;
							}
							else if ((i & 1) == 1 || (k & 1) == 1) bid = Blocks.glass_pane;
						}
						else if (k != 0){
							if ((j & 1) == 1){
								if (i == 2 || k == 2 || i == 20 || k == 20) bid = Blocks.glass_pane;
							}
							else if (i == 1 || k == 1 || i == 21 || k == 21) bid = Blocks.glass_pane;

							if (j > 0 && j < 5 && k > 7 && k < 15) bid = Blocks.glass_pane;
						}
						else if ((j & 1) == 1){
							if (i == 2 || k == 2 || i == 20 || k == 20) bid = Blocks.glass_pane;
						}
	...
	private void makewhroof(World world, int cposx, int cposy, int cposz) {
		...
		for (j = 0; j < 13; j++) {
			for (i = 0; i < 25 - 2 * j; i++) {
				for (k = 0; k < 25 - 2 * j; k++) {
					bid = Blocks.air;
					if (i == 0 || k == 0 || i == 24 - 2 * j || k == 24 - 2 * j) bid = Blocks.quartz_block;
					if (j == 0 && bid != Blocks.air) {
						if ((i + k & 1) == 1) {
							bid = Blocks.emerald_block;
						}
					}
					if (j == 12) bid = Blocks.emerald_block;
					this.FastSetBlock(world, cposx + i + j, cposy + 8 + j, cposz + k + j, bid);
					if (i == 0 || i == 24 - 2 * j) {
						if (k == 0 || k == 24 - 2 * j) this.FastSetBlock(world, cposx + i + j, cposy + 8 + j + 1, cposz + k + j, OreSpawnMain.CrystalTorch);
					}
				}
			}
		}
	...
	private void makewhinterior(World world, int cposx, int cposy, int cposz)
	{
		...
		if (tileentitymobspawner != null) tileentitymobspawner.func_145881_a().setEntityName("Criminal");
		world.setBlock(cposx + xoff, cposy, cposz + zoff, Blocks.chest, 0, 2);
		chest = this.getChestTileEntity(world, cposx + xoff, cposy, cposz + zoff);
		if (chest != null) WeightedRandomChestContent.generateChestContents(world.rand, chestContents, chest, 3 + world.rand.nextInt(5));
	...
	private void makequeencolumn(World world, int cposx, int cposy, int cposz)
	{
		...
		for (j = 0; j < height; j++) {
			for (i = 0; i < width; i++) {
				for (k = 0; k < length; k++) {
					bid = Blocks.air;
					if (i == 0 || k == 0 || i == width - 1 || k == length - 1) bid = Blocks.obsidian;
					if (j % 4 == 0) {
						if (bid != Blocks.air) {
							if (i == 2 || k == 2) bid = Blocks.redstone_block;
						}
					}
					if (j % 4 == 1) {
						if (bid != Blocks.air) {
							if (i == 1 || k == 1) bid = Blocks.redstone_block;
							if (i == 3 || k == 3) bid = Blocks.redstone_block;
						}
					}
					if (j % 4 == 2) {
						if (bid != Blocks.air) {
							if (i == 1 || k == 1) bid = Blocks.redstone_block;
							if (i == 3 || k == 3) bid = Blocks.redstone_block;
							if (i == 2 || k == 2) bid = OreSpawnMain.MyBlockAmethystBlock;
						}
					}
					if (j % 4 == 3) {
						if (bid != Blocks.air) {
	...
	private void makequeencenteraltar(World world, int cposx, int cposy, int cposz)
	{
		...
		for (i = -width; i <= width; i++) {
			for (k = -length; k <= length; k++) {
				bid = Blocks.obsidian;
				if (i == width) {
					if (k == -length || k == length) bid = OreSpawnMain.MyBlockAmethystBlock;
				}
				if (i == -width) {
					if (k == -length || k == length) bid = OreSpawnMain.MyBlockAmethystBlock;
				}
	...
	public void makeRoundRotator(World world, int cposx, int cposy, int cposz)
	{
		...
		radius = 6.0F;
		for (curdeg = 0.0F; curdeg < 360.0F; curdeg += 5.0F) {
			curx = (float)((double)radius * Math.cos(Math.toRadians((double)curdeg)));
			cury = (float)((double)radius * Math.sin(Math.toRadians((double)curdeg)));
			blk = Blocks.bedrock;
	...
	public void makeRainbow(World world, int cposx, int cposy, int cposz)
	{
		...
		for (i = -width; i < width; i++) {
			for (k = -depth; k <= depth; k++) {
				blk = Blocks.air;
				if (i == -width || i == width - 1) blk = Blocks.stained_hardened_clay;
				if (k == -depth || k == depth) blk = Blocks.stained_hardened_clay;
		...
		if (tileentitymobspawner != null) tileentitymobspawner.func_145881_a().setEntityName("Cloud Shark");
	...
	public void makeEnormousCastleQ(World world, int cposx, int cposy, int cposz)
	{
		...
		for (j = 0; j < 4; j++)
		{
			world.setBlock(cposx - 3, cposy + 1 + j, cposz - 3, Blocks.mob_spawner, 0, 2);
			tileentitymobspawner = this.getSpawnerTileEntity(world, cposx - 3, cposy + 1 + j, cposz - 3);
			if (tileentitymobspawner != null) tileentitymobspawner.func_145881_a().setEntityName("Lurking Terror");
		...
		j += 10;
		if (level >= 2) this.buildLevelQ(world, cposx + 1, cposy + j, cposz + 1, width - 2, 10, 4, "Bee", 0, 0, 4, 2, level);
		j += 10;
		if (level >= 3) this.buildLevelQ(world, cposx + 2, cposy + j, cposz + 2, width - 4, 9, 4, "Mantis", 1, 1, 4, 3, level);
		j += 9;
		if (level >= 4) this.buildLevelQ(world, cposx + 2, cposy + j, cposz + 2, width - 4, 9, 3, "Mothra", 0, 0, 4, 4, level);
		j += 9;
		if (level >= 5) this.buildLevelQ(world, cposx + 3, cposy + j, cposz + 3, width - 6, 8, 3, "Brutalfly", 1, 1, 4, 5, level);
		j += 8;
		if (level >= 6) this.buildLevelQ(world, cposx + 3, cposy + j, cposz + 3, width - 6, 16, 3, "Vortex", 0, 0, 3, 6, level);
		j += 16;
	...
	public void buildLevelQ(World world, int cposx, int cposy, int cposz, int width, int height, int pw, String critter, int stepside, int stepoff, int holelen, int decor, int level)
	{
		...
		for (k = 0; k < width; k++) {
			for (j = 1; j < height; j++) {
				blk = Blocks.bedrock;
				if (k == 0 || k == width - 1) blk = OreSpawnMain.MyBlockRubyBlock;
				i = 0;
				this.FastSetBlock(world, cposx + i, cposy + j, cposz + k, blk);
				i = width - 1;
				this.FastSetBlock(world, cposx + i, cposy + j, cposz + k, blk);
	...
	public void addLevelDecorationsQ(World world, int cposx, int cposy, int cposz, int width, int height, int decor, int difficulty)
	{
		...
		if (decor == 1) {
			if (difficulty == 1) critter = "T. Rex";
			if (difficulty == 2) critter = "Nastysaurus";
			if (difficulty == 3) critter = "Basilisk";
			if (difficulty == 4) critter = "Hercules Beetle";
			if (difficulty == 5) critter = "Jumpy Bug";
			if (difficulty == 6) critter = "CaterKiller";
			reward = difficulty;
	...
	public void makeSpiderHangout(World world, int cposx, int cposy, int cposz)
	{
		...
		for (j = 1; j < 4; j++) {
			...
			world.setBlock(cposx + i, cposy + j, cposz + k, Blocks.mob_spawner, 0, 2);
			tileentitymobspawner = this.getSpawnerTileEntity(world, cposx + i, cposy + j, cposz + k);
			if (tileentitymobspawner != null) tileentitymobspawner.func_145881_a().setEntityName("Spider Driver");
