...
public class ModelWaterDragon extends ModelBase
{
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		this.body3.rotateAngleY = MathHelper.cos(f2 * 1.3F * this.wingspeed) * (float)Math.PI * 0.4F * f1;
		this.body4.rotationPointZ = this.body3.rotationPointZ + (float)Math.cos((double)this.body3.rotateAngleY) * 7.0F;
		this.body4.rotationPointX = this.body3.rotationPointX - 1.0F + (float)Math.sin((double)this.body3.rotateAngleY) * 7.0F;
		this.body4.rotateAngleY = MathHelper.cos(f2 * 1.3F * this.wingspeed - pi4) * (float)Math.PI * 0.4F * f1;
		this.tail1.rotationPointZ = this.body4.rotationPointZ + (float)Math.cos((double)this.body4.rotateAngleY) * 5.0F;
		this.tail1.rotationPointX = this.body4.rotationPointX + (float)Math.sin((double)this.body4.rotateAngleY) * 5.0F;
		this.tail1.rotateAngleY = MathHelper.cos(f2 * 1.3F * this.wingspeed - 2.0F * pi4) * (float)Math.PI * 0.4F * f1;
		this.tailmiddle.rotationPointZ = this.tail1.rotationPointZ + (float)Math.cos((double)this.tail1.rotateAngleY) * 3.0F;
		this.tailmiddle.rotationPointX = this.tail1.rotationPointX + (float)Math.sin((double)this.tail1.rotateAngleY) * 3.0F;
		this.tailmiddle.rotateAngleY = MathHelper.cos(f2 * 1.3F * this.wingspeed - 3.0F * pi4) * (float)Math.PI * 0.4F * f1;
		...
		newangle = MathHelper.cos(f2 * 0.8F * this.wingspeed) * (float)Math.PI * 0.1F;
		this.leftear.rotateAngleY = 0.62F + newangle;
		this.rightear.rotateAngleY = -0.62F - newangle;
		
		
		newangle = MathHelper.cos(f2 * 0.7F * this.wingspeed) * (float)Math.PI * 0.02F;
		if (e.isSitting()) newangle = 0.0F;
		this.Bodyfin.rotateAngleZ = newangle;
		newangle = MathHelper.cos(f2 * 0.6F * this.wingspeed) * (float)Math.PI * 0.1F;
		if (e.isSitting()) newangle = 0.0F;
		...
		if (e.getAttacking() == 1)
		{
			newangle = MathHelper.cos(f2 * 1.2F * this.wingspeed) * (float)Math.PI * 0.25F;
		...
		newangle = (float)Math.toRadians((double)f3) * 0.75F;
		this.Head.rotateAngleY = newangle;
		this.nose.rotateAngleY = newangle;
		this.nose.rotationPointZ = this.Head.rotationPointZ - (float)Math.cos((double)this.Head.rotateAngleY) * 8.0F;
		this.nose.rotationPointX = this.Head.rotationPointX - (float)Math.sin((double)this.Head.rotateAngleY) * 8.0F;
		this.jaw.rotateAngleY = newangle;
		this.jaw.rotationPointZ = this.Head.rotationPointZ - (float)Math.cos((double)this.Head.rotateAngleY) * 7.0F;
		this.jaw.rotationPointX = this.Head.rotationPointX - (float)Math.sin((double)this.Head.rotateAngleY) * 7.0F - 1.0F;
		this.headfin.rotateAngleY = newangle;
		this.headfin.rotationPointZ = this.Head.rotationPointZ - (float)Math.cos((double)this.Head.rotateAngleY) * 3.0F;
		this.headfin.rotationPointX = this.Head.rotationPointX - (float)Math.sin((double)this.Head.rotateAngleY) * 3.0F;
		this.leftear.rotateAngleY += newangle;
		this.leftear.rotationPointZ = this.Head.rotationPointZ - (float)Math.cos((double)(this.Head.rotateAngleY - pi4)) * root13;
		this.leftear.rotationPointX = this.Head.rotationPointX - (float)Math.sin((double)(this.Head.rotateAngleY - pi4)) * root13;
		this.rightear.rotateAngleY += newangle;
		this.rightear.rotationPointZ = this.Head.rotationPointZ - (float)Math.cos((double)(this.Head.rotateAngleY + pi4)) * root20;
		this.rightear.rotationPointX = this.Head.rotationPointX - (float)Math.sin((double)(this.Head.rotateAngleY + pi4)) * root20;
