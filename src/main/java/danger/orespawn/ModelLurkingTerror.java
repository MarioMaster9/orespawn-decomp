...
public class ModelLurkingTerror extends ModelBase
{
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		newangle = f2 * legspeed * this.wingspeed % ((float)Math.PI * 2F);
		newangle = Math.abs(newangle);
		
		if (newangle < r.rf1)
		{
			r.ri1 = 0;
			if (e.worldObj.rand.nextInt(3) == 1) r.ri1 |= 1;
			if (e.worldObj.rand.nextInt(3) == 1) r.ri1 |= 2;
			if (e.worldObj.rand.nextInt(4) == 1) r.ri1 |= 4;
			if (e.worldObj.rand.nextInt(4) == 1) r.ri1 |= 8;
			if (e.worldObj.rand.nextInt(6) == 1) r.ri1 |= 16;
			if (e.worldObj.rand.nextInt(6) == 1) r.ri1 |= 32;
		}

		r.rf1 = newangle;
		
		newangle = f2 * mouthspeed * this.wingspeed % ((float)Math.PI * 2F);
		newangle = Math.abs(newangle);
		
		if (newangle < r.rf2)
		{
			r.ri2 = 0;
			if (e.worldObj.rand.nextInt(20) == 1) r.ri2 |= 1;
		...
		newangle = 0.0F;
		if ((r.ri1 & 1) != 0) {
			newangle = MathHelper.sin(f2 * legspeed * this.wingspeed) * (float)Math.PI * 0.25F;
		}
		...
		newangle = 0.0F;
		if ((r.ri1 & 4) != 0) {
			newangle = MathHelper.sin(f2 * legspeed * this.wingspeed) * (float)Math.PI * 0.15F;
		}
		...
		newangle = 0.0F;
		if ((r.ri1 & 16) != 0) {
			newangle = MathHelper.sin(f2 * legspeed * this.wingspeed) * (float)Math.PI * 0.1F;
		}
		...
		newangle = 0.0F;
		if ((r.ri2 & 1) != 0) {
			newangle = MathHelper.sin(f2 * mouthspeed * this.wingspeed) * (float)Math.PI * 0.35F;
			newangle = Math.abs(newangle);
		}
		this.jaw1.rotateAngleY = newangle;
		this.jaw1part2.rotateAngleY = newangle;
		this.jaw1tooth1.rotateAngleY = this.jaw1tooth3.rotateAngleY = this.jaw1tooth5.rotateAngleY = newangle;
		this.jaw1tooth2.rotateAngleY = this.jaw1tooth4.rotateAngleY = this.jaw1tooth6.rotateAngleY = newangle;
		this.jaw2.rotateAngleY = -newangle;
		this.jaw2part2.rotateAngleY = -newangle;
		this.jaw2tooth1.rotateAngleY = this.jaw2tooth3.rotateAngleY = this.jaw2tooth5.rotateAngleY = -newangle;
		this.jaw2tooth2.rotateAngleY = this.jaw2tooth4.rotateAngleY = this.jaw2tooth6.rotateAngleY = -newangle;
		this.jaw3.rotateAngleX = -newangle;
		this.jaw3part2.rotateAngleX = -newangle;
		this.jaw3tooth1.rotateAngleX = this.jaw3tooth3.rotateAngleX = this.jaw3tooth5.rotateAngleX = -newangle;
		this.jaw3tooth2.rotateAngleX = this.jaw3tooth4.rotateAngleX = this.jaw3tooth6.rotateAngleX = -newangle;
		this.jaw4.rotateAngleX = newangle;
		this.jaw4part2.rotateAngleX = newangle;
		this.jaw4tooth1.rotateAngleX = this.jaw4tooth3.rotateAngleX = this.jaw4tooth5.rotateAngleX = newangle;
		this.jaw4tooth2.rotateAngleX = this.jaw4tooth4.rotateAngleX = this.jaw4tooth6.rotateAngleX = newangle;
		
		this.tonguepart1.rotateAngleX = this.tonguepart2.rotateAngleX = this.tonguepart3.rotateAngleX = 0.0F;
		this.tonguepart1.rotateAngleY = this.tonguepart2.rotateAngleY = this.tonguepart3.rotateAngleY = 0.0F;
		this.tonguepart1.rotateAngleZ = this.tonguepart2.rotateAngleZ = this.tonguepart3.rotateAngleZ = 0.0F;
		...
		newangle = MathHelper.sin(f2 * 0.1F * this.wingspeed) * (float)Math.PI * 0.06F;
		this.thorax.rotateAngleX = newangle;
		this.abdomen.rotationPointY = (float)((double)this.thorax.rotationPointY - Math.sin((double)newangle) * 14.0D);
		
		newangle = MathHelper.cos(f2 * 1.4F * this.wingspeed) * (float)Math.PI * 0.2F;
