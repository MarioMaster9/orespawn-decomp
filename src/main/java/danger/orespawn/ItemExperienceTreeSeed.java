	...
	public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World world, int x, int y, int z, int par7, float par8, float par9, float par10)
	{
		if (!world.isRemote)
		{
			...
			for (int j1 = 0; j1 < 10; j1++)
			{
				...
				world.spawnParticle("happyVillager", (double)((float)x + world.rand.nextFloat()), (double)y + 1.0D + (double)world.rand.nextFloat(), (double)((float)z + world.rand.nextFloat()), 0.0D, 0.0D, 0.0D);
			}
		}
