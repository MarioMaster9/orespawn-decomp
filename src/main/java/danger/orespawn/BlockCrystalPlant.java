...
public class BlockCrystalPlant extends BlockReed
{
	...
	{
		if (par1World.rand.nextInt(30) != 1) return;
	...
	{
		if (this == OreSpawnMain.MyCrystalPlant) return Item.getItemFromBlock(OreSpawnMain.MyCrystalPlant);
		if (this == OreSpawnMain.MyCrystalPlant2) Item.getItemFromBlock(OreSpawnMain.MyCrystalPlant2); // typo?
