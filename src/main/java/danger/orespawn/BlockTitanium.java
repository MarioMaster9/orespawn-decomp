	...
	private void sparkle(World par1World, int par2, int par3, int par4)
	{
		...
		for (int var8 = 0; var8 < 6; var8++)
		{
			...
			if (var9 < (double)par2 || var9 > (double)(par2 + 1) || var11 < 0.0D || var11 > (double)(par3 + 1) || var13 < (double)par4 || var13 > (double)(par4 + 1))
			{
				...
				if (which == 0) par1World.spawnParticle("flame", var9, var11, var13, 0.0D, 0.0D, 0.0D);
				if (which == 1) par1World.spawnParticle("smoke", var9, var11, var13, 0.0D, 0.0D, 0.0D);
				if (which == 2) par1World.spawnParticle("reddust", var9, var11, var13, 0.0D, 0.0D, 0.0D);
			}
		}
	}
