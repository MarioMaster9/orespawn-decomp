...
public class Spyro extends EntityTameable {
	...
	protected String getLivingSound() {
		if (this.isSitting()) {
			...
			return this.getActivity() != 2 ? null : "orespawn:roar";
		}
	}
				...
				if (this.worldObj.rand.nextInt(6) == 1 && this.worldObj.difficultySetting != EnumDifficulty.PEACEFUL) {
					...
					if (e != null) {
						if (this.isTamed() && this.getHealth() / (float)this.mygetMaxHealth() < 0.25F) {
							...
							} else if (this.getDistanceSqToEntity(e) < (double)64.0F && !this.isInWater() && (this.getSpyroFire() == 1 && this.worldObj.rand.nextInt(10) == 0 || this.worldObj.rand.nextInt(15) == 1)) {
