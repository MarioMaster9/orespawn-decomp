...
public class ModelEmperorScorpion extends ModelBase
{
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		newangle = MathHelper.cos(f2 * 2.0F * this.wingspeed) * (float)Math.PI * 0.12F * f1;
		nextangle = MathHelper.cos((f2 + 0.1F) * 2.0F * this.wingspeed) * (float)Math.PI * 0.12F * f1;
		upangle = 0.0F;
		...
		newangle = MathHelper.cos(f2 * 2.0F * this.wingspeed - 1.0F * pi4) * (float)Math.PI * 0.12F * f1;
		nextangle = MathHelper.cos((f2 + 0.1F) * 2.0F * this.wingspeed - 1.0F * pi4) * (float)Math.PI * 0.12F * f1;
		upangle = 0.0F;
		if (nextangle > newangle)
			upangle = 0.47F * f1 - Math.abs(newangle);
		...
		newangle = MathHelper.cos(f2 * 2.0F * this.wingspeed - 2.0F * pi4) * (float)Math.PI * 0.12F * f1;
		nextangle = MathHelper.cos((f2 + 0.1F) * 2.0F * this.wingspeed - 2.0F * pi4) * (float)Math.PI * 0.12F * f1;
		upangle = 0.0F;
		if (nextangle > newangle)
			upangle = 0.47F * f1 - Math.abs(newangle);
		...
		newangle = MathHelper.cos(f2 * 2.0F * this.wingspeed - 3.0F * pi4) * (float)Math.PI * 0.12F * f1;
		nextangle = MathHelper.cos((f2 + 0.1F) * 2.0F * this.wingspeed - 3.0F * pi4) * (float)Math.PI * 0.12F * f1;
		upangle = 0.0F;
		if (nextangle > newangle)
			upangle = 0.47F * f1 - Math.abs(newangle);
		...
		if (e.getAttacking() == 0) {
			newangle = MathHelper.cos(f2 * 0.5F * this.wingspeed) * (float)Math.PI * 0.05F;
		} else {
			newangle = MathHelper.cos(f2 * 2.5F * this.wingspeed) * (float)Math.PI * 0.15F;
		}
		...
		newangle = MathHelper.cos(f2 * 3.0F * this.wingspeed) * (float)Math.PI * 0.15F;
		nextangle = MathHelper.cos((f2 + 0.1F) * 3.0F * this.wingspeed) * (float)Math.PI * 0.15F;
	...
	private void doLeftLeg(ModelRenderer seg1, ModelRenderer seg2, ModelRenderer seg3, ModelRenderer seg4, ModelRenderer seg5, float angle, float upangle)
	{
		...
		seg3.rotationPointZ = (float)((double)seg2.rotationPointZ - Math.sin((double)angle) * 6.0D);
		seg3.rotationPointX = (float)((double)seg2.rotationPointX - Math.abs(Math.sin((double)angle) * 6.0D) + 6.0D);
		seg4.rotationPointZ = (float)((double)seg3.rotationPointZ - Math.sin((double)angle) * 9.0D);
		seg4.rotationPointX = (float)((double)seg3.rotationPointX - Math.abs(Math.sin((double)angle) * 9.0D) + 9.0D);
		seg5.rotationPointZ = (float)((double)seg4.rotationPointZ - Math.sin((double)angle) * 1.0D);
		seg5.rotationPointX = (float)((double)seg4.rotationPointX - Math.abs(Math.sin((double)angle) * 1.0D) + 1.0D);
		
		
		seg2.rotateAngleZ = -upangle - 0.929F;
		seg3.rotateAngleZ = -upangle + 0.632F;
		seg3.rotationPointY = seg2.rotationPointY + (float)(11.5D * Math.sin((double)seg2.rotateAngleZ));
		seg4.rotationPointY = seg3.rotationPointY + (float)(11.5D * Math.sin((double)seg3.rotateAngleZ));
	...
	private void doLeftClaw(float angle)
	{
		...
		this.LeftArmSeg2.rotationPointZ = (float)(-22.0D - Math.cos((double)this.LeftArmSeg1.rotateAngleY) * 12.0D);
	...
	private void doRightClaw(float angle)
	{
		...
		this.RightArmSeg2.rotationPointZ = (float)(-22.0D - Math.cos((double)this.RightArmSeg1.rotateAngleY) * 12.0D);
	...
	private void doTail(float angle)
	{
		...
		this.Tailseg2.rotationPointY = (float)((double)this.Tailseg1.rotationPointY - Math.sin((double)this.Tailseg1.rotateAngleX) * 9.0D);
		this.Tailseg2.rotationPointZ = (float)((double)this.Tailseg1.rotationPointZ + Math.cos((double)this.Tailseg1.rotateAngleX) * 9.0D);
		
		this.Tailseg3.rotateAngleX = this.Tailseg2.rotateAngleX + 0.6320001F + angle;
		this.Tailseg3.rotationPointY = (float)((double)this.Tailseg2.rotationPointY - Math.sin((double)this.Tailseg2.rotateAngleX) * 10.0D);
		this.Tailseg3.rotationPointZ = (float)((double)this.Tailseg2.rotationPointZ + Math.cos((double)this.Tailseg2.rotateAngleX) * 10.0D);
		
		this.Tailseg4.rotateAngleX = this.Tailseg3.rotateAngleX + 0.5569999F - angle;
		this.Tailseg4.rotationPointY = (float)((double)this.Tailseg3.rotationPointY - Math.sin((double)this.Tailseg3.rotateAngleX) * 10.0D);
		this.Tailseg4.rotationPointZ = (float)((double)this.Tailseg3.rotationPointZ + Math.cos((double)this.Tailseg3.rotateAngleX) * 10.0D);
		
		this.Tailseg5.rotateAngleX = this.Tailseg4.rotateAngleX + 0.63199997F - angle;
		this.Tailseg5.rotationPointY = (float)((double)this.Tailseg4.rotationPointY - Math.sin((double)this.Tailseg4.rotateAngleX) * 10.0D);
		this.Tailseg5.rotationPointZ = (float)((double)this.Tailseg4.rotationPointZ + Math.cos((double)this.Tailseg4.rotateAngleX) * 10.0D);
		
		this.Tailseg6.rotateAngleX = this.Tailseg5.rotateAngleX + -5.501F - angle * 3.0F / 2.0F - 0.4F;
		this.Tailseg6.rotationPointY = (float)((double)this.Tailseg5.rotationPointY - Math.sin((double)this.Tailseg5.rotateAngleX) * 10.0D);
		this.Tailseg6.rotationPointZ = (float)((double)this.Tailseg5.rotationPointZ + Math.cos((double)this.Tailseg5.rotateAngleX) * 10.0D);
		
		this.Tailseg7.rotateAngleX = this.Tailseg6.rotateAngleX + -2.822F - angle * 2.5F - 2.2F;
		this.Tailseg7.rotationPointY = (float)((double)this.Tailseg6.rotationPointY - Math.sin((double)this.Tailseg6.rotateAngleX) * 10.0D);
		this.Tailseg7.rotationPointZ = (float)((double)this.Tailseg6.rotationPointZ + Math.cos((double)this.Tailseg6.rotateAngleX) * 10.0D);
		...
		this.Stinger1.rotationPointY = (float)((double)this.Tailseg7.rotationPointY - Math.sin((double)this.Tailseg7.rotateAngleX) * 10.0D);
		this.Stinger1.rotationPointZ = (float)((double)this.Tailseg7.rotationPointZ + Math.cos((double)this.Tailseg7.rotateAngleX) * 10.0D);
		
		this.Stinger2.rotateAngleX = this.Stinger1.rotateAngleX + -0.48F + angle;
		this.Stinger2.rotationPointY = (float)((double)this.Stinger1.rotationPointY - Math.sin((double)this.Stinger1.rotateAngleX) * 3.0D);
		this.Stinger2.rotationPointZ = (float)((double)this.Stinger1.rotationPointZ + Math.cos((double)this.Stinger1.rotateAngleX) * 3.0D);
		
		this.Stinger3.rotateAngleX = this.Stinger2.rotateAngleX + -1.01F + angle * 1.7F;
		this.Stinger3.rotationPointY = (float)((double)this.Stinger2.rotationPointY - Math.sin((double)this.Stinger2.rotateAngleX) * 3.0D);
		this.Stinger3.rotationPointZ = (float)((double)this.Stinger2.rotationPointZ + Math.cos((double)this.Stinger2.rotateAngleX) * 3.0D);
